...
const GENERIC_TASK_MAPPINGS = {
  ...
  'brownfield-create-epic.md': 'Fumero (Strategist)',
  'brownfield-create-story.md': 'Pax (Balancer)',
  'build-component.md': 'Uma (Empathizer)',
  'calculate-roi.md': 'Fumero (Strategist)',
  ...
  'create-doc.md': 'Fumero (Strategist)',
  ...
  'document-project.md': 'Fumero (Strategist)',
  ...
  'shard-doc.md': 'Fumero (Strategist)',
  'sync-documentation.md': 'Fumero (Strategist)',

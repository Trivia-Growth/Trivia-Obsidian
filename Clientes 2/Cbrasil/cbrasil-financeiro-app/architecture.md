...
|-------------|----------|
| `Trivia-Obsidian/Clientes 2/Cbrasil/` | Documentacao, specs, stories, processos, research |
| `Clientes 2/Cbrasil/cbrasil-financeiro-app/` | Codigo: React, Supabase, Edge Functions |

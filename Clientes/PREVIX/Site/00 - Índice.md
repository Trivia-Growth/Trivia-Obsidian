...
| Seção | Link |
|-------|------|
| Dashboard (status das stories) | [[Clientes/PREVIX/Site/Projeto/Dashboard do Projeto]] |
| Roadmap (fases e milestones) | [[Clientes/PREVIX/Site/Projeto/Roadmap]] |
...
> **Por que Astro e não Vite:** crawlers de IA (ChatGPT, Perplexity, Google AI Overviews) precisam de HTML completo. SPA Vite entrega HTML vazio. Decisão formal em [[Decisões Arquiteturais|ADR-001]] e na seção "Stack negociável" do [[../../Documentos Trivia/Padrão Projetos/01 - Arquitetura/Stack Padrão|Stack Padrão Trívia]].

...
**Arquitetura:** Bulletproof React (feature-based). Dois repositórios: `trivia-obsidian/Clientes/PREVIX/Organograma/` (vault Obsidian — specs) e `organograma-previx-app/` (código). A Lovable pode editar qualquer parte do código — frontend, Supabase migrations, Edge Functions. Não alterar `CLAUDE.md` nem `.aiox-core/`.

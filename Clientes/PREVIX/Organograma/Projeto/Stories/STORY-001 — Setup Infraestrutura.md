...
- [[../../../../Documentos Trivia/Padrão Projetos/00 - Checklist de Início|Checklist de Início]]
- [[../../../../Documentos Trivia/Padrão Projetos/01 - Arquitetura/Dois Repositórios|Dois Repositórios]]

## Critérios de Aceite

- [x] CA1 — Estrutura local criada: vault `Clientes/PREVIX/Organograma/` + repo `organograma-previx-app/` lado a lado
...
- `Clientes/PREVIX/Organograma/00 - Índice.md`
- `Clientes/PREVIX/Organograma/Projeto/Dashboard do Projeto.md`
- `Clientes/PREVIX/Organograma/Projeto/Roadmap.md`

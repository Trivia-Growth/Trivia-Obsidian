...
```bash
node -e "const {runDiagnostics}=require('./.triviaiox-core/core/synapse/diagnostics/synapse-diagnostics');console.log(runDiagnostics(process.cwd()))"
```
...
- **SYNAPSE diagnostics**: `.triviaiox-core/core/synapse/diagnostics/synapse-diagnostics.js`

...
| Seção | Link |
|-------|------|
| Dashboard (status das stories) | [[Clientes/Trivia/JimmyStudio/Projeto/Dashboard do Projeto]] |
| Roadmap (fases e milestones) | [[Clientes/Trivia/JimmyStudio/Projeto/Roadmap]] |

...
| Seção | Link |
|-------|------|
| Dashboard (status das stories) | [[Clientes/Trivia/TriviaCRM+Atende/Projeto/Dashboard do Projeto]] |
| Roadmap (fases e milestones) | [[Clientes/Trivia/TriviaCRM+Atende/Projeto/Roadmap]] |

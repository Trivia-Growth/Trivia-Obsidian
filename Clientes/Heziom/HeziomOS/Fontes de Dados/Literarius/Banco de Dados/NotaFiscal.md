...
Notas fiscais emitidas e recebidas pela Literarius. As NFs de saída (`EntSai = 'S'`) com `GeraFinanceiro = 1` disparam a criação de títulos em [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/TituloFinanceiro]]. Contém os valores totais da operação e informações fiscais completas.
...
| `GeraFinanceiro` | bit | `1` = gera título em [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/TituloFinanceiro]] |
...
| `idPedidoVenda` | bigint | FK → [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/PedidoVenda]] |
...
- FK → [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/PedidoVenda]] via `idPedidoVenda`
- FK → [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/FormaPagto]] via `FormaPagto`
- 1:N → [[Clientes/Heziom/HeziomOS/Fontes de Dados/Literarius/Banco de Dados/TituloFinanceiro]] (via `Origem` + `OrigemIdRegistro` no título)

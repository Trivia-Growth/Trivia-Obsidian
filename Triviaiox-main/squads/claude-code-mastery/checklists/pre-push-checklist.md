...
It complements the TRIVIAIOX framework pre-push-checklist but focuses on
...
- [ ] All `TRIVIAIOX-MANAGED-START` sections have matching `TRIVIAIOX-MANAGED-END` markers (CRITICAL)

...
IDE-FILE-RESOLUTION:
  ...
  - Example: update-knowledge.md -> .triviaiox-core/development/tasks/update-knowledge.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .triviaiox-core/development/scripts/unified-activation-pipeline.js roadmap-sentinel
...
---
---
*TRIVIAIOX Agent - Roadmap Sentinel (Vigil)*

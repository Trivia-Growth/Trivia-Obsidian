...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-agent.md → .triviaiox-core/development/tasks/create-agent.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .triviaiox-core/development/scripts/unified-activation-pipeline.js swarm-orchestrator
...
knowledge_base:
  ...
  # ── LAYER 4: TRIVIAIOX Integration ──────────────────────

  triviaiox_subagent_patterns:
    description: |
      Within the TRIVIAIOX framework, the Agent tool (formerly Task tool) can spawn
      subagents using the subagent_type parameter. TRIVIAIOX agents can delegate to
    ...
    worktree_integration:
      description: |
        ...
        changes are made. Combine with TRIVIAIOX *worktree-create for story-level isolation.
      pattern: |
...
---
---
*TRIVIAIOX Agent - TriviaGrowth Triviaiox Swarm Orchestrator v1.0*

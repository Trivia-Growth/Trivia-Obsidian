...
**TRIVIAIOX-specific deny rules (if .triviaiox-core/ exists):**

| Pattern | Protects | Severity if Missing |
|---------|----------|---------------------|
| `Edit(.triviaiox-core/core/**)` | L1 Framework Core | HIGH |
| `Edit(.triviaiox-core/constitution.md)` | Constitution | HIGH |
| `Edit(bin/triviaiox.js)` | CLI entry point | MEDIUM |

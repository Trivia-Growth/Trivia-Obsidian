...
| integration | integrate, repository, project setup, CI/CD, headless, brownfield, monorepo, TRIVIAIOX, git workflow | project-integrator | Conduit |
...
1. Synthesize knowledge from the quick_reference section and TRIVIAIOX awareness

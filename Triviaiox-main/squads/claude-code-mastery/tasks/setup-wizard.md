...
1. Check for project markers:
   ...
   - `go.mod` -> Go project
   - `.triviaiox-core/` -> TRIVIAIOX-managed project
...
| triviaiox | .triviaiox-core/ directory | acceptEdits |
...
5. If TRIVIAIOX project: include TRIVIAIOX-specific sections (agent system, workflows)
...
3. If TRIVIAIOX project: add L1-L4 boundary protection deny rules

...
| 2 | project-integrator | Conduit | Daniel Miessler (PAI) | 959 | Project integration, CI/CD, TRIVIAIOX bridge |
...
```
Or use the TRIVIAIOX activation:
```
/TRIVIAIOX:agents:claude-mastery-chief
```

### Direct Specialist Access
```
/TRIVIAIOX:agents:hooks-architect        # Hook automation
/TRIVIAIOX:agents:mcp-integrator         # MCP servers
/TRIVIAIOX:agents:swarm-orchestrator     # Multi-agent orchestration
/TRIVIAIOX:agents:config-engineer        # Settings & permissions
/TRIVIAIOX:agents:skill-craftsman        # Skills & plugins
/TRIVIAIOX:agents:project-integrator     # Project integration
/TRIVIAIOX:agents:roadmap-sentinel       # Updates & roadmap
```
...
| TRIVIAIOX Bridge | Orion + Conduit | `*triviaiox-bridge`, `*triviaiox-guide` |
...
This squad understands both Claude Code native capabilities AND the TRIVIAIOX-core framework:

| TRIVIAIOX Concept | Claude Code Equivalent | Bridge Agent |
|-------------|----------------------|-------------|
| Agents (@dev, @qa...) | Subagents (.claude/agents/) | Nexus |
| Tasks (.triviaiox-core/tasks/) | Skills (.claude/skills/) | Anvil |

...
This directory contains automated workflows for the TRIVIAIOX project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. TRIVIAIOX now uses Docker MCP Toolkit exclusively (Story 5.11).

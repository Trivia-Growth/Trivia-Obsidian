---
name: Squad Proposal
about: Propose a new TRIVIAIOX Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this TRIVIAIOX Squad does and what domain it covers.

> TRIVIAIOX Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
- Core TRIVIAIOX framework (triviaiox-core)?
...
# Or via CLI
triviaiox squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required triviaiox-core version?
- **Other Squads:** Any dependencies on other TRIVIAIOX Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `triviaiox-squads` repo
...
### ✅ Checklist
- [ ] Squad follows TRIVIAIOX structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `triviaiox-squads` repository.

**Tagline:** *TRIVIAIOX Squads: Equipes de AI agents trabalhando com você* 🤖

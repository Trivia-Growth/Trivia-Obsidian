...
>
> - Someone familiar with TRIVIAIOX can understand
...
4. Tag relevant stakeholders: @Trivia-Growth/core-team
...
**Note:** This template follows the TRIVIAIOX RFC process. For questions about the process, see [CONTRIBUTING.md](/CONTRIBUTING.md).

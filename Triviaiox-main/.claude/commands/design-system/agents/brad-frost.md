...
> Integrates with TRIVIAIOX via `/DS:agents:brad-frost` skill.
...
# ============================================================
# OUTPUT EXAMPLES (TRIVIAIOX Standard - 3+ examples)
# ============================================================
output_examples:
...
# ============================================================
# ANTI-PATTERNS (TRIVIAIOX Standard)
# ============================================================
anti_patterns:
  never_do:
...
status:
  ...
  note: |
    ...
    Integrates with TRIVIAIOX via /SA:design-system skill.
```

...
[![NPM Version](https://img.shields.io/npm/v/triviaiox-core.svg)](https://www.npmjs.com/package/triviaiox-core)
...
[![Documentation](https://img.shields.io/badge/docs-available-orange.svg)](https://triviaioxsquad.ai)
...
If this is your first time with TRIVIAIOX, follow this linear path:

1. Install in a new or existing project:
```bash
# new project
npx triviaiox-core init my-project
...
## IDE Hook Compatibility (TRIVIAIOX 4.2 Reality)

Many advanced TRIVIAIOX features depend on lifecycle events (hooks). The table below shows the actual parity between IDEs/platforms:
...
TRIVIAIOX follows a clear priority hierarchy:
...
**The Two Key Innovations of TRIVIAIOX:**
...
### Understanding the TRIVIAIOX Workflow

**Before diving in, review these critical workflow diagrams that explain how TRIVIAIOX works:**
...
> ⚠️ **These diagrams explain 90% of the confusion about the TRIVIAIOX Agentic Agile workflow** - Understanding PRD+Architecture creation and the sm/dev/qa workflow and how agents pass notes through story files is essential - and it also explains why this is NOT taskmaster or just a simple task runner!

### What would you like to do?

- **[Install and Build software with a Full Stack AI Agile Team](#quick-start)** → Quick Start Instructions
- **[Learn how to use TRIVIAIOX](docs/guides/user-guide.md)** → Complete user guide and walkthrough
...
- **[Report issues](https://github.com/Trivia-Growth/Triviaiox/issues)** → Bug reports and feature requests

## Important: Keep Your TRIVIAIOX Installation Updated

**Stay up to date effortlessly!** To update your existing TRIVIAIOX installation:
...
**Install TRIVIAIOX with a single command:**
...
TRIVIAIOX now includes a cutting-edge interactive installation experience, inspired by modern tools like Vite and Next.js:
...
- ✅ Configuration of all TRIVIAIOX agents and workflows
...
If you already have TRIVIAIOX installed:
...
### Configure Your IDE for TRIVIAIOX Development

TRIVIAIOX includes pre-configured IDE rules to enhance your development experience:
...
- ✅ First-class integration in TRIVIAIOX 4.2 (shared activation and greeting pipeline)
...
- Generated files in `.gemini/rules.md`, `.gemini/rules/TRIVIAIOX/agents/`, and `.gemini/commands/*.toml`
- ✅ Local hooks and settings in the installation flow (`.gemini/hooks/` + `.gemini/settings.json`)
- ✅ Quick activation via slash commands (`/triviaiox-menu`, `/triviaiox-dev`, `/triviaiox-architect`, etc.)
...
- 📝 TRIVIAIOX-specific code patterns

### Fastest Start with Web Interface (2 minutes)

1. **Install TRIVIAIOX**: Run `npx triviaiox-core init my-project`
...
4. **Use TRIVIAIOX commands**: Type `*help` to see available commands
5. **Follow the flow**: See the [User Guide](docs/guides/user-guide.md) for more details

### CLI Command Reference

TRIVIAIOX offers a modern, cross-platform CLI with intuitive commands:

```bash
# Project Management (with interactive wizard)
npx triviaiox-core init <project-name> [options]
...
npx triviaiox-core install [options]
  --force              Overwrite existing configuration
  --quiet              Minimal output during installation
  --dry-run            Simulate installation without modifying files

# System Commands
npx triviaiox-core --version   Display installed version
npx triviaiox-core --help      Display detailed help
npx triviaiox-core info        Display system information
npx triviaiox-core doctor      Run system diagnostics
npx triviaiox-core doctor --fix Automatically fix detected issues

# Maintenance
npx triviaiox-core update      Update to latest version
npx triviaiox-core uninstall   Remove TRIVIAIOX
```
...
```bash
# Install TRIVIAIOX in the project
npx triviaiox-core@latest install

# This will:
# 1. Detect existing installation (if any)
# 2. Install/update TRIVIAIOX framework
# 3. Configure agents and workflows
```

## 🌟 Beyond Software Development - Squads

The TRIVIAIOX natural language framework works in ANY domain. Squads provide specialized AI agents for creative writing, business strategy, health and wellness, education, and more. Additionally, Squads can expand the TRIVIAIOX core with domain-specific functionality that isn't generic for all use cases. [See the Squads Guide](docs/guides/squads-guide.md) and learn to create your own!

## Available Agents

TRIVIAIOX comes with 12 specialized agents:

### Meta Agents

- **triviaiox-master** - Master orchestration agent (includes framework development capabilities)
- **triviaiox-orchestrator** - Workflow orchestrator and team coordination
...
- 🚀 **[Squads Guide](docs/guides/squads-guide.md)** - Extend TRIVIAIOX to any domain beyond software development
...
- 🎯 **[Guiding Principles](docs/GUIDING-PRINCIPLES.md)** - TRIVIAIOX philosophy and best practices
- 🏛️ **[Architecture Overview](docs/architecture/ARCHITECTURE-INDEX.md)** - Detailed view of system architecture
- ⚙️ **[Performance Tuning Guide](docs/performance-tuning-guide.md)** - Optimize your TRIVIAIOX workflow
...
TRIVIAIOX introduces the **Autonomous Development Engine (ADE)** - a complete system for autonomous development that transforms requirements into working code.
...
Squads allow you to extend TRIVIAIOX to any domain. Basic structure:
...
- **[hybrid-ops](https://github.com/Trivia-Growth/triviaiox-hybrid-ops-pedro-valerio)** - Human-agent hybrid operations (separate repository)

## TRIVIAIOX Pro

**TRIVIAIOX Pro** (`@triviaiox-fullstack/pro`) is the premium module of TRIVIAIOX, offering advanced features for teams and larger-scale projects.

> **Restricted availability:** TRIVIAIOX Pro is available exclusively to members of the **TRIVIAIOX Cohort Advanced**. [Learn more about the program](https://triviaioxsquad.ai).
...
- **Licensing** - License management via `triviaiox pro activate --key <KEY>`

For more information, run `npx triviaiox-core pro --help` after installation.

## Support

- 🐛 [Issue Tracker](https://github.com/Trivia-Growth/Triviaiox/issues) - Bug reports and feature requests
...
TRIVIAIOX implements a multi-layer validation system to ensure code quality and consistency:
...
# TRIVIAIOX Validator
node .triviaiox-core/utils/triviaiox-validator.js pre-commit   # Pre-commit validation
node .triviaiox-core/utils/triviaiox-validator.js pre-push     # Pre-push validation
node .triviaiox-core/utils/triviaiox-validator.js stories      # Validate all stories
```
...
**[⬆ Back to top](#triviaiox-squad-artificial-intelligence-orchestration-experience)**

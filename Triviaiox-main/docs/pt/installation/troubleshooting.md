...
### Problema 1: "npx triviaiox-core is not recognized"
...
```bash
# Verifique status da instalação TRIVIAIOX
npx triviaiox-core status
...
```bash
# Verifique estrutura .triviaiox-core
...
1. Execute `npx triviaiox-core status` e anote a saída
2. Consulte este guia de solução de problemas
3. Pesquise [Issues existentes no GitHub](https://github.com/Trivia-Growth/Triviaiox/issues)
...
- **Issues no GitHub**: [triviaiox-core/issues](https://github.com/Trivia-Growth/Triviaiox/issues)

...
# Guia de Instalação para macOS - TriviaGrowth Triviaiox
...
1. Os comandos são instalados em `.claude/commands/TRIVIAIOX/`
...
2. O TriviaGrowth Triviaiox lida automaticamente com sistemas de arquivos case-sensitive e case-insensitive

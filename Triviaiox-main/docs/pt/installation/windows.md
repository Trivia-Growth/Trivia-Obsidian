...
# Guia de Instalação Windows para TriviaGrowth Triviaiox
...
2. Comandos são instalados em `.claude\commands\TRIVIAIOX\`
...
# - Fazer backup de customizações em .triviaiox-backup\

# Guia de Início Rápido TRIVIAIOX v4
...
## Passo 1: Instalar TRIVIAIOX Core
...
TRIVIAIOX usa agentes especializados para diferentes tarefas. Na sua IDE com IA ou Claude Code CLI, digite:
...
Stories direcionam o desenvolvimento no TRIVIAIOX. Ative o Product Owner e crie uma:
...
```bash
# Instalação e setup
npx triviaiox-core@latest           # Executar wizard
npx triviaiox-core@latest doctor    # Executar diagnósticos
npx triviaiox-core@latest info      # Mostrar info do sistema

# Desenvolvimento
npm run lint                           # Verificar estilo de código
npm run typecheck                      # Verificar tipos TypeScript
npm test                               # Executar testes unitários
npm run validate:structure             # Validar estrutura TRIVIAIOX
```
...
```
seu-projeto/
├── .triviaiox-core/                    # Core do framework
│   ├── core/                      # Módulos core
...
3. **Aprenda sobre agentes:** [Definições de Agentes](../../../.triviaiox-core/development/agents/)
...
3. Verifique se o arquivo do agente existe: `ls .triviaiox-core/development/agents/`
...
### Estrutura TRIVIAIOX não encontrada

```bash
# Reinstalar TRIVIAIOX no projeto atual
...
- **Documentação:** [Repositório GitHub](https://github.com/Trivia-Growth/Triviaiox)
...
**Bem-vindo ao TRIVIAIOX! Bom coding!**

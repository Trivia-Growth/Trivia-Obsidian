...
# Guia de Solução de Problemas do TriviaGrowth Triviaiox

> 🌐 [EN](../troubleshooting.md) | **PT** | [ES](../es/troubleshooting.md)

---

Este guia abrangente ajuda você a diagnosticar e resolver problemas comuns com o TriviaGrowth Triviaiox.
...
# Saída detalhada
npx triviaiox-core doctor --verbose

# Verificar componente específico
npx triviaiox-core doctor --component memory-layer
```
...
npm exec triviaiox-core init my-project
```
...
npx triviaiox-core doctor --component config
...
```javascript
// Editar .triviaiox/memory-config.json
{
...
```
Error: "triviaiox-core" cannot be opened
```
...
xattr -d com.apple.quarantine /usr/local/bin/triviaiox-core
```
...
npx triviaiox-core doctor --report diagnostic.json

# Incluir informações do sistema
npx triviaiox-core info --detailed >> diagnostic.json
...
1. **Execute diagnósticos:**
   ```bash
   npx triviaiox-core doctor --verbose > diagnostic.log
   ```
...
2. **Colete informações:**
   ...
   - Versão do TRIVIAIOX: `npx triviaiox-core version`

3. **Verifique issues existentes:**
   - [GitHub Issues](https://github.com/triviaiox-core/triviaiox-core/issues)
   - [Discussions](https://github.com/triviaiox-core/triviaiox-core/discussions)
...
- **Stack Overflow**: Marque perguntas com `triviaiox-core`
...
1. Executar `npx triviaiox-core init test`
...
1. `npx triviaiox-core doctor --fix`
2. Limpando caches

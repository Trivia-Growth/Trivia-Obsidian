...
# Guia de Workflow Git do TRIVIAIOX
...
O TriviaGrowth Triviaiox implementa uma estratégia de validação de **Defesa em Profundidade** com três camadas progressivas que detectam problemas antecipadamente e garantem a qualidade do código antes do merge.
...
**Localização:** `.triviaiox-core/utils/triviaiox-validator.js`
...
- [Abra uma Issue](https://github.com/Trivia-Growth/Triviaiox/issues)

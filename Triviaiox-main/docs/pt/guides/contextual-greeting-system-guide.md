...
O Sistema de Greeting Contextual é uma melhoria de UX que torna os greetings dos agentes TRIVIAIOX inteligentes e adaptativos, mostrando informações e comandos relevantes baseados no contexto da sessão.
...
### Scripts Core
- `.triviaiox-core/core/session/context-detector.js` - Detecção de tipo de sessão
- `.triviaiox-core/infrastructure/scripts/git-config-detector.js` - Detecção de git config
- `.triviaiox-core/development/scripts/greeting-builder.js` - Montagem do greeting
- `.triviaiox-core/development/scripts/workflow-navigator.js` - Navegação de workflow
- `.triviaiox-core/development/scripts/agent-exit-hooks.js` - Hooks de saída (para persistência)

### Arquivos de Dados
- `.triviaiox-core/data/workflow-patterns.yaml` - Definições de workflows
...
### Configuração
- `.triviaiox-core/core-config.yaml` - Configuração global (seções git + agentIdentity)

### Agentes (Atualizados)
- `.triviaiox-core/agents/dev.md` - Metadata de visibilidade de comandos
- `.triviaiox-core/agents/po.md` - Metadata de visibilidade de comandos
- `.triviaiox-core/agents/*.md` - 9 agentes restantes (atualização pendente)
...
R: Use o script de teste: `node .triviaiox-core/development/scripts/test-greeting-system.js`

...
# Guia de Service Discovery TRIVIAIOX

> 🌐 [EN](../../guides/service-discovery.md) | **PT** | [ES](../../es/guides/service-discovery.md)

---

> Como descobrir, consultar e usar workers no framework TRIVIAIOX.
...
O sistema de Service Discovery permite encontrar e usar workers (tasks, templates, scripts, workflows) em todo o framework TRIVIAIOX. O **Service Registry** é o catálogo central contendo metadados sobre todos os workers disponíveis.
...
Encontrados 5 workers correspondendo a "create story":
  ...
  [task] dev-create-brownfield-story
         Path: .triviaiox-core/development/tasks/dev-create-brownfield-story.md
...
**Localização:** `.triviaiox-core/development/tasks/`
...
**Localização:** `.triviaiox-core/product/templates/`
...
**Localização:** `.triviaiox-core/infrastructure/scripts/`
...
**Localização:** `.triviaiox-core/development/workflows/`
...
**Localização:** `.triviaiox-core/product/checklists/`
...
_Guia de Service Discovery TriviaGrowth Triviaiox v4_

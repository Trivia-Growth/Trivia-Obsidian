...
Guia completo para desenvolvedores que desejam contribuir com o projeto TriviaGrowth Triviaiox.
...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes TRIVIAIOX    |
| **VS Code / Cursor** | IDE com integração TRIVIAIOX                       |
...
1. Navegue até [github.com/Trivia-Growth/Triviaiox](https://github.com/Trivia-Growth/Triviaiox)
...
Sincronizar agentes TRIVIAIOX com sua IDE:
...
Entendendo a estrutura de diretórios do `triviaiox-core`:

```
triviaiox-core/
├── .triviaiox-core/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.triviaiox-core/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.triviaiox-core/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.triviaiox-core/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.triviaiox-core/development/agents/`:

```bash
# Arquivo: .triviaiox-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .triviaiox-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .triviaiox-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.triviaiox-core/development/tasks/`:
...
# .triviaiox-core/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (TRIVIAIOX Task Format V1.0)
...
Crie um novo arquivo em `.triviaiox-core/development/workflows/`:

```bash
# Arquivo: .triviaiox-core/development/workflows/my-workflow.yaml
```
...
- Marque `@Trivia-Growth/core-team` para issues urgentes
...
_TriviaGrowth Triviaiox Development Setup Guide v1.0.0_

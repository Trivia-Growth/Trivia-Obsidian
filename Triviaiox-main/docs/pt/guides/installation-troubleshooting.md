...
# Guia de Instalação e Solução de Problemas do TRIVIAIOX-Core
...
Este comando baixa e executa a versão mais recente do instalador do TRIVIAIOX-Core.
...
2. **Execute diagnósticos**: `npx triviaiox-core@latest doctor`
3. **Verifique informações do sistema**: `npx triviaiox-core@latest info`
...
| Comando | Descrição |
|---------|-----------|
| `npx triviaiox-core@latest` | Instalar/executar assistente |
| `npx triviaiox-core@latest --version` | Mostrar versão |
| `npx triviaiox-core@latest --help` | Mostrar ajuda |
| `npx triviaiox-core@latest install` | Instalar no diretório atual |
| `npx triviaiox-core@latest init <name>` | Criar novo projeto |
| `npx triviaiox-core@latest doctor` | Executar diagnósticos |
| `npx triviaiox-core@latest info` | Mostrar informações do sistema |

---

*Última atualização: Dezembro 2025 | TRIVIAIOX-Core v2.2.0*

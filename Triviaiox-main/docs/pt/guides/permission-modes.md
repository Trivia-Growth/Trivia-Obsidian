...
> Controle o nível de autonomia que os agentes TRIVIAIOX têm sobre seu sistema.

---

## Visão Geral

Os Modos de Permissão permitem controlar o nível de autonomia dos agentes TRIVIAIOX. Seja explorando um novo codebase ou executando builds totalmente autônomos, há um modo para seu workflow.
...
O modo é persistido em `.triviaiox/config.yaml`:
...
Verifique se `.triviaiox/config.yaml` existe e é gravável:

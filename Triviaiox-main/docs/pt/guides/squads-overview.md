...
Introdução aos TRIVIAIOX Squads - equipes modulares de agentes de IA que estendem a funcionalidade do framework.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do TRIVIAIOX para domínios ou casos de uso específicos. Cada squad é um pacote autocontido que pode ser instalado, compartilhado e composto com outros squads.

> **TRIVIAIOX Squads:** Equipes de agentes de IA trabalhando com você
...
| Agentes Tradicionais   | TRIVIAIOX Squads                  |
| ---------------------- | ---------------------------- |
...
| ----------------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0  | Coleta e transformação de dados    | [triviaiox-squads/etl](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0  | Utilitários de geração de conteúdo | [triviaiox-squads/creator](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) |
...
│  Nível 2: TRIVIAIOX-SQUADS  --> github.com/Trivia-Growth (Público)     │
...
| Modo       | Comportamento                           |
| ---------- | --------------------------------------- |
| `extend`   | Adiciona regras do squad às regras TRIVIAIOX |
| `override` | Substitui regras TRIVIAIOX pelas do squad    |
...
- **Explore Squads Oficiais:** Confira o [repositório triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads)
- **Contribua:** Veja o [Guia de Contribuição de Squads](./contributing-squads.md)
- **Aprenda o Formato de Task:** Leia [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificação de Formato de Task](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_TRIVIAIOX Squads: Equipes de agentes de IA trabalhando com você_

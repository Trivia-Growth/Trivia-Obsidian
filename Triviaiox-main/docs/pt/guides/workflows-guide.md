# Guia de Workflows do TRIVIAIOX
...
Os Workflows do TRIVIAIOX sao sequencias orquestradas de atividades de agents que automatizam processos de desenvolvimento complexos. Eles fornecem padroes estruturados e repetitivos para cenarios de desenvolvimento comuns.
...
O state e persistido em `.triviaiox/{instance-id}-state.yaml`:
...
O TRIVIAIOX detecta padroes comuns de workflow baseados no historico de comandos:
...
| **Localizacao** | `.triviaiox-core/development/workflows/` | `.triviaiox-core/development/tasks/` |
...
*Guia de Workflows do TRIVIAIOX v1.0 - Orquestrando Colaboracao IA-Humano*

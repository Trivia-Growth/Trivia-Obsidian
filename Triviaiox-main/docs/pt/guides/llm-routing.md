...
**Opção 1: Se você tem o triviaiox-core clonado**
```bash
# Do diretório triviaiox-core
...
- **Definição da Ferramenta:** `.triviaiox-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalação:** `.triviaiox-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definição de Tarefa:** `.triviaiox-core/development/tasks/setup-llm-routing.md`
...
*Gerado pelo TRIVIAIOX Framework - Story 6.7*

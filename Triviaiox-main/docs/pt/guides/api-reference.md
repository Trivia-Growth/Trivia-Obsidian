# Referência de API do TRIVIAIOX

> [EN](../../guides/api-reference.md) | **PT** | [ES](../../es/guides/api-reference.md)

---

Referência completa de API para o TriviaGrowth Triviaiox - o Sistema Orquestrado por IA para Desenvolvimento Full Stack.
...
O TRIVIAIOX fornece uma API unificada para interagir com agentes de IA especializados através de dois mecanismos principais:
...
| `@triviaiox-master`   | Orion  | Orchestrator | Orquestração do framework, meta-operações       |

### Comportamento de Ativação

Quando um agente é ativado:

1. O arquivo de definição do agente é carregado de `.triviaiox-core/development/agents/{id}.md`
...
*develop story-1.2.3
    │
    ▼
.triviaiox-core/development/tasks/dev-develop-story.md
    │
    ▼
...
### @triviaiox-master (Orchestrator)

**Desenvolvimento do Framework:**

| Comando                | Argumentos      | Descrição                                           |
| ---------------------- | --------------- | --------------------------------------------------- |
| `*create`              | `{type} {name}` | Criar componente TRIVIAIOX (agent/task/workflow)         |
...
| `*kb`   | -                          | Alternar modo KB (conhecimento do TRIVIAIOX Method)   |
...
```bash
# Iniciar workflow
@triviaiox-master *workflow greenfield-fullstack
...
| -------------------- | ------------------------------- | --------------------------------------------- |
| `AGENT_NOT_FOUND`    | Definição de agente ausente     | Verificar `.triviaiox-core/development/agents/`    |
...
/triviaiox-master  → Ativa agente @triviaiox-master
```
...
- [Guia do Usuário](./user-guide.md) - Começando com TRIVIAIOX
...
- [Guia de Squads](./squads-guide.md) - Estendendo TRIVIAIOX com squads

---

_TriviaGrowth Triviaiox Referência de API v4.2.11_

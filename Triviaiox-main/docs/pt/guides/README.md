...
Índice completo de documentação para os guias do sistema TRIVIAIOX.
...
> **Nota:** A documentação do 1MCP foi descontinuada. O TRIVIAIOX agora usa exclusivamente o Docker MCP Toolkit (Story 5.11). Documentos arquivados disponíveis em `.github/deprecated-docs/guides/`.

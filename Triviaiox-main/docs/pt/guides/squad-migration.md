...
Como migrar squads legados para o formato TRIVIAIOX 2.1.

## Visão Geral

TRIVIAIOX 2.1 introduziu um novo formato de squad com:
...
| Campo TRIVIAIOX type      | Ausente       | `triviaiox.type: squad`         |
| Versão mínima        | Ausente       | `triviaiox.minVersion: "2.1.0"` |
...
- Adiciona campos `triviaiox` ausentes ao manifesto
...
- [ ] `triviaiox.type` é `"squad"`
- [ ] `triviaiox.minVersion` é `"2.1.0"` ou superior

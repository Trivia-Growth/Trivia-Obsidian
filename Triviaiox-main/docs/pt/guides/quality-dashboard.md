...
```
.triviaiox/data/quality-metrics.json
```
...
```bash
# Sincronizar de .triviaiox/data para o dashboard
npm run sync-metrics
...
Isso copia `.triviaiox/data/quality-metrics.json` para `tools/quality-dashboard/public/.triviaiox/data/`.
...
ls -la .triviaiox/data/quality-metrics.json

# Se estiver faltando, popule com dados de exemplo
npx triviaiox metrics seed
```
...
_TriviaGrowth Triviaiox Quality Dashboard v1.0_

# Guia de Testes do TriviaGrowth Triviaiox

> [EN](../../guides/testing-guide.md) | **PT** | [ES](../../es/guides/testing-guide.md)

---

> Guia completo sobre a estratégia de testes, ferramentas e melhores práticas do TriviaGrowth Triviaiox.
...
O TRIVIAIOX segue uma estratégia abrangente de testes que garante qualidade de código em todas as camadas do framework. Nossa filosofia de testes é baseada em:
 ...
 *
 * Garante que agentes de versões anteriores do TRIVIAIOX continuem funcionando.
 */
...
O TRIVIAIOX suporta Windows, macOS e Linux. Testes cross-platform garantem comportamento consistente.
...
│   └── .triviaiox-core/       # Cobertura por módulo
...
O Sistema de Quality Gate do TRIVIAIOX (veja [Guia de Quality Gates](./quality-gates.md)) integra testes em múltiplas camadas:
...
_TriviaGrowth Triviaiox v4 Guia de Testes_

...
# Guia do Sistema de Quality Gates TRIVIAIOX

> 🌐 [EN](../../guides/quality-gates.md) | **PT** | [ES](../../es/guides/quality-gates.md)

---

> Guia completo para o sistema de quality gates de 3 camadas do TriviaGrowth Triviaiox.
...
O Sistema de Quality Gates do TRIVIAIOX fornece garantia de qualidade automatizada através de três camadas progressivas de validação. Cada camada captura diferentes tipos de problemas no estágio apropriado do desenvolvimento.
...
# Executar com opções
triviaiox qa run --verbose          # Saída detalhada
triviaiox qa run --fail-fast        # Parar na primeira falha
triviaiox qa run --continue-on-fail # Continuar apesar de falhas
```
...
_Guia do Sistema de Quality Gates TriviaGrowth Triviaiox v4_

...
Guia completo para criar, validar, publicar e gerenciar Squads no TRIVIAIOX.

> **TRIVIAIOX Squads:** Equipes de AI agents trabalhando com você
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do TRIVIAIOX. Cada squad é um pacote autocontido contendo:
...
│  Nível 2: TRIVIAIOX-SQUADS  → github.com/Trivia-Growth (Público/Free) │
│  Nível 3: TRIVIAGROWTH API   → api.triviagrowth.dev      (Marketplace)  │
└─────────────────────────────────────────────────────────────┘
```
...
| -------------------------------------------------------------------------- | ------ | ---------------------------------- |
| [etl-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl)         | 2.0.0  | Coleta e transformação de dados    |
| [creator-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) | 1.0.0  | Utilitários de geração de conteúdo |
...
- Node.js 18+
- Projeto TRIVIAIOX inicializado (`.triviaiox-core/` existe)
...
Tasks devem seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamento                                   |
| ---------- | ----------------------------------------------- |
| `extend`   | Adiciona regras do squad às regras core do TRIVIAIOX |
...
### Nível 2: Repositório triviaiox-squads (Público)
...
Isso cria um PR para [Trivia-Growth/triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads).

### Nível 3: TriviaGrowth Marketplace
...
3. **Adicionar Campos** - `triviaiox.type`, `triviaiox.minVersion`
...
# - triviaiox.type: deve ser "squad"
# - triviaiox.minVersion: deve ser semver válido
```
...
### Qual a diferença entre um Squad e formatos legados de squad no TRIVIAIOX?

**Squads** são o padrão no TRIVIAIOX 2.1+ com:
...
3. Re-publicar: `*publish-squad` ou `*sync-squad-triviagrowth`
...
- **Nível 3**: Sincronize com flag `--private`: `*sync-squad-triviagrowth my-squad --private`

### Qual a versão mínima do TRIVIAIOX para Squads?

Squads requerem TRIVIAIOX 2.1.0+. Defina no manifesto:
...
- [Repositório triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads)

---

## Obtendo Ajuda

- [GitHub Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions)
- [Issue Tracker](https://github.com/Trivia-Growth/Triviaiox/issues)

---

_TRIVIAIOX Squads: Equipes de AI agents trabalhando com você_

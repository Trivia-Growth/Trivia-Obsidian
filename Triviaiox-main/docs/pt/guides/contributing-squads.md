...
Como contribuir squads para o ecossistema TRIVIAIOX.

## Visão Geral

Existem duas formas de compartilhar seu squad com a comunidade:

1. **Repositório triviaiox-squads** - Squads gratuitos e open-source no GitHub
2. **TriviaGrowth Marketplace** - Squads premium via API TriviaGrowth
...
| **Compatibilidade TRIVIAIOX** | `triviaiox.minVersion: "2.1.0"` ou superior |
...
## Publicando no triviaiox-squads
...
Isso irá:
1. Fazer fork de `Trivia-Growth/triviaiox-squads` (se necessário)
...
## Publicando no TriviaGrowth Marketplace

### Pré-requisitos

1. Conta TriviaGrowth
...
- **Perguntas**: [GitHub Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions)
- **Issues**: [Issue Tracker](https://github.com/Trivia-Growth/Triviaiox/issues)

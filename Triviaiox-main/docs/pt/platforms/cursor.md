...
### Por que usar TRIVIAIOX com Cursor?

O Cursor é uma das **IDEs com IA mais populares** com excelente integração TRIVIAIOX:
...
Verifique se os arquivos TRIVIAIOX foram criados:
...
- Integração do framework TRIVIAIOX
...
### Iniciando o Cursor com TRIVIAIOX
...
R: Execute `npm run sync:ide` após atualizações do TRIVIAIOX.
...
2. Inicialize TRIVIAIOX para Claude Code:
...
- [Guia de Integração TRIVIAIOX](../README.md)

---

_TriviaGrowth Triviaiox - Guia da Plataforma Cursor v1.0_

# Guia TRIVIAIOX para AntiGravity
...
### Por que usar TRIVIAIOX com AntiGravity?
...
```markdown
# Regras TriviaGrowth Triviaiox para AntiGravity
...
1. Seus agentes em `.triviaiox-core/` são portáveis
...
1. Agentes TRIVIAIOX permanecem em `.triviaiox-core/`
...
*TriviaGrowth Triviaiox - Guia da Plataforma AntiGravity v1.0*

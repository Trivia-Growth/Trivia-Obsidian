# Guia TRIVIAIOX para Claude Code

> 🌐 [EN](../../platforms/claude-code.md) | **PT** | [ES](../../es/platforms/claude-code.md)

---

> **CLI Oficial da Anthropic** - Plataforma Recomendada para TRIVIAIOX
...
### Por que usar TRIVIAIOX com Claude Code?

O Claude Code oferece a **melhor integração** com o TRIVIAIOX devido a:
...
### Passo 3: Instalar o TRIVIAIOX

```bash
# Navegue até seu projeto
cd seu-projeto

# Inicialize o TRIVIAIOX
...
# Verificar se os arquivos TRIVIAIOX foram criados
ls -la .claude/
```
...
- Entendimento do framework TRIVIAIOX
...
export TRIVIAIOX_DEBUG="true"                        # Habilitar log de debug
```
...
```mermaid
flowchart LR
    Source["TRIVIAIOX Core<br/>.triviaiox-core/development/agents"] --> Parser["Parser de Agente"]
...
1. Alterações locais são salvas em `.claude/commands/TRIVIAIOX/agents/.backup/`
...
### Perguntas Específicas do TRIVIAIOX
...
R: Em `.claude/commands/TRIVIAIOX/agents/` após a sincronização.

**P: Com que frequência devo sincronizar agentes?**
R: Após atualizar o TRIVIAIOX ou quando agentes são modificados no core.
...
2. Inicialize o TRIVIAIOX com Claude Code:
   ```bash
...
1. Seus agentes TRIVIAIOX estão armazenados em `.triviaiox-core/development/agents/`
2. Inicialize o TRIVIAIOX para a IDE de destino
...
*TriviaGrowth Triviaiox - Guia da Plataforma Claude Code v1.0*

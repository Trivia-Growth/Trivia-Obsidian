# Guia TRIVIAIOX para GitHub Copilot
...
### Por que usar TRIVIAIOX com GitHub Copilot?
...
Este projeto usa TriviaGrowth Triviaiox para desenvolvimento orquestrado por IA.
...
Você é um Desenvolvedor Full Stack Sênior trabalhando com TriviaGrowth Triviaiox.
...
### Ativando Modos de Agente TRIVIAIOX

1. Abra a visualização de Chat
2. Clique no seletor de modo (topo do chat)
3. Selecione o modo desejado (Agent, Plan, Ask, Edit)
4. Para agentes TRIVIAIOX, use modos de chat personalizados em `.github/chatmodes/`

### Modos TRIVIAIOX Personalizados

| Modo | Propósito |
|------|-----------|
| `triviaiox-dev` | Desenvolvimento full-stack |
| `triviaiox-qa` | Garantia de qualidade |
| `triviaiox-architect` | Design de sistema |
| `triviaiox-pm` | Gerenciamento de projeto |

### Exemplos de Interação

```
# No modo triviaiox-dev:
Implemente a feature de autenticação de usuário da story

# No modo triviaiox-qa:
Revise o módulo de auth para vulnerabilidades de segurança

# No modo triviaiox-architect:
...
```
Problema: Modos de agente TRIVIAIOX não no seletor
```
**Solução:**
...
1. Instale TRIVIAIOX para Copilot:
   ```bash
...
1. Agentes armazenados em `.triviaiox-core/` são portáveis
...
*TriviaGrowth Triviaiox - Guia da Plataforma GitHub Copilot v1.0*

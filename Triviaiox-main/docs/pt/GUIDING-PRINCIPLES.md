...
# Princípios Orientadores do Método TRIVIAIOX

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | **PT** | [ES](../es/GUIDING-PRINCIPLES.md)

---

O Método TRIVIAIOX é um framework em linguagem natural para desenvolvimento de software assistido por IA. Estes princípios garantem que as contribuições mantenham a efetividade do método.
...
Templates seguem a especificação do [TRIVIAIOX Document Template](../../common/utils/triviaiox-doc-template.md) usando formato YAML:

...
# Especificação de Nomenclatura do TRIVIAIOX

> 🌐 [EN](../triviaiox-nomenclature-specification.md) | **PT** | [ES](../es/triviaiox-nomenclature-specification.md)
...
Este documento estabelece nomenclatura clara para o TRIVIAIOX diferenciando entre:
...
**Características:**
- **Escopo:** Interno a um único arquivo de task (`.triviaiox-core/tasks/*.md`)
...
- **Localização:** Definido em `.triviaiox-core/workflows/*.yaml` ou seções de workflow de stories
...
**Conceito:** Inspirado pelo protocolo Organizer-Worker do AsyncThink, workflows do TRIVIAIOX podem usar um **Organizer Agent** que coordena **Worker Agents** executando tasks em paralelo.

**Aplicação ao TRIVIAIOX:**
...
- Exemplo: `.triviaiox-core/tasks/security-scan.md`

**Arquivos de Workflow:**
- Localização: `.triviaiox-core/workflows/{workflow-name}.yaml`
- Contém: Definição de orquestração multi-task
- Exemplo: `.triviaiox-core/workflows/story-development-workflow.yaml`
...
3. **Gerenciamento de Workflow TRIVIAIOX:** Padrões de workflow existentes no TRIVIAIOX

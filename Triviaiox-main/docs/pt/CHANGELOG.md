...
Todas as alteracoes notaveis do TriviaGrowth Triviaiox serao documentadas neste arquivo.
...
- **Estrutura de Diretorios**: Renomeado `.legacy-core/` para `.triviaiox-core/`
...
- **Configuracao de IDE**: Agentes do Claude Code movidos para `.claude/commands/TRIVIAIOX/agents/`
...
- Processo de instalacao manual (use `npx triviaiox-core install` em vez disso)
...
- Lancamento publico inicial do TriviaGrowth Triviaiox
...
1. Diretorio renomeado: `.legacy-core/` -> `.triviaiox-core/`

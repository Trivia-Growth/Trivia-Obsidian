...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.triviaiox-core/infrastructure/scripts/asset-inventory.js`   | JS Script   | ✅     |
| path-analyzer.js     | `.triviaiox-core/infrastructure/scripts/path-analyzer.js`     | JS Script   | ✅     |
| migrate-agent.js     | `.triviaiox-core/infrastructure/scripts/migrate-agent.js`     | JS Script   | ✅     |
| agent-v3-schema.json | `.triviaiox-core/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | ✅     |
| task-v3-schema.json  | `.triviaiox-core/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | ✅     |
...
- **Todos os agents** sincronizados em `.claude/commands/TRIVIAIOX/agents/`

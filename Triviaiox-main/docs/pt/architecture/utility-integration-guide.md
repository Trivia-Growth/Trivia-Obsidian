...
**Propósito:** Definir padrões para integração de scripts utilitários no framework TRIVIAIOX

---

## O que é Integração de Utilitários?

**Definição:** Integração de utilitários é o processo de tornar um script utilitário órfão **descobrível, documentado e utilizável** dentro do framework TRIVIAIOX.
...
- `.triviaiox-core/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.triviaiox-core/core-config.yaml` (registrar se necessário)
- `.triviaiox-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.triviaiox-core/tasks/{task}.md` (adicionar execution.utils)
- `.triviaiox-core/agents/{agent}.yaml` (adicionar task à lista executes)
- `.triviaiox-core/core-config.yaml` (registrar se necessário)
- `.triviaiox-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.triviaiox-core/core-config.yaml` (registrar em framework)
- `.triviaiox-core/utils/README.md` (documentar como utilitário de framework)
...
- `.triviaiox-core/tasks/{task}.md` (se criar task)
- `.triviaiox-core/core-config.yaml`
...
**Exemplos:** triviaiox-validator, code-quality-improver, coverage-analyzer
...
**Localização:** `.triviaiox-core/utils/{name}.js`

...
| **Ícone** | 🏗️ |
| **Arquivo** | `.triviaiox-core/development/agents/squad-creator.md` |
...
| `*publish-squad` | squad-creator-publish.md | ⏳ Placeholder | Publicar no triviaiox-squads |
| `*sync-squad-triviagrowth` | squad-creator-sync-triviagrowth.md | ⏳ Placeholder | Sincronizar com marketplace |
...
| SquadPublisher | squad-publisher.js | Publicar no triviaiox-squads |

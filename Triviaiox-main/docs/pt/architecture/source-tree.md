...
# Estrutura da Árvore de Código TRIVIAIOX
...
**Aviso de Migração:** Este documento será migrado para o repositório `Trivia-Growth/Triviaiox` no Q2 2026 (veja Decisão 005)
...
- [Estrutura Atual (triviaiox-core Brownfield)](#estrutura-atual-triviaiox-core-brownfield)
...
TRIVIAIOX utiliza uma **arquitetura de camada dupla**:

1. **Framework Core** (`.triviaiox-core/`) - Componentes portáteis do framework
...
## Estrutura Atual (triviaiox-core Brownfield)

```
triviaiox-core/                             # Raiz (projeto brownfield)
├── .triviaiox-core/                        # Core do framework (portátil)
...
│
├── bin/                               # Executáveis CLI
│   ├── triviaiox-core.js              # Ponto de entrada principal da CLI
│   └── triviaiox-minimal.js                # CLI mínima
│
...
**Propósito:** Componentes portáteis do framework que funcionam em qualquer projeto TRIVIAIOX.
...
Workflows:
  Location: .triviaiox-core/workflows/
  Format: YAML
...
Squads são extensões modulares que adicionam capacidades especializadas ao TRIVIAIOX. Diferente dos Squads descontinuados, Squads seguem uma estrutura de template padronizada.
...
│   └── cli/                           # Interface CLI
│
├── .triviaiox-core/                        # Ativos do framework (estrutura atual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Localização: .triviaiox-core/agents/{agent-name}.md
Exemplo: .triviaiox-core/agents/security-expert.md

# Estou criando uma nova tarefa:
Localização: .triviaiox-core/tasks/{task-name}.md
Exemplo: .triviaiox-core/tasks/deploy-to-production.md

# Estou criando um novo workflow:
Localização: .triviaiox-core/workflows/{workflow-name}.yaml
Exemplo: .triviaiox-core/workflows/continuous-deployment.yaml

# Estou criando um novo template:
Localização: .triviaiox-core/product/templates/{template-name}-tmpl.{yaml|md}
Exemplo: .triviaiox-core/product/templates/deployment-plan-tmpl.yaml

# Estou escrevendo uma story:
Localização: docs/stories/{epic-context}/{story-file}.md
Exemplo: docs/stories/triviaiox migration/story-6.1.2.6.md
...
Localização: .triviaiox-core/utils/{utility-name}.js
Exemplo: .triviaiox-core/utils/performance-monitor.js

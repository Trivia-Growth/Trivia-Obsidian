...
```
.triviaiox-core/development/scripts/squad/
...
```
.triviaiox-core/development/agents/squad-creator.md  # Adicionar novos comandos
.triviaiox-core/schemas/squad-schema.json            # (sem alterações necessárias)
```

...
| ------------------------ | ------------------------------------------------------------ | --------- | ------ |
| worktree-manager.js      | `.triviaiox-core/infrastructure/scripts/worktree-manager.js`      | JS Script | ✅     |
| story-worktree-hooks.js  | `.triviaiox-core/infrastructure/scripts/story-worktree-hooks.js`  | JS Script | ✅     |
| project-status-loader.js | `.triviaiox-core/infrastructure/scripts/project-status-loader.js` | JS Script | ✅     |
| auto-worktree.yaml       | `.triviaiox-core/development/workflows/auto-worktree.yaml`        | Workflow  | ✅     |
| worktree-create.md       | `.triviaiox-core/development/tasks/worktree-create.md`            | Task      | ✅     |
| worktree-list.md         | `.triviaiox-core/development/tasks/worktree-list.md`              | Task      | ✅     |
| worktree-merge.md        | `.triviaiox-core/development/tasks/worktree-merge.md`             | Task      | ✅     |
...
- **status.json**: Status do worktree rastreado em `.triviaiox/status.json`
- **Dashboard**: API do WorktreeManager consumida pelo TRIVIAIOX Dashboard

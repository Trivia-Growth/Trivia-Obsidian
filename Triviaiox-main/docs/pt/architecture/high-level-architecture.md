...
# Arquitetura de Alto Nível do TRIVIAIOX v4
...
**TRIVIAIOX (AI Operating System)** é um framework sofisticado para orquestração de agentes de IA, workers e humanos em fluxos de trabalho complexos de desenvolvimento de software. A versão 2.1 introduz uma arquitetura modular com 4 módulos, estratégia multi-repositório e quality gates de 3 camadas.
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                     FRAMEWORK TRIVIAIOX v4                                 │
│                     ═══════════════════                                 │
│                                                                         │
│   ┌─────────────────────────────────────────────────────────────────┐   │
│   │                        CLI / FERRAMENTAS                        │   │
│   │  (triviaiox agents, triviaiox tasks, triviaiox squads, triviaiox workflow)          │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                │                                        │
│          ┌────────────────────┼────────────────────┐                   │
│          │                    │                    │                   │
...
| --------------------- | ----------- | -------------- |
| `@triviaiox/core`          | npm público | MIT            |
| `@triviaiox/squad-etl`     | npm público | MIT            |
| `@triviaiox/squad-creator` | npm público | MIT            |
| `@triviaiox/squad-mmos`    | npm público | MIT            |
| `@triviaiox/mcp-presets`   | npm público | Apache 2.0     |
...
```
triviaiox-core/
├── .triviaiox-core/                    # Camada do Framework
...
| ------------------ | ---------------------------- | --------------------- | ------------------------------------ |
| **Core**           | `.triviaiox-core/core/`           | Fundação do framework | Config, Registry, QG, MCP, Session   |
| **Development**    | `.triviaiox-core/development/`    | Artefatos de dev      | Agentes, Tarefas, Workflows, Scripts |
| **Product**        | `.triviaiox-core/product/`        | Artefatos PM          | Templates, Checklists, Dados         |
| **Infrastructure** | `.triviaiox-core/infrastructure/` | Config do sistema     | Scripts, Ferramentas, Integrações    |
...
| Pax    | `triviaiox-master`   | Orchestrator | Orquestração do framework |
...
- [TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.triviaiox-core/docs/standards/TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guia completo do framework

...
**Fonte:** `gh api repos/Trivia-Growth/Triviaiox/branches/main/protection`
...
**Fonte:** `gh api repos/Trivia-Growth/Triviaiox`
...
**Fonte:** `gh api repos/Trivia-Growth/Triviaiox/actions/workflows`
...
1. Criar `.coderabbit.yaml` com regras específicas do TRIVIAIOX

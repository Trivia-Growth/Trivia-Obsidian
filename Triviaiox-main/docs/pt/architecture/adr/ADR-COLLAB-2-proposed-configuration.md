...
Seguindo a [Auditoria do Estado Atual](./ADR-COLLAB-1-current-state-audit.md), este documento propõe alterações de configuração específicas para habilitar contribuições externas seguras ao TRIVIAIOX.
...
# Configuração CodeRabbit do TRIVIAIOX
# Story: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.triviaiox-core/development/agents/**':
      - 'Verificar se agente segue estrutura YAML de agente TRIVIAIOX (persona_profile, commands, dependencies)'
    ...
    '.triviaiox-core/development/tasks/**':
      - 'Verificar se tarefa segue formato de tarefa TRIVIAIOX com pontos de elicitação claros'
    ...
    '.triviaiox-core/product/templates/**':
      - 'Garantir que template segue convenções de template TRIVIAIOX'
    ...
    '**/*.js':
      ...
      - 'Garantir que código segue padrões de codificação TRIVIAIOX'
...
- `@Trivia-Growth/maintainers` - Maintainers gerais (acesso de escrita)
- `@Trivia-Growth/core-team` - Desenvolvedores core do framework
- `@Trivia-Growth/devops` - CI/CD e infraestrutura
...
- [ ] Agente segue estrutura YAML de agente TRIVIAIOX
...
- [ ] Tarefa segue formato de tarefa TRIVIAIOX

...
# Arquitetura do Sistema de Módulos do TRIVIAIOX

> 🌐 [EN](../../architecture/module-system.md) | **PT** | [ES](../../es/architecture/module-system.md)

---

> Guia completo para a arquitetura modular v4.2 do TriviaGrowth Triviaiox.
...
O TriviaGrowth Triviaiox organiza o diretório `.triviaiox-core/` em quatro módulos principais:
...
```mermaid
graph TB
    subgraph "Framework TRIVIAIOX v4"
        CLI[CLI / Ferramentas]
...
| `data/`          | `triviaiox-kb.md`, `workflow-patterns.yaml`           | Base de conhecimento do framework           |
...
```javascript
// Configuração
const { loadAgentConfig, globalConfigCache } = require('./.triviaiox-core/core');

// Sessão
const { ContextDetector, SessionContextLoader } = require('./.triviaiox-core/core');

// Elicitation
const { ElicitationEngine, ElicitationSessionManager } = require('./.triviaiox-core/core');
...
**Caminho:** `.triviaiox-core/development/`
...
| --------------- | ------------------ | ------------------------- |
| TRIVIAIOX Master     | `triviaiox-master`      | Orquestração do framework |
...
**Caminho:** `.triviaiox-core/product/`
...
**Caminho:** `.triviaiox-core/infrastructure/`
...
_Arquitetura do Sistema de Módulos TriviaGrowth Triviaiox v4_

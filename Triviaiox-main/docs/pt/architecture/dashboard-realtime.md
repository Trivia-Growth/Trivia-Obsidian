# 🔴 TRIVIAIOX Dashboard - Arquitetura de Observabilidade em Tempo Real
...
Este documento descreve a arquitetura para **observabilidade em tempo real** do TRIVIAIOX Dashboard, permitindo que usuários acompanhem comandos executados no CLI com máximo detalhe visual.
...
│                                                                              │
│  .triviaiox/dashboard/events.jsonl (HIGH-LEVEL ONLY)                             │
│  ─────────────────────────────────────────────────────                      │

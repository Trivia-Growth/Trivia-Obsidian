...
Este guia explica como ferramentas são integradas com agentes TRIVIAIOX. Ferramentas estendem as capacidades dos agentes fornecendo acesso a serviços externos, APIs e recursos do sistema.
...
| `tasks`        | Arquivos de workflow de tarefas     | `.triviaiox-core/development/tasks/`    |
| `checklists`   | Checklists de validação             | `.triviaiox-core/product/checklists/`   |

### Exemplo de Declaração

```yaml
# Do arquivo .triviaiox-core/development/agents/dev.md
dependencies:
  checklists:
...
TRIVIAIOX implementa governança rigorosa de operações git:
...
- [Definições de Agentes](../../../.triviaiox-core/development/agents/)

...
# Melhores Práticas de Segurança do TriviaGrowth Triviaiox

> 🌐 [EN](../security-best-practices.md) | **PT** | [ES](../es/security-best-practices.md)

---

Este guia fornece recomendações abrangentes de segurança para implantação e manutenção do TriviaGrowth Triviaiox em ambientes de produção.
...
O TriviaGrowth Triviaiox implementa uma abordagem de segurança em múltiplas camadas:
...
AUDIT_LOG_FILE=/var/log/triviaiox/audit.log
```
...
chmod 600 .env
chmod 600 .triviaiox/config.json
chmod 600 .triviaiox/users.json
chmod 600 .triviaiox/sessions.json
chmod 700 .triviaiox/
chmod 700 security/
```
...
Para dúvidas ou preocupações de segurança, abra uma issue em: https://github.com/Trivia-Growth/Triviaiox/issues

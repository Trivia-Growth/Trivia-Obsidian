...
# Estrutura do Source Tree TRIVIAIOX
...
**Repositório:** Trivia-Growth/Triviaiox
...
O TRIVIAIOX usa uma **arquitetura modular** com clara separação de responsabilidades:

1. **Framework Core** (`.triviaiox-core/`) - Componentes portáveis do framework organizados por domínio
...
│   └── triviaiox-kb.md                     # Base de conhecimento TRIVIAIOX
│
├── development/                       # Assets de Desenvolvimento
│   ├── agents/                        # Definições de agentes (11 agentes core)
│   │   ├── triviaiox-master.md             # Orquestrador master
...
│   ├── triviaiox migration/                # Stories de migração TRIVIAIOX
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads são extensões modulares que adicionam capacidades especializadas ao TRIVIAIOX. Diferente dos Squads deprecados, Squads seguem uma estrutura de template padronizada.
...
```
squads/
├── verified/                          # Squads curados pelo TRIVIAIOX
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
| 1.1    | 2025-12-14 | Atualizado org para Trivia-Growth, substituído Squads pelo sistema Squads [Story 6.10]                                       | Dex (dev)        |
...
_Este é um padrão oficial do framework TRIVIAIOX. Todo posicionamento de arquivos deve seguir esta estrutura._

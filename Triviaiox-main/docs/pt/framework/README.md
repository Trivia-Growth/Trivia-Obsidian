...
# Documentação do Framework TRIVIAIOX
...
**Destino de Migração:** Q2 2026 → repositório `Trivia-Growth/Triviaiox`

---

## Visão Geral

Este diretório contém **documentação oficial do framework TRIVIAIOX** que define padrões, patterns e estruturas aplicáveis em todos os projetos TRIVIAIOX (greenfield e brownfield).
...
**IMPORTANTE**: Estes documentos agora estão no repositório `Trivia-Growth/Triviaiox`. A migração do antigo org `triviaiox/triviaiox-core` foi concluída em dezembro de 2024 como parte do OSR-9 (Rebranding).

### Cronograma de Migração

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Docs do framework separados em `docs/framework/`
- **Fase 2 (Q4 2024):** Repositório migrado para `Trivia-Growth/Triviaiox` (OSR-9)
...
- **Escopo**: Portável entre todos os projetos TRIVIAIOX
- **Exemplos**: Padrões de código, tech stack, estrutura de source tree
- **Ciclo de vida**: Vive no repositório `Trivia-Growth/Triviaiox`
...
1. **Leia os docs do framework durante o onboarding** - Entenda os padrões TRIVIAIOX
...
### Para Mantenedores do Framework TRIVIAIOX
...
**Mantenedor**: Equipe do Framework TRIVIAIOX

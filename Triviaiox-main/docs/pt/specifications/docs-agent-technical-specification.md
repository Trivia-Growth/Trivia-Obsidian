...
**@docs (Ajax)** e um agente de IA especializado em criar **documentacao educacional** para o TRIVIAIOX. Diferente da documentacao tecnica (JSDoc/Typedoc), Ajax foca em **tutoriais, guias de onboarding, explicadores visuais e materiais de treinamento para parceiros**.
...
whenToUse: |
  ...
  - Tutoriais explicando como usar recursos do TRIVIAIOX
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de cores TRIVIAIOX)"
      blocker: false
...
whenToUse: |
  ...
  - Novo parceiro entra no ecossistema TRIVIAIOX
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Links para documentacao TRIVIAIOX relevante"
      blocker: false
...
[Nome do Agente] e o agente de [funcao] do TRIVIAIOX, especializado em [expertise principal].
...
**Notas do Template:**
- Use paleta de cores TRIVIAIOX (Azul primario, Roxo secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Atualizacao @docs do TRIVIAIOX
...
- [ ] Criar `squads/triviaiox/agents/docs/agent.yaml`
...
- [ ] **Reconhecimento da Industria:** Docs do TRIVIAIOX citados como "melhor no espaco de agentes de IA"
...
Com a adicao do @docs (Ajax), TRIVIAIOX agora tem **13 agentes nomeados**:
...
| 13 | @triviaiox-master | Orion | Commander | Aries | Cyan |

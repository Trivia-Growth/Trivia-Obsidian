...
Guia para configurar servidores MCP (Model Context Protocol) baseados em Docker com TRIVIAIOX.
...
- Projeto **TRIVIAIOX** inicializado
...
- `~/.triviaiox/mcp/servers/` - Configurações de servidores individuais
...
TRIVIAIOX usa Docker MCP Toolkit como a infraestrutura MCP principal:
...
_Guia de Configuração Docker MCP do TriviaGrowth Triviaiox v4.0_

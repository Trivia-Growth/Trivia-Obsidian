...
Levamos a segurança a sério na Trivia-Growth. Se você descobrir uma vulnerabilidade de segurança no TRIVIAIOX, por favor reporte de forma responsável.
...
1. **GitHub Security Advisories** (Preferido)
   - Vá para [Security Advisories](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
   - Clique em "Report a vulnerability"
   - Preencha o formulário com detalhes

2. **GitHub Issues (Privado)**
   - Abra um [security advisory privado](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
...
Ao usar o TRIVIAIOX Framework, recomendamos:
...
O TRIVIAIOX Framework executa código e comandos gerados por IA. Usuários devem:
...
- TRIVIAIOX pode processar dados sensíveis através de provedores de IA
...
- [GitHub Security Advisories](https://github.com/Trivia-Growth/Triviaiox/security/advisories)

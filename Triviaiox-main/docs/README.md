# TriviaGrowth Triviaiox Documentation
...
├── framework/                 # English
├── platforms/                 # English
├── triviaiox-agent-flows/          # Detailed agent documentation (PT) — legacy root location
├── triviaiox-workflows/            # Detailed workflow documentation (PT) — legacy root location
│
...
- [Agent System Documentation](./en/triviaiox-agent-flows/README.md)
- [Workflow Documentation](./en/triviaiox-workflows/README.md)
...
- [Documentação do Sistema de Agentes](./triviaiox-agent-flows/README.md)
- [Documentação de Workflows](./triviaiox-workflows/README.md)
...
- [Documentación del Sistema de Agentes](./es/triviaiox-agent-flows/README.md)
- [Documentación de Workflows](./es/triviaiox-workflows/README.md)
...
- [代理系统文档](./zh/triviaiox-agent-flows/README.md)
- [工作流文档](./zh/triviaiox-workflows/README.md)
...
This documentation is part of TriviaGrowth Triviaiox, licensed under [MIT License](../LICENSE).

---

_TriviaGrowth Triviaiox - Orchestrating AI for Better Software Development_

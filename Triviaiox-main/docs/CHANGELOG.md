...
- **🤖 TRIVIAIOX Autonomous Development Engine (ADE)**: Complete autonomous development system with 7 Epics:
...
- **Agent Sync**: All agents now synced between `.triviaiox-core/development/agents/` and `.claude/commands/TRIVIAIOX/agents/`
...
- **Directory Structure**: Renamed `.legacy-core/` to `.triviaiox-core/`
...
- **IDE Configuration**: Claude Code agents moved to `.claude/commands/TRIVIAIOX/agents/`
- **File Locations**:
  ...
  - `.triviaiox-core/utils/` → `.triviaiox-core/scripts/`
...
- Manual installation process (use `npx triviaiox-core install` instead)
...
- Initial public release of TriviaGrowth Triviaiox
...
1. Directory renamed: `.legacy-core/` → `.triviaiox-core/`
...
- [GitHub Repository](https://github.com/Trivia-Growth/Triviaiox)

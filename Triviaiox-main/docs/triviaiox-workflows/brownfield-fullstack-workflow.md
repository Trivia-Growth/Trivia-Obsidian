...
> **Arquivo Fonte:** `.triviaiox-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo de Task:** `.triviaiox-core/development/tasks/document-project.md`
...
**Arquivo de Checklist:** `.triviaiox-core/product/checklists/po-master-checklist.md`
...
**Arquivo de Task:** `.triviaiox-core/development/tasks/shard-doc.md`
...
**Arquivos de Task:**
- `.triviaiox-core/development/tasks/create-next-story.md`
- `.triviaiox-core/development/tasks/create-brownfield-story.md`
...
- [ ] Core config TRIVIAIOX configurado (`.triviaiox-core/core-config.yaml`)
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/workflows/brownfield-fullstack.yaml` | Definição do workflow |
| `.triviaiox-core/development/tasks/brownfield-create-story.md` | Task para criar story simples |
| `.triviaiox-core/development/tasks/brownfield-create-epic.md` | Task para criar epic |
| `.triviaiox-core/development/tasks/document-project.md` | Task para documentar projeto existente |
| `.triviaiox-core/development/tasks/shard-doc.md` | Task para fragmentar documentos |
| `.triviaiox-core/development/tasks/create-brownfield-story.md` | Task para criar story brownfield |
| `.triviaiox-core/development/tasks/create-next-story.md` | Task para criar story de PRD |
| `.triviaiox-core/product/checklists/po-master-checklist.md` | Checklist de validação PO |

### Arquivos de Agentes

| Arquivo | Agente |
|---------|--------|
| `.triviaiox-core/development/agents/analyst.md` | @analyst (Atlas) |
| `.triviaiox-core/development/agents/architect.md` | @architect (Aria) |
| `.triviaiox-core/development/agents/pm.md` | @pm (Morgan) |
| `.triviaiox-core/development/agents/po.md` | @po (Pax) |
| `.triviaiox-core/development/agents/sm.md` | @sm (River) |
| `.triviaiox-core/development/agents/dev.md` | @dev (Dex) |
| `.triviaiox-core/development/agents/qa.md` | @qa (Quinn) |
...
| `.triviaiox-core/working-in-the-brownfield.md` | Guia de trabalho brownfield |

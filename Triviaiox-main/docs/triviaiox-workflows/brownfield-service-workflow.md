...
|---------|-----------|---------|
| Workflow Definition | Definição YAML do workflow | `.triviaiox-core/development/workflows/brownfield-service.yaml` |
...
| PO Master Checklist | Checklist de validação | `.triviaiox-core/development/checklists/po-master-checklist.md` |
...
- [Technical Preferences](../../../.triviaiox-core/development/data/technical-preferences.md) - Preferências técnicas do projeto

...
|------|------|--------|---------|
| Gather Requirements | 1 | @pm | `.triviaiox-core/development/tasks/spec-gather-requirements.md` |
| Assess Complexity | 2 | @architect | `.triviaiox-core/development/tasks/spec-assess-complexity.md` |
| Research Dependencies | 3 | @analyst | `.triviaiox-core/development/tasks/spec-research-dependencies.md` |
| Write Specification | 4 | @pm | `.triviaiox-core/development/tasks/spec-write-spec.md` |
| Critique Specification | 5, 5c | @qa | `.triviaiox-core/development/tasks/spec-critique.md` |
| Create Implementation Plan | 6 | @architect | `.triviaiox-core/development/tasks/plan-create-implementation.md` |
...
| Arquivo | Localização |
|---------|-------------|
| Definicao do Workflow | `.triviaiox-core/development/workflows/spec-pipeline.yaml` |
| Task: Gather | `.triviaiox-core/development/tasks/spec-gather-requirements.md` |
| Task: Assess | `.triviaiox-core/development/tasks/spec-assess-complexity.md` |
| Task: Research | `.triviaiox-core/development/tasks/spec-research-dependencies.md` |
| Task: Write Spec | `.triviaiox-core/development/tasks/spec-write-spec.md` |
| Task: Critique | `.triviaiox-core/development/tasks/spec-critique.md` |
| Task: Create Plan | `.triviaiox-core/development/tasks/plan-create-implementation.md` |
...
- [TRIVIAIOX Documentation Index](../TRIVIAIOX-DOCUMENTATION-INDEX.md)
...
metadata:
  ...
  baseado_em:
    - .triviaiox-core/development/workflows/spec-pipeline.yaml
    - .triviaiox-core/development/tasks/spec-*.md

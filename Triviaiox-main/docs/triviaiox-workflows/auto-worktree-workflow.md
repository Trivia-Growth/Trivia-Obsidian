...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Não existe| ERR3[Erro: TRIVIAIOX incompleto]
...
```mermaid
graph TB
    subgraph TRIVIAIOX["TRIVIAIOX Core"]
    ...
    subgraph FS["File System"]
        WT[.triviaiox/worktrees/{storyId}/<br/>Worktree Directory]
        LOG[.triviaiox/logs/merges/<br/>Merge Audit Logs]
    end
...
**Estrutura Criada:**
```
.triviaiox/worktrees/{storyId}/     # Diretório de trabalho
...
```bash
git worktree add .triviaiox/worktrees/{storyId} -b auto-claude/{storyId}
```
...
```bash
TRIVIAIOX_WORKTREE=/path/to/.triviaiox/worktrees/{storyId}
TRIVIAIOX_STORY={storyId}
```
...
| Propriedade | Valor |
|-------------|-------|
| **Localização** | `.triviaiox-core/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versão** | 1.0 |
| **Story** | 1.3 |
...
| **TRIVIAIOX Core** | Instalado | Verificar `.triviaiox-core/` |
...
| `WorktreeManager not found` | TRIVIAIOX incompleto | Reinstalar TRIVIAIOX |
...
ls .triviaiox-core/infrastructure/scripts/worktree-manager.js
```
...
3. Aumentar limite (se necessário) em `.triviaiox/config.yaml`
...
| Arquivo | Caminho |
|---------|---------|
| **Workflow Definition** | `.triviaiox-core/development/workflows/auto-worktree.yaml` |
| **Task Create** | `.triviaiox-core/development/tasks/create-worktree.md` |
| **WorktreeManager** | `.triviaiox-core/infrastructure/scripts/worktree-manager.js` |
...
*Documentação gerada automaticamente pelo TRIVIAIOX-FULLSTACK*

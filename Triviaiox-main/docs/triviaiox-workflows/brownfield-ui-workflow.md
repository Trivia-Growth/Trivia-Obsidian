...
| **Templates TRIVIAIOX** | Templates instalados | Verificar `.triviaiox-core/development/templates/` |
| **Agentes Configurados** | Todos os agentes do workflow | Verificar `.triviaiox-core/development/agents/` |
...
|-----------|-------------|-----------------|
| Templates de PRD | `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml` | Step 2 |
| Template Frontend | `.triviaiox-core/development/templates/front-end-spec-tmpl.yaml` | Step 3 |
| Template Arquitetura | `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml` | Step 4 |
| Checklist PO | `.triviaiox-core/development/checklists/po-master-checklist.md` | Step 5 |
| Template Story | `.triviaiox-core/development/templates/story-tmpl.yaml` | Step 8 |
...
```bash
ls .triviaiox-core/development/templates/
```

2. Verificar nome correto do template no workflow
3. Se necessario, reinstalar templates do TRIVIAIOX core
...
|-----------|-------------|-----------|
| TRIVIAIOX Knowledge Base | `.triviaiox-core/data/triviaiox-kb.md` | Base de conhecimento TRIVIAIOX |
| IDE Development Workflow | `.triviaiox-core/data/triviaiox-kb.md#IDE Development Workflow` | Workflow de desenvolvimento IDE |
| Brownfield PRD Template | `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| Frontend Spec Template | `.triviaiox-core/development/templates/front-end-spec-tmpl.yaml` | Template especificacao frontend |
| Brownfield Architecture Template | `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| PO Master Checklist | `.triviaiox-core/development/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Agentes

| Agente | Arquivo | Documentação |
|--------|---------|--------------|
| @architect | `.triviaiox-core/development/agents/architect.md` | Aria - Holistic System Architect |
| @pm | `.triviaiox-core/development/agents/pm.md` | Morgan - Product Manager |
| @ux-expert | `.triviaiox-core/development/agents/ux-design-expert.md` | Uma - UX/UI Designer |
| @po | `.triviaiox-core/development/agents/po.md` | Pax - Product Owner |
| @sm | `.triviaiox-core/development/agents/sm.md` | River - Scrum Master |
| @analyst | `.triviaiox-core/development/agents/analyst.md` | Atlas - Business Analyst |
| @dev | `.triviaiox-core/development/agents/dev.md` | Dex - Full Stack Developer |
| @qa | `.triviaiox-core/development/agents/qa.md` | Quinn - Test Architect |
...
*Documentacao gerada automaticamente a partir de `.triviaiox-core/development/workflows/brownfield-ui.yaml`*

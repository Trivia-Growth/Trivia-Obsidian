...
O **Story Development Cycle** e o workflow central do TRIVIAIOX para desenvolvimento de stories. Ele automatiza o fluxo completo desde a criacao ate a entrega com quality gate integrado, seguindo a sequencia: **criar -> validar -> implementar -> QA review**.
...
1. **core-config.yaml** - Arquivo de configuracao TRIVIAIOX obrigatorio
...
2. **Story Template** - `story-tmpl.yaml` disponivel em `.triviaiox-core/development/templates/`
...
| Story template | YAML | `.triviaiox-core/development/templates/` | Template padrao |
...
| Arquivo | Caminho |
|---------|---------|
| Workflow Definition | `.triviaiox-core/development/workflows/story-development-cycle.yaml` |
| SM Agent | `.triviaiox-core/development/agents/sm.md` |
| PO Agent | `.triviaiox-core/development/agents/po.md` |
| Dev Agent | `.triviaiox-core/development/agents/dev.md` |
| QA Agent | `.triviaiox-core/development/agents/qa.md` |
| Create Story Task | `.triviaiox-core/development/tasks/create-next-story.md` |
| Validate Story Task | `.triviaiox-core/development/tasks/validate-next-story.md` |
| Develop Story Task | `.triviaiox-core/development/tasks/dev-develop-story.md` |
| QA Gate Task | `.triviaiox-core/development/tasks/qa-gate.md` |
| Story Template | `.triviaiox-core/development/templates/story-tmpl.yaml` |

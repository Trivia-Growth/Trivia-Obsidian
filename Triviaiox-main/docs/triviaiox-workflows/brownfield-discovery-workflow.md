...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.triviaiox-core/development/workflows/brownfield-discovery.yaml` |
| Task: brownfield-create-epic | `.triviaiox-core/development/tasks/brownfield-create-epic.md` |
| Task: brownfield-create-story | `.triviaiox-core/development/tasks/brownfield-create-story.md` |
| Task: db-schema-audit | `.triviaiox-core/development/tasks/db-schema-audit.md` |
| Task: security-audit | `.triviaiox-core/development/tasks/security-audit.md` |
...
| @data-engineer | `.triviaiox-core/development/agents/data-engineer.md` |
| @ux-design-expert | `.triviaiox-core/development/agents/ux-design-expert.md` |
...
- [Guia de Workflows TRIVIAIOX](../TRIVIAIOX-WORKFLOWS-GUIDE.md)

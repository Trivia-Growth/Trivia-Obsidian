...
**Versão:** 1.0
**Criado:** 2026-02-04
**Fonte:** `.triviaiox-core/development/workflows/greenfield-service.yaml`
...
**Referencia:** `.triviaiox-core/data/triviaiox-kb.md#IDE Development Workflow`
...
| Arquivo | Descricao |
|---------|-----------|
| `.triviaiox-core/core-config.yaml` | Configuracao do framework |
...
|----------|-------------|--------|
| `project-brief-tmpl.yaml` | `.triviaiox-core/development/templates/` | analyst |
| `prd-tmpl.yaml` | `.triviaiox-core/development/templates/` | pm |
| `architecture-tmpl.yaml` | `.triviaiox-core/development/templates/` | architect |
| `story-tmpl.yaml` | `.triviaiox-core/development/templates/` | sm |
| `qa-gate-tmpl.yaml` | `.triviaiox-core/development/templates/` | qa |
...
| Tipo | Localizacao |
|------|-------------|
| Logs do agente | `.triviaiox/logs/agent.log` |
| Status do projeto | `.triviaiox/project-registry.yaml` |
...
cat .triviaiox/project-status.yaml
...
| Arquivo | Descricao |
|---------|-----------|
| `.triviaiox-core/development/workflows/greenfield-service.yaml` | Definicao do workflow |
| `.triviaiox-core/data/triviaiox-kb.md` | Knowledge base do TRIVIAIOX |

### Agentes

| Arquivo | Agente |
|---------|--------|
| `.triviaiox-core/development/agents/analyst.md` | Atlas (Analyst) |
| `.triviaiox-core/development/agents/pm.md` | Morgan (PM) |
| `.triviaiox-core/development/agents/architect.md` | Aria (Architect) |
| `.triviaiox-core/development/agents/po.md` | Pax (PO) |
| `.triviaiox-core/development/agents/sm.md` | River (SM) |
| `.triviaiox-core/development/agents/dev.md` | Dex (Dev) |
| `.triviaiox-core/development/agents/qa.md` | Quinn (QA) |

### Tasks Principais

| Arquivo | Task |
|---------|------|
| `.triviaiox-core/development/tasks/create-doc.md` | Criacao de documentos |
| `.triviaiox-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| `.triviaiox-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| `.triviaiox-core/development/tasks/dev-develop-story.md` | Implementacao de stories |
| `.triviaiox-core/development/tasks/qa-review-story.md` | Revisao de implementacao |
| `.triviaiox-core/development/tasks/execute-checklist.md` | Execucao de checklists |

### Templates

| Arquivo | Template |
|---------|----------|
| `.triviaiox-core/development/templates/project-brief-tmpl.yaml` | Project Brief |
| `.triviaiox-core/development/templates/prd-tmpl.yaml` | PRD |
| `.triviaiox-core/development/templates/architecture-tmpl.yaml` | Arquitetura |
| `.triviaiox-core/development/templates/story-tmpl.yaml` | User Story |
| `.triviaiox-core/development/templates/qa-gate-tmpl.yaml` | QA Gate |

### Checklists

| Arquivo | Checklist |
|---------|-----------|
| `.triviaiox-core/development/checklists/po-master-checklist.md` | Validacao PO |
| `.triviaiox-core/development/checklists/story-draft-checklist.md` | Validacao Story Draft |
| `.triviaiox-core/development/checklists/story-dod-checklist.md` | Definition of Done |
...
*Documentacao gerada automaticamente a partir de `.triviaiox-core/development/workflows/greenfield-service.yaml`*

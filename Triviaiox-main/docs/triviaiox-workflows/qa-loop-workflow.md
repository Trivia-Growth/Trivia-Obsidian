...
**Localização:** `.triviaiox-core/development/tasks/qa-review-story.md`
...
**Localização:** `.triviaiox-core/development/tasks/qa-create-fix-request.md`
...
**Localização:** `.triviaiox-core/development/tasks/dev-apply-qa-fixes.md`
...
No arquivo `.triviaiox-core/core-config.yaml`:
...
| Arquivo | Localização |
|---------|-------------|
| Workflow Definition | `.triviaiox-core/development/workflows/qa-loop.yaml` |
| QA Review Task | `.triviaiox-core/development/tasks/qa-review-story.md` |
| Create Fix Request Task | `.triviaiox-core/development/tasks/qa-create-fix-request.md` |
| Apply QA Fixes Task | `.triviaiox-core/development/tasks/dev-apply-qa-fixes.md` |
...
|----------|-------------|-----|
| `qa-gate-tmpl.yaml` | `.triviaiox-core/development/templates/` | Gate file structure |
| `story-tmpl.yaml` | `.triviaiox-core/development/templates/` | Story file structure |

...
Guide for setting up Docker-based MCP (Model Context Protocol) servers with TRIVIAIOX.
...
- [DevOps Agent](../.triviaiox-core/development/agents/devops.md)

---

_TriviaGrowth Triviaiox Docker MCP Setup Guide v4.2.11_

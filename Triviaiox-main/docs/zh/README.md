...
├── framework/                 # English
├── platforms/                 # English
├── triviaiox-agent-flows/          # Detailed agent documentation (PT)
├── triviaiox-workflows/            # Detailed workflow documentation (PT)
│
├── pt/                        # Português
├── es/                        # Español
└── zh/                        # 中文（简体）
...
- [代理系统文档](./triviaiox-agent-flows/README.md)
- [工作流文档](./triviaiox-workflows/README.md)

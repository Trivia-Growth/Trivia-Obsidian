# 对 TriviaGrowth Triviaiox 做出贡献

> **[葡萄牙語版本](../CONTRIBUTING-PT.md)**

欢迎来到 TRIVIAIOX！感谢您对贡献的兴趣。本指南将帮助您了解我们的开发工作流程、贡献流程以及如何提交更改。
...
- [Squad 讨论](https://github.com/Trivia-Growth/Triviaiox/discussions/categories/ideas) - 分享想法
...
TRIVIAIOX 实施了 **深度防御**策略，有 3 个验证层：
...
- **GitHub Issues：** [打开一个 issue](https://github.com/Trivia-Growth/Triviaiox/issues)
- **讨论：** [开始讨论](https://github.com/Trivia-Growth/Triviaiox/discussions)
...
TRIVIAIOX 使用 Open Core 模型，带有私人 `pro/` git 子模块（见 [ADR-PRO-001](../docs/architecture/adr/adr-pro-001-repository-strategy.md)）。
...
**推送顺序：** 始终先推送 `pro/` 更改，然后是 `triviaiox-core`。
...
**感谢您对 TriviaGrowth Triviaiox 的贡献！**

<!--
  翻译：zh-CN（简体中文）
  原文：/docs/triviaiox-agent-flows/squad-creator-system.md
  最后同步：2026-02-22
-->
...
**小队创建者** (Craft) 是 TRIVIAIOX 用于创建、验证、发布和管理小队的专业代理。小队是代理、任务、工作流和资源的模块化包，可在项目之间重用。

该系统实现了 TRIVIAIOX 的**任务优先架构**，其中任务是执行的主要入口点，代理编排这些任务。

### 系统目的

- **创建小队**遵循 TRIVIAIOX 模式和结构
- **验证小队**针对 JSON Schema 和任务规范
- **列出小队**项目本地
- **分发小队**在 3 个级别（本地、triviaiox-squads、TriviaGrowth API）
- **迁移小队**到带编排和技能的 v2 格式
- **分析和扩展**现有小队
...
4. **3 级分发**：本地、公共（triviaiox-squads）、市场（TriviaGrowth API）
5. **与 triviaiox-core 集成**：小队与框架协同工作
...
| 文件 | 目的 |
|---------|-----------|
| `.triviaiox-core/development/agents/squad-creator.md` | 小队创建者代理核心定义 |
| `.claude/commands/TRIVIAIOX/agents/squad-creator.md` | 用于激活 @squad-creator 的 Claude Code 命令 |

### @squad-creator 任务文件

| 文件 | 命令 | 目的 | 状态 |
|---------|---------|-----------|--------|
| `.triviaiox-core/development/tasks/squad-creator-create.md` | `*create-squad` | 创建带完整结构的新小队 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-design.md` | `*design-squad` | 分析文档并生成蓝图 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | 验证小队针对 schema 和模式 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-list.md` | `*list-squads` | 列出本地小队 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | 分析结构并建议改进 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | 使用新组件扩展小队 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | 迁移小队到 v2 格式 | 活跃 |
| `.triviaiox-core/development/tasks/squad-generate-skills.md` | `*generate-skills` | 生成小队知识技能 | 活跃 |
| `.triviaiox-core/development/tasks/squad-generate-workflow.md` | `*generate-workflow` | 生成 YAML 编排工作流 | 活跃 |
| `.triviaiox-core/development/tasks/squad-creator-download.md` | `*download-squad` | 从公共仓库下载小队 | 占位符（Sprint 8） |
| `.triviaiox-core/development/tasks/squad-creator-publish.md` | `*publish-squad` | 发布小队到 triviaiox-squads | 占位符（Sprint 8） |
| `.triviaiox-core/development/tasks/squad-creator-sync-triviagrowth.md` | `*sync-squad-triviagrowth` | 同步小队到 TriviaGrowth API | 占位符（Sprint 8） |

### 相关任务文件

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/create-agent.md` | `*create-agent` | 创建单个代理定义 |
| `.triviaiox-core/development/tasks/create-task.md` | `*create-task` | 创建单个任务文件 |
| `.triviaiox-core/development/tasks/create-workflow.md` | `*create-workflow` | 创建编排工作流 |

### 支持脚本

| 文件 | 类/函数 | 目的 |
|---------|---------------|-----------|
| `.triviaiox-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | 生成完整小队结构 |
| `.triviaiox-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | 验证小队针对 schema 和模式 |
| `.triviaiox-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | 加载和解析小队 |
| `.triviaiox-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | 分析文档并生成蓝图 |
| `.triviaiox-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | 分析小队结构 |
| `.triviaiox-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | 扩展现有小队 |
| `.triviaiox-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | 迁移小队到 v2 |
| `.triviaiox-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | 从仓库下载小队 |
| `.triviaiox-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | 发布小队 |

### JSON Schema

| 文件 | 目的 |
|---------|-----------|
| `.triviaiox-core/schemas/squad-schema.json` | squad.yaml 验证 schema |
| `.triviaiox-core/schemas/squad-design-schema.json` | 蓝图验证 schema |
...
flowchart TB
    ...
    subgraph DISTRIBUTE["分发"]
        LOCAL["本地<br/>./squads/"]
        PUBLIC["公共<br/>github.com/Trivia-Growth/triviaiox-squads"]
        MARKET["市场<br/>api.triviagrowth.dev/squads"]
    end
...
| 命令 | 任务文件 | 操作 |
|---------|-----------|----------|
| `*download-squad` | `squad-creator-download.md` | 从 triviaiox-squads 下载小队 |
| `*publish-squad` | `squad-creator-publish.md` | 发布小队到 triviaiox-squads |
| `*sync-squad-triviagrowth` | `squad-creator-sync-triviagrowth.md` | 同步小队到 TriviaGrowth API |
...
triviaiox:
  minVersion: string  # TRIVIAIOX 最低版本
  type: squad
...
flowchart LR
    ...
    subgraph MARKET["级别 3：市场"]
        ...
        M_DESC["通过 TriviaGrowth API 的高级小队"]
...
- [任务：squad-creator-create.md](.triviaiox-core/development/tasks/squad-creator-create.md)
- [任务：squad-creator-validate.md](.triviaiox-core/development/tasks/squad-creator-validate.md)
- [任务：squad-creator-design.md](.triviaiox-core/development/tasks/squad-creator-design.md)
- [脚本：squad-generator.js](.triviaiox-core/development/scripts/squad/squad-generator.js)
- [脚本：squad-validator.js](.triviaiox-core/development/scripts/squad/squad-validator.js)
- [Schema：squad-schema.json](.triviaiox-core/schemas/squad-schema.json)
- [代理：squad-creator.md](.triviaiox-core/development/agents/squad-creator.md)
- [命令：squad-creator.md](.claude/commands/TRIVIAIOX/agents/squad-creator.md)

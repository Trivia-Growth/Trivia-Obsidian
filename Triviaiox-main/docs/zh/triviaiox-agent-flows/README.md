<!--
  翻译：zh-CN（简体中文）
  原文：/docs/triviaiox-agent-flows/README.md
  最后同步：2026-02-22
-->

# TRIVIAIOX 代理流程 - 代理详细文档

> 🌐 [PT](../../triviaiox-agent-flows/README.md) | [EN](../../en/triviaiox-agent-flows/README.md) | [ES](../../es/triviaiox-agent-flows/README.md) | **ZH**
...
| 代理 | 角色 | 原型 | 文档 |
|--------|---------|-----------|-----------|
| **@triviaiox-master** | Orion | 编排者 | [triviaiox-master-system.md](./triviaiox-master-system.md) |
...
| TRIVIAIOX 工作流 | [docs/triviaiox-workflows/](../triviaiox-workflows/) | 工作流详情 |
...
*TRIVIAIOX 代理流程文档 v1.0 - 代理系统详细文档*

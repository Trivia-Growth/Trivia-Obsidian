<!--
  翻译：zh-CN（简体中文）
  原文：/docs/triviaiox-agent-flows/pm-system.md
  最后同步：2026-02-22
-->

# 产品经理 (PM) 代理系统 - TRIVIAIOX
...
本文档描述 TRIVIAIOX 产品经理 (PM) 代理的完整系统，包括所有涉及的文件、工作流程、可用命令和代理之间的集成。
...
| 文件 | 目的 |
|---------|-----------|
| `.triviaiox-core/development/agents/pm.md` | PM 代理核心定义 |
| `.claude/commands/TRIVIAIOX/agents/pm.md` | 用于激活 @pm 的 Claude Code 命令 |

### @pm 任务

| 文件 | 命令 | 目的 |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/create-doc.md` | `*create-prd` | 从 YAML 模板创建文档 |
| `.triviaiox-core/development/tasks/correct-course.md` | `*correct-course` | 分析并纠正项目偏差 |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | `*research` | 生成深度研究提示 |
| `.triviaiox-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | 为棕地项目创建史诗 |
| `.triviaiox-core/development/tasks/brownfield-create-story.md` | `*create-story` | 为棕地创建故事 |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*checklist` | 执行检查清单验证 |
| `.triviaiox-core/development/tasks/shard-doc.md` | `*shard-prd` | 拆分大型文档 |

### @pm 模板

| 文件 | 目的 |
|---------|-----------|
| `.triviaiox-core/product/templates/prd-tmpl.yaml` | 绿地项目 PRD 模板 |
| `.triviaiox-core/product/templates/brownfield-prd-tmpl.yaml` | 棕地项目 PRD 模板 |

### @pm 检查清单

| 文件 | 目的 |
|---------|-----------|
| `.triviaiox-core/product/checklists/pm-checklist.md` | PRD 验证检查清单 |
| `.triviaiox-core/product/checklists/change-checklist.md` | 变更导航检查清单 |

### 使用 @pm 的工作流

| 文件 | 阶段 | 目的 |
|---------|------|-----------|
| `.triviaiox-core/development/workflows/brownfield-discovery.yaml` | 阶段 10 | 发现后创建史诗和故事 |
...
**解决方案：**
- 检查 `.triviaiox-core/product/templates/`
...
- [代理定义：pm.md](.triviaiox-core/development/agents/pm.md)
- [任务：create-doc.md](.triviaiox-core/development/tasks/create-doc.md)
- [任务：brownfield-create-epic.md](.triviaiox-core/development/tasks/brownfield-create-epic.md)
- [任务：correct-course.md](.triviaiox-core/development/tasks/correct-course.md)
- [模板：prd-tmpl.yaml](.triviaiox-core/product/templates/prd-tmpl.yaml)
- [模板：brownfield-prd-tmpl.yaml](.triviaiox-core/product/templates/brownfield-prd-tmpl.yaml)
- [检查清单：pm-checklist.md](.triviaiox-core/product/checklists/pm-checklist.md)

...
**版本:** 1.0
**创建:** 2026-02-04
**源:** `.triviaiox-core/development/workflows/greenfield-service.yaml`
...
**参考:** `.triviaiox-core/data/triviaiox-kb.md#IDE Development Workflow`
...
| 文件 | 描述 |
|------|------|
| `.triviaiox-core/core-config.yaml` | 框架配置 |
| `.env` | 环境变量 |
...
| 类型 | 位置 |
|------|------|
| 代理日志 | `.triviaiox/logs/agent.log` |
| 项目状态 | `.triviaiox/project-registry.yaml` |
...
| 文件 | 描述 |
|------|------|
| `.triviaiox-core/development/workflows/greenfield-service.yaml` | 工作流定义 |
| `.triviaiox-core/data/triviaiox-kb.md` | TRIVIAIOX 知识库 |

### 代理

| 文件 | 代理 |
|------|------|
| `.triviaiox-core/development/agents/analyst.md` | Atlas (分析师) |
| `.triviaiox-core/development/agents/pm.md` | Morgan (PM) |
| `.triviaiox-core/development/agents/architect.md` | Aria (架构师) |
...
| 文件 | 任务 |
|------|------|
| `.triviaiox-core/development/tasks/create-doc.md` | 创建文档 |
| `.triviaiox-core/development/tasks/shard-doc.md` | 分片文档 |
| `.triviaiox-core/development/tasks/sm-create-next-story.md` | 创建故事 |
| `.triviaiox-core/development/tasks/dev-develop-story.md` | 实施故事 |
| `.triviaiox-core/development/tasks/qa-review-story.md` | 审阅实现 |
| `.triviaiox-core/development/tasks/execute-checklist.md` | 执行检查列表 |

### 模板

| 文件 | 模板 |
|------|------|
| `.triviaiox-core/development/templates/project-brief-tmpl.yaml` | 项目简报 |
| `.triviaiox-core/development/templates/prd-tmpl.yaml` | PRD |
| `.triviaiox-core/development/templates/architecture-tmpl.yaml` | 架构 |
| `.triviaiox-core/development/templates/story-tmpl.yaml` | 用户故事 |
| `.triviaiox-core/development/templates/qa-gate-tmpl.yaml` | 质量保证关卡 |

### 检查列表

| 文件 | 检查列表 |
|------|----------|
| `.triviaiox-core/development/checklists/po-master-checklist.md` | PO 验证 |
| `.triviaiox-core/development/checklists/story-draft-checklist.md` | 验证故事草稿 |
| `.triviaiox-core/development/checklists/story-dod-checklist.md` | 完成定义 |
...
*文档自动从 `.triviaiox-core/development/workflows/greenfield-service.yaml` 生成*

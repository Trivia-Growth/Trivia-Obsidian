...
| 任务 | 阶段 | 代理 | 文件 |
|------|------|------|------|
| 收集需求 | 1 | @pm | `.triviaiox-core/development/tasks/spec-gather-requirements.md` |
| 评估复杂性 | 2 | @architect | `.triviaiox-core/development/tasks/spec-assess-complexity.md` |
| 研究依赖 | 3 | @analyst | `.triviaiox-core/development/tasks/spec-research-dependencies.md` |
| 编写规范 | 4 | @pm | `.triviaiox-core/development/tasks/spec-write-spec.md` |
| 批评规范 | 5, 5c | @qa | `.triviaiox-core/development/tasks/spec-critique.md` |
| 创建实现计划 | 6 | @architect | `.triviaiox-core/development/tasks/plan-create-implementation.md` |
...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.triviaiox-core/development/workflows/spec-pipeline.yaml` |
| 任务: 收集 | `.triviaiox-core/development/tasks/spec-gather-requirements.md` |
| 任务: 评估 | `.triviaiox-core/development/tasks/spec-assess-complexity.md` |
| 任务: 研究 | `.triviaiox-core/development/tasks/spec-research-dependencies.md` |
| 任务: 编写规范 | `.triviaiox-core/development/tasks/spec-write-spec.md` |
| 任务: 批评 | `.triviaiox-core/development/tasks/spec-critique.md` |
| 任务: 创建计划 | `.triviaiox-core/development/tasks/plan-create-implementation.md` |
...
- [TRIVIAIOX 文档索引](../TRIVIAIOX-DOCUMENTATION-INDEX.md)

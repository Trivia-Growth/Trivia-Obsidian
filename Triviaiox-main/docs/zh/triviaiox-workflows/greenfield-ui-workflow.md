...
2. **TRIVIAIOX-Core 可用**
   - `.triviaiox-core/development/templates/` 中的模板
   - `.triviaiox-core/development/tasks/` 中的任务
   - `.triviaiox-core/development/checklists/` 中的检查列表
...
| 问题 | 可能原因 | 解决方案 |
|------|---------|---------|
| 模板未找到 | 路径不正确 | 检查 `.triviaiox-core/development/templates/` |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.triviaiox-core/development/workflows/greenfield-ui.yaml` |
| 知识库 | `.triviaiox-core/data/triviaiox-kb.md` |
...
| 模板 | 路径 |
|------|------|
| 项目简报 | `.triviaiox-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.triviaiox-core/development/templates/prd-tmpl.yaml` |
| 前端规范 | `.triviaiox-core/development/templates/front-end-spec-tmpl.yaml` |
| 前端架构 | `.triviaiox-core/development/templates/front-end-architecture-tmpl.yaml` |
| 故事 | `.triviaiox-core/development/templates/story-tmpl.yaml` |

### 检查列表

| 检查列表 | 路径 |
|---------|------|
| PO 主检查 | `.triviaiox-core/development/checklists/po-master-checklist.md` |
| 故事草稿 | `.triviaiox-core/development/checklists/story-draft-checklist.md` |
| 故事完成定义 | `.triviaiox-core/development/checklists/story-dod-checklist.md` |

### 相关文档

- [TRIVIAIOX 知识库](.triviaiox-core/data/triviaiox-kb.md) - 中央知识库
...
*文档自动从 `.triviaiox-core/development/workflows/greenfield-ui.yaml` 生成*

...
> **类型：** 棕地项目开发
> **状态：** 官方文档
> **源文件：** `.triviaiox-core/development/workflows/brownfield-fullstack.yaml`
...
**任务文件：** `.triviaiox-core/development/tasks/document-project.md`
...
**清单文件：** `.triviaiox-core/development/checklists/po-master-checklist.md`
...
**任务文件：** `.triviaiox-core/development/tasks/shard-doc.md`
...
- [ ] TRIVIAIOX核心配置已配置 (`.triviaiox-core/core-config.yaml`)
...
| 文件 | 目的 |
|------|------|
| `.triviaiox-core/development/workflows/brownfield-fullstack.yaml` | 工作流定义 |
| `.triviaiox-core/development/tasks/brownfield-create-story.md` | 创建简单故事的任务 |
| `.triviaiox-core/development/tasks/brownfield-create-epic.md` | 创建史诗的任务 |
| `.triviaiox-core/development/tasks/document-project.md` | 记录现有项目的任务 |
| `.triviaiox-core/development/tasks/shard-doc.md` | 分割文档的任务 |
| `.triviaiox-core/development/tasks/create-brownfield-story.md` | 创建棕地故事的任务 |
| `.triviaiox-core/development/tasks/create-next-story.md` | 从PRD创建故事的任务 |
| `.triviaiox-core/product/checklists/po-master-checklist.md` | PO验证清单 |
...
| `.triviaiox-core/working-in-the-brownfield.md` | 棕地工作指南 |

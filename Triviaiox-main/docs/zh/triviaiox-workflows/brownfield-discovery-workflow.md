...
| 文件 | 位置 |
|------|------|
| 工作流定义 | `.triviaiox-core/development/workflows/brownfield-discovery.yaml` |
| 任务：brownfield-create-epic | `.triviaiox-core/development/tasks/brownfield-create-epic.md` |
| 任务：brownfield-create-story | `.triviaiox-core/development/tasks/brownfield-create-story.md` |
| 任务：db-schema-audit | `.triviaiox-core/development/tasks/db-schema-audit.md` |
| 任务：security-audit | `.triviaiox-core/development/tasks/security-audit.md` |

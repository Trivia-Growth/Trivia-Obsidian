...
**故事开发循环**是 TRIVIAIOX 中央工作流，用于故事开发。它自动化从创建到交付的完整流程，整合质量网关，遵循序列: **创建 -> 验证 -> 实现 -> QA 审查**。
...
1. **core-config.yaml** - 必需的 TRIVIAIOX 配置文件
   - `devStoryLocation` - 故事位置
   - `prd.*` - PRD 配置
   - `architecture.*` - 架构配置
   - `qa.qaLocation` - QA 工件位置

2. **故事模板** - `.triviaiox-core/development/templates/` 中的 `story-tmpl.yaml`
...
| 故事模板 | YAML | `.triviaiox-core/development/templates/` | 标准模板 |
...
| 文件 | 路径 |
|------|------|
| 工作流定义 | `.triviaiox-core/development/workflows/story-development-cycle.yaml` |
| SM 代理 | `.triviaiox-core/development/agents/sm.md` |
| PO 代理 | `.triviaiox-core/development/agents/po.md` |
| 开发代理 | `.triviaiox-core/development/agents/dev.md` |
| QA 代理 | `.triviaiox-core/development/agents/qa.md` |
| 创建故事任务 | `.triviaiox-core/development/tasks/create-next-story.md` |
| 验证故事任务 | `.triviaiox-core/development/tasks/validate-next-story.md` |
| 开发故事任务 | `.triviaiox-core/development/tasks/dev-develop-story.md` |
| QA 网关任务 | `.triviaiox-core/development/tasks/qa-gate.md` |
| 故事模板 | `.triviaiox-core/development/templates/story-tmpl.yaml` |

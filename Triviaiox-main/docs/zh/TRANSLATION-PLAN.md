# TriviaGrowth Triviaiox 中文文档翻译计划
...
本文档描述了将 TriviaGrowth Triviaiox 文档翻译成中文的完整计划。
...
**代理流程文档 (triviaiox-agent-flows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 代理流程 README | `triviaiox-agent-flows/README.md` | `zh/triviaiox-agent-flows/README.md` | ⬜ |
| TRIVIAIOX Master 系统 | `triviaiox-agent-flows/triviaiox-master-system.md` | `zh/triviaiox-agent-flows/triviaiox-master-system.md` | ⬜ |
| 开发者系统 | `triviaiox-agent-flows/dev-system.md` | `zh/triviaiox-agent-flows/dev-system.md` | ⬜ |
| 架构师系统 | `triviaiox-agent-flows/architect-system.md` | `zh/triviaiox-agent-flows/architect-system.md` | ⬜ |
| QA 系统 | `triviaiox-agent-flows/qa-system.md` | `zh/triviaiox-agent-flows/qa-system.md` | ⬜ |
| UX 设计专家系统 | `triviaiox-agent-flows/ux-design-expert-system.md` | `zh/triviaiox-agent-flows/ux-design-expert-system.md` | ⬜ |
| 数据工程师系统 | `triviaiox-agent-flows/data-engineer-system.md` | `zh/triviaiox-agent-flows/data-engineer-system.md` | ⬜ |
| 分析师系统 | `triviaiox-agent-flows/analyst-system.md` | `zh/triviaiox-agent-flows/analyst-system.md` | ⬜ |
| 产品经理系统 | `triviaiox-agent-flows/pm-system.md` | `zh/triviaiox-agent-flows/pm-system.md` | ⬜ |
| Scrum Master 系统 | `triviaiox-agent-flows/sm-system.md` | `zh/triviaiox-agent-flows/sm-system.md` | ⬜ |
| DevOps 系统 | `triviaiox-agent-flows/devops-system.md` | `zh/triviaiox-agent-flows/devops-system.md` | ⬜ |
| Squad 创建者系统 | `triviaiox-agent-flows/squad-creator-system.md` | `zh/triviaiox-agent-flows/squad-creator-system.md` | ⬜ |

**工作流文档 (triviaiox-workflows/)：**

| 文档 | 原文路径 | 译文路径 | 状态 |
|------|----------|----------|------|
| 工作流 README | `triviaiox-workflows/README.md` | `zh/triviaiox-workflows/README.md` | ⬜ |
| 绿地全栈工作流 | `triviaiox-workflows/greenfield-fullstack-workflow.md` | `zh/triviaiox-workflows/greenfield-fullstack-workflow.md` | ⬜ |
| 绿地服务工作流 | `triviaiox-workflows/greenfield-service-workflow.md` | `zh/triviaiox-workflows/greenfield-service-workflow.md` | ⬜ |
| 绿地 UI 工作流 | `triviaiox-workflows/greenfield-ui-workflow.md` | `zh/triviaiox-workflows/greenfield-ui-workflow.md` | ⬜ |
| 棕地全栈工作流 | `triviaiox-workflows/brownfield-fullstack-workflow.md` | `zh/triviaiox-workflows/brownfield-fullstack-workflow.md` | ⬜ |
| 棕地服务工作流 | `triviaiox-workflows/brownfield-service-workflow.md` | `zh/triviaiox-workflows/brownfield-service-workflow.md` | ⬜ |
| 棕地 UI 工作流 | `triviaiox-workflows/brownfield-ui-workflow.md` | `zh/triviaiox-workflows/brownfield-ui-workflow.md` | ⬜ |
| 棕地发现工作流 | `triviaiox-workflows/brownfield-discovery-workflow.md` | `zh/triviaiox-workflows/brownfield-discovery-workflow.md` | ⬜ |
| 规格流水线工作流 | `triviaiox-workflows/spec-pipeline-workflow.md` | `zh/triviaiox-workflows/spec-pipeline-workflow.md` | ⬜ |
| QA 循环工作流 | `triviaiox-workflows/qa-loop-workflow.md` | `zh/triviaiox-workflows/qa-loop-workflow.md` | ⬜ |
| Story 开发周期 | `triviaiox-workflows/story-development-cycle-workflow.md` | `zh/triviaiox-workflows/story-development-cycle-workflow.md` | ⬜ |
...
| TRIVIAIOX 视觉概览 | `architecture/TRIVIAIOX-VISUAL-OVERVIEW.md` | `zh/architecture/TRIVIAIOX-VISUAL-OVERVIEW.md` | ⬜ |
...
| Gate | 门控 | 門控 | 质量门控 |
| Persona | 角色 / 人格 | 角色 / 人格 | |
| Constitution | 宪法 / 准则 | 憲法 / 準則 | TRIVIAIOX Constitution |
| CLI | CLI / 命令行 | CLI / 命令列 | |
| Hook | 钩子 | 鉤子 | |
| MCP | MCP | MCP | 不翻译 |
...
3. **保留品牌名** - TriviaGrowth、TRIVIAIOX、Claude 等品牌名不翻译
...
│       └── README.md
│
├── triviaiox-agent-flows/                   # 代理流程
│   ├── README.md
│   ├── triviaiox-master-system.md
│   ├── dev-system.md
│   ├── architect-system.md
│   ├── qa-system.md
...
*TriviaGrowth Triviaiox 中文文档翻译计划 v1.0*
*创建日期：2026-02-22*

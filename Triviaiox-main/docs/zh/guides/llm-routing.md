...
- **工具定义:** `.triviaiox-core/infrastructure/tools/cli/llm-routing.yaml`
- **安装脚本:** `.triviaiox-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **任务定义:** `.triviaiox-core/development/tasks/setup-llm-routing.md`
...
*由 TRIVIAIOX Framework 生成 - Story 6.7*

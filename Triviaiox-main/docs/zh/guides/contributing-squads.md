...
如何向TRIVIAIOX生态系统贡献Squad。

## 概述

有两种方式与社区共享你的Squad：

1. **triviaiox-squads Repository** - GitHub上的免费开源Squad
2. **TriviaGrowth Marketplace** - 通过TriviaGrowth API的高级Squad
...
| **TRIVIAIOX兼容性** | `triviaiox.minVersion: "2.1.0"` 或更高 |
...
这将：
1. Fork `Trivia-Growth/triviaiox-squads` （如需要）
2. 用你的Squad创建分支
3. 开启审查PR
...
- **问题**: [GitHub讨论](https://github.com/Trivia-Growth/Triviaiox/discussions)
- **问题**: [问题跟踪器](https://github.com/Trivia-Growth/Triviaiox/issues)
- **指南**: 本文档

...
为想要为 TriviaGrowth Triviaiox 项目做出贡献的开发者提供的完整指南。
...
| 工具                 | 目的                                 |
| -------------------- | ------------------------------------ |
| **Claude Code**      | 与 TRIVIAIOX 代理进行 AI 驱动的开发       |
| **VS Code / Cursor** | 带 TRIVIAIOX 集成的 IDE                   |
...
1. 导航至 [github.com/Trivia-Growth/Triviaiox](https://github.com/Trivia-Growth/Triviaiox)
2. 点击右上角的 **Fork** 按钮
...
_TriviaGrowth Triviaiox 开发设置指南 v1.0.0_
_最后更新：2026-01-29_

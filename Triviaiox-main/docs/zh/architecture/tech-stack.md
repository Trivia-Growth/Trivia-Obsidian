...
**迁移通知:** 本文档将在 2026 Q2 迁移到 `Trivia-Growth/Triviaiox` 仓库 (参见决策 005)
...
TRIVIAIOX 构建在现代 JavaScript/TypeScript 和 Node.js 运行时上，优化用于开发具有交互式 UX 和代理编排功能的跨平台 CLI。
...
```yaml
基线: 30MB (Node.js + TRIVIAIOX core)
代理执行: +10MB (每个代理)
...
| 1.1  | 2025-12-14 | 更新对 Trivia-Growth/Triviaiox 的迁移通知、semantic-release 到 v25.0.2 [故事 6.10] | Dex (dev)        |

---

_这是 TRIVIAIOX 框架的官方模式。所有技术选择应与本栈保持一致。_

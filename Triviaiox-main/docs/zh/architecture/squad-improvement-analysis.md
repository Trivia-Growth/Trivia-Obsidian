...
| **职位**       | Squad Creator                              |
| **图标**       | 🏗️                                         |
| **文件**       | `.triviaiox-core/development/agents/squad-creator.md` |
...
| `*publish-squad`   | squad-creator-publish.md     | ⏳ 占位符   | 发布到 triviaiox-squads |
| `*sync-squad-triviagrowth` | squad-creator-sync-triviagrowth.md | ⏳ 占位符  | 同步到市场       |
...
| SquadPublisher  | squad-publisher.js   | 发布到 triviaiox-squads |

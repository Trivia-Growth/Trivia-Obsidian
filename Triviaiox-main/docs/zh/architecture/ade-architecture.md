...
**自主开发引擎 (ADE)** 是 TRIVIAIOX 用于自主开发工作流的基础设施。它使 AI 代理能够通过智能管道、自愈循环和持久学习独立工作。
...
状态文件: .triviaiox/project-status.yaml
```
...
| 类型         | 描述                    | 存储                              |
| ------------ | ----------------------- | --------------------------------- |
| 代码模式     | 来自代码库的可重用模式  | .triviaiox/patterns/code-patterns.json |
| 陷阱         | 已知问题和解决方案      | .triviaiox/patterns/gotchas.json       |
| 会话洞察     | 会话期间的发现          | .triviaiox/sessions/                   |
| 代码库地图   | 项目结构分析            | .triviaiox/codebase-map.json           |
...
位于 `.triviaiox-core/core-config.yaml`:
...
_这是记录自主开发引擎的官方 TRIVIAIOX 框架标准。_

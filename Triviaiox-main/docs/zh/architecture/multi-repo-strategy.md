...
- [概览](#概览)
- [仓库结构](#仓库结构)
- [主要仓库 (triviaiox-core)](#主要仓库-triviaiox-core)
- [Squad 仓库](#squad-仓库)
...
TRIVIAIOX v4 采用**多仓库策略**以实现模块化开发、社区贡献和核心框架、扩展(squads)和专有组件之间的清晰分离。
...
Trivia-Growth 组织
├── 公共仓库
│   ├── triviaiox-core          # 主框架 (MIT)
│   ├── triviaiox-squads        # 社区 Squad (MIT)
...
主仓库包含所有项目依赖的基础 TRIVIAIOX 框架。

### 内容

| 目录                       | 描述                                    |
| -------------------------- | --------------------------------------- |
| `.triviaiox-core/core/`         | 框架基础(配置、注册表、质量门)          |
| `.triviaiox-core/development/`  | 代理、任务、工作流定义                  |
| `.triviaiox-core/product/`      | 模板、检查表、PM 数据                   |
| `.triviaiox-core/infrastructure/` | 脚本、工具、集成                      |
| `docs/`                    | 框架文档                                |
...
Squad 是模块化扩展,为 TRIVIAIOX 添加专门功能。
...
### Trivia-Growth/certified-partners(专有)
...
```
triviaiox-squads → 依赖于 → triviaiox-core
```
...
| 包                   | 注册表 | 许可证     | 仓库        |
| -------------------- | ------ | ---------- | ----------- |
| `@triviaiox/core`         | npm    | MIT        | triviaiox-core   |
| `@triviaiox/squad-etl`    | npm    | MIT        | triviaiox-squads |
| `@triviaiox/squad-creator`| npm    | MIT        | triviaiox-squads |
| `@triviaiox/squad-mmos`   | npm    | MIT        | triviaiox-squads |
| `@triviaiox/mcp-presets`  | npm    | Apache 2.0 | mcp-ecosystem |
...
2. **对等依赖** - 指定精确的 triviaiox-core 版本要求
...
_最后更新: 2026-01-28 | TRIVIAIOX 框架团队_

...
| 工件                 | 路径                                                      | 类型        | 状态 |
| -------------------- | --------------------------------------------------------- | ----------- | ---- |
| asset-inventory.js   | `.triviaiox-core/infrastructure/scripts/asset-inventory.js`    | JS 脚本     | ✅   |
| path-analyzer.js     | `.triviaiox-core/infrastructure/scripts/path-analyzer.js`      | JS 脚本     | ✅   |
| migrate-agent.js     | `.triviaiox-core/infrastructure/scripts/migrate-agent.js`      | JS 脚本     | ✅   |
...
- **所有代理**同步到 `.claude/commands/TRIVIAIOX/agents/`

...
**来源:** `gh api repos/Trivia-Growth/Triviaiox/branches/main/protection`
...
**来源:** `gh api repos/Trivia-Growth/Triviaiox`
...
**来源:** `gh api repos/Trivia-Growth/Triviaiox/actions/workflows`
...
1. 创建包含 TRIVIAIOX 特定规则的 `.coderabbit.yaml`

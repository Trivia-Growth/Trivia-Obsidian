...
> TriviaGrowth Triviaiox v4.2 模块化架构完整指南。
...
TriviaGrowth Triviaiox 将 `.triviaiox-core/` 目录组织为四个主要模块：
...
| `data/` | `triviaiox-kb.md`、`workflow-patterns.yaml` | 框架知识库 |
| `docs/` | 内部文档 | 组件指南、故障排除 |
...
| 代理 | ID | 责任 |
| --- | --- | --- |
| TRIVIAIOX 主代理 | `triviaiox-master` | 框架编排 |
| 开发者 | `dev` | 代码实现 |
| QA | `qa` | 质量保证 |
| 架构师 | `architect` | 技术架构 |
| 产品经理 | `po` | 产品待办 |
...
**路径:** `.triviaiox-core/infrastructure/`
**目的:** 系统配置 - 脚本、工具和外部集成。
...
_TriviaGrowth Triviaiox v4 模块系统架构_

...
O agente **@sm (River)** e o Scrum Master tecnico do TRIVIAIOX, especializado em preparacao de stories e facilitacao de processos ageis. Seu papel principal e criar stories detalhadas e acionaveis que agentes desenvolvedores possam implementar com minima necessidade de pesquisa adicional.
...
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/sm-create-next-story.md` | `*draft` | Task principal para criar proxima story do backlog |
| `.triviaiox-core/development/tasks/create-next-story.md` | `*draft` | Versao completa da task de criação de story |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*story-checklist` | Executa checklist de validação de story draft |
| `.triviaiox-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo |
| `.triviaiox-core/development/tasks/collaborative-edit.md` | - | Edicao colaborativa de documentos |
| `.triviaiox-core/development/tasks/init-project-status.md` | - | Inicializacao de status do projeto |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/sm.md` | Definição core do agente SM |
| `.claude/commands/TRIVIAIOX/agents/sm.md` | Comando Claude Code para ativar @sm |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/checklists/story-draft-checklist.md` | Valida qualidade e completude de story drafts |
| `.triviaiox-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.triviaiox-core/product/checklists/change-checklist.md` | Navegacao de mudancas e correcao de curso |
| `.triviaiox-core/product/checklists/po-master-checklist.md` | Checklist mestre usado em validação |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.triviaiox-core/development/agents/po.md` | @po | Coordena com @sm em backlog e sprint planning |
| `.triviaiox-core/development/agents/dev.md` | @dev | Recebe stories do @sm para implementacao |
| `.triviaiox-core/development/agents/pm.md` | @pm | Cria epics que @sm quebra em stories |
| `.triviaiox-core/development/agents/devops.md` | @github-devops | Recebe stories completas para push/PR |
| `.triviaiox-core/development/agents/qa.md` | @qa | Coordena em risk profiling |

### Arquivos de Workflows que Utilizam @sm

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/workflows/story-development-cycle.yaml` | Ciclo completo de desenvolvimento de stories |
| `.triviaiox-core/development/workflows/greenfield-fullstack.yaml` | Workflow greenfield full-stack |
| `.triviaiox-core/development/workflows/greenfield-service.yaml` | Workflow greenfield service |
| `.triviaiox-core/development/workflows/greenfield-ui.yaml` | Workflow greenfield UI |
| `.triviaiox-core/development/workflows/brownfield-fullstack.yaml` | Workflow brownfield full-stack |
| `.triviaiox-core/development/workflows/brownfield-service.yaml` | Workflow brownfield service |
| `.triviaiox-core/development/workflows/brownfield-ui.yaml` | Workflow brownfield UI |

### Arquivos de Configuracao

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/core-config.yaml` | Configuracao central (devStoryLocation, etc.) |
| `.triviaiox-core/development/scripts/unified-activation-pipeline.js` | Pipeline de saudacao inteligente |
| `.triviaiox-core/development/scripts/agent-assignment-resolver.js` | Resolucao de assignment de agentes |
...
**Solucao:**
1. Copiar de `GITHUB triviaiox-core/core-config.yaml`
2. Ou executar TRIVIAIOX installer: `npm run triviaiox:install`
...
### Arquivos do Agente
- [Agent: sm.md](.triviaiox-core/development/agents/sm.md)
- [Task: create-next-story.md](.triviaiox-core/development/tasks/create-next-story.md)
- [Task: execute-checklist.md](.triviaiox-core/development/tasks/execute-checklist.md)
- [Task: correct-course.md](.triviaiox-core/development/tasks/correct-course.md)

### Checklists
- [Checklist: story-draft-checklist.md](.triviaiox-core/product/checklists/story-draft-checklist.md)
- [Checklist: story-dod-checklist.md](.triviaiox-core/product/checklists/story-dod-checklist.md)
- [Checklist: change-checklist.md](.triviaiox-core/product/checklists/change-checklist.md)

### Workflows
- [Workflow: story-development-cycle.yaml](.triviaiox-core/development/workflows/story-development-cycle.yaml)
- [Workflow: greenfield-fullstack.yaml](.triviaiox-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-fullstack.yaml](.triviaiox-core/development/workflows/brownfield-fullstack.yaml)

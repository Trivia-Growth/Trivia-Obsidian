# TRIVIAIOX Agent Flows - Documentação Detalhada dos Agentes

> 🌐 **PT** | [EN](../en/triviaiox-agent-flows/README.md) | [ES](../es/triviaiox-agent-flows/README.md) | [ZH](../zh/triviaiox-agent-flows/README.md)
...
Esta pasta contém a documentação detalhada de todos os agentes do TRIVIAIOX, incluindo:
...
| TRIVIAIOX Workflows | [docs/triviaiox-workflows/](../triviaiox-workflows/) | Detalhamento de workflows |
...
*TRIVIAIOX Agent Flows Documentation v1.0 - Documentação detalhada do sistema de agentes*

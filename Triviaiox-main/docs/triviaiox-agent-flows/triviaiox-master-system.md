...
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/triviaiox-master.md` | Definição completa do agente (persona, comandos, dependencias) |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/templates/agent-template.yaml` | Template para criação de novos agentes |
| `.triviaiox-core/development/templates/task-template.md` | Template para criação de novas tasks |
| `.triviaiox-core/development/templates/workflow-template.yaml` | Template para criação de novos workflows |

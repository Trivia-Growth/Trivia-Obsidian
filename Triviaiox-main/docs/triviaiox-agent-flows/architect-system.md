...
O agente **@architect** (Aria) e o **Holistic System Architect & Full-Stack Technical Leader** do TRIVIAIOX. Este agente e responsavel por:
...
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | Analisa impacto de modificacoes em componentes do framework |
| `.triviaiox-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao brownfield de projeto existente |
| `.triviaiox-core/development/tasks/create-doc.md` | `*create-doc` | Cria documentos a partir de templates YAML |
| `.triviaiox-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | Gerencia sessoes de edicao colaborativa |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validação |
| `.triviaiox-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | Avalia complexidade de stories (Spec Pipeline) |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/architect.md` | Definição core do agente Architect |
| `.claude/commands/TRIVIAIOX/agents/architect.md` | Comando Claude Code para ativar @architect |

### Arquivos de Templates do @architect

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/templates/architecture-tmpl.yaml` | Template para arquitetura backend |
| `.triviaiox-core/product/templates/front-end-architecture-tmpl.yaml` | Template para arquitetura frontend |
| `.triviaiox-core/product/templates/fullstack-architecture-tmpl.yaml` | Template para arquitetura fullstack |
| `.triviaiox-core/product/templates/brownfield-architecture-tmpl.yaml` | Template para projetos brownfield |

### Arquivos de Dados de Suporte

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao do TRIVIAIOX |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.triviaiox-core/development/tasks/spec-gather-requirements.md` | @pm | Coleta requisitos que alimentam arquitetura |
| `.triviaiox-core/development/tasks/spec-research-dependencies.md` | @analyst | Pesquisa dependencias para arquitetura |
| `.triviaiox-core/development/tasks/spec-critique.md` | @qa | Valida specs que impactam arquitetura |
| `.triviaiox-core/development/tasks/plan-create-implementation.md` | @architect | Cria plano de implementacao pos-spec |
| `.triviaiox-core/development/agents/db-sage.md` | @db-sage | Colabora em arquitetura de dados |
| `.triviaiox-core/development/agents/ux-design-expert.md` | @ux-design-expert | Colabora em arquitetura frontend |
| `.triviaiox-core/development/agents/devops.md` | @devops | Colabora em infraestrutura |
...
**Arquivo:** `.triviaiox-core/development/workflows/greenfield-fullstack.yaml`
...
**Arquivo:** `.triviaiox-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo:** `.triviaiox-core/development/workflows/spec-pipeline.yaml`
...
**Arquivo:** `.triviaiox-core/development/workflows/qa-loop.yaml`
...
```bash
# Analise basica
*analyze-impact modify .triviaiox-core/agents/weather-agent.md
...
*analyze-impact deprecate .triviaiox-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation.html
...
| `.triviaiox/project-registry.yaml` | Registro de projetos |
...
**Solucao:**
1. Verificar `.triviaiox-core/product/templates/`
...
- [architect-analyze-impact.md](.triviaiox-core/development/tasks/architect-analyze-impact.md)
- [document-project.md](.triviaiox-core/development/tasks/document-project.md)
- [create-doc.md](.triviaiox-core/development/tasks/create-doc.md)
- [execute-checklist.md](.triviaiox-core/development/tasks/execute-checklist.md)
- [spec-assess-complexity.md](.triviaiox-core/development/tasks/spec-assess-complexity.md)

### Templates de Arquitetura

- [fullstack-architecture-tmpl.yaml](.triviaiox-core/product/templates/fullstack-architecture-tmpl.yaml)
- [architecture-tmpl.yaml](.triviaiox-core/product/templates/architecture-tmpl.yaml)
- [front-end-architecture-tmpl.yaml](.triviaiox-core/product/templates/front-end-architecture-tmpl.yaml)
- [brownfield-architecture-tmpl.yaml](.triviaiox-core/product/templates/brownfield-architecture-tmpl.yaml)

### Workflows Relacionados

- [greenfield-fullstack.yaml](.triviaiox-core/development/workflows/greenfield-fullstack.yaml)
- [brownfield-fullstack.yaml](.triviaiox-core/development/workflows/brownfield-fullstack.yaml)
- [spec-pipeline.yaml](.triviaiox-core/development/workflows/spec-pipeline.yaml)

### Agentes Colaboradores

- [@db-sage](.triviaiox-core/development/agents/db-sage.md) - Arquitetura de dados
- [@ux-design-expert](.triviaiox-core/development/agents/ux-design-expert.md) - Arquitetura frontend
- [@pm](.triviaiox-core/development/agents/pm.md) - Requisitos e PRD
- [@devops](.triviaiox-core/development/agents/devops.md) - Git push e infraestrutura

...
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/dev-develop-story.md` | `*develop {story-id}` | Task principal - desenvolve story completa com modos YOLO/Interactive/Pre-flight |
| `.triviaiox-core/development/tasks/dev-improve-code-quality.md` | `*improve-code-quality <path>` | Melhora qualidade do codigo (formatting, linting, modern-syntax) |
| `.triviaiox-core/development/tasks/dev-optimize-performance.md` | `*optimize-performance <path>` | Analisa e otimiza performance do codigo |
| `.triviaiox-core/development/tasks/dev-suggest-refactoring.md` | `*suggest-refactoring <path>` | Sugere oportunidades de refactoring automatizado |
| `.triviaiox-core/development/tasks/dev-backlog-debt.md` | `*backlog-debt` | Registra divida tecnica no backlog |
| `.triviaiox-core/development/tasks/apply-qa-fixes.md` | `*apply-qa-fixes` | Aplica correcoes baseadas em feedback de QA |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Valida documentacao usando checklists |
| `.triviaiox-core/development/tasks/validate-next-story.md` | `*validate-story-draft` | Valida qualidade e completude de stories |
| `.triviaiox-core/development/tasks/sync-documentation.md` | `*sync-documentation` | Sincroniza documentacao com mudancas de codigo |
| `.triviaiox-core/development/tasks/po-manage-story-backlog.md` | (usado internamente) | Gerencia backlog de stories |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/dev.md` | Definição core do agente @dev (persona, comandos, workflows) |
| `.claude/commands/TRIVIAIOX/agents/dev.md` | Comando Claude Code para ativar @dev |

### Arquivos de Checklists Usados pelo @dev

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.triviaiox-core/product/checklists/pre-push-checklist.md` | Checklist antes de push |
| `.triviaiox-core/product/checklists/change-checklist.md` | Validacao de mudancas |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.triviaiox-core/development/tasks/qa-backlog-add-followup.md` | @qa | QA adiciona follow-ups ao backlog |
| `.triviaiox-core/development/tasks/qa-review-story.md` | @qa | QA revisa implementacao do @dev |
| `.triviaiox-core/development/tasks/github-devops-pre-push-quality-gate.md` | @github-devops | Quality gate antes de push |
| `.triviaiox-core/development/tasks/sm-create-next-story.md` | @sm | Scrum Master cria stories para @dev |

### Arquivos de Workflows que Usam @dev

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/workflows/brownfield-fullstack.yaml` | Workflow full-stack brownfield |
| `.triviaiox-core/development/workflows/brownfield-service.yaml` | Workflow de servico brownfield |
| `.triviaiox-core/development/workflows/brownfield-ui.yaml` | Workflow UI brownfield |
| `.triviaiox-core/development/workflows/greenfield-fullstack.yaml` | Workflow full-stack greenfield |
| `.triviaiox-core/development/workflows/greenfield-service.yaml` | Workflow de servico greenfield |
| `.triviaiox-core/development/workflows/greenfield-ui.yaml` | Workflow UI greenfield |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/core-config.yaml` | Configuracao central (devStoryLocation, coderabbit, etc.) |
| `.triviaiox-core/development/scripts/unified-activation-pipeline.js` | Pipeline canonico de ativacao e greeting |
| `.triviaiox-core/scripts/decision-recorder.js` | Logging de decisoes (YOLO mode) |
...
### Tasks do @dev
- [dev-develop-story.md](.triviaiox-core/development/tasks/dev-develop-story.md)
- [dev-improve-code-quality.md](.triviaiox-core/development/tasks/dev-improve-code-quality.md)
- [dev-optimize-performance.md](.triviaiox-core/development/tasks/dev-optimize-performance.md)
- [dev-suggest-refactoring.md](.triviaiox-core/development/tasks/dev-suggest-refactoring.md)
- [dev-backlog-debt.md](.triviaiox-core/development/tasks/dev-backlog-debt.md)
- [apply-qa-fixes.md](.triviaiox-core/development/tasks/apply-qa-fixes.md)

### Checklists
- [story-dod-checklist.md](.triviaiox-core/product/checklists/story-dod-checklist.md)
- [pre-push-checklist.md](.triviaiox-core/product/checklists/pre-push-checklist.md)

### Agente
- [dev.md](.triviaiox-core/development/agents/dev.md)

# Sistema do Agente Analyst (@analyst) - TRIVIAIOX
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/analyst.md` | Definição core do agente Analyst |
| `.claude/commands/TRIVIAIOX/agents/analyst.md` | Comando Claude Code para ativar @analyst |

### Tasks do Analyst

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | Task principal - facilita sessoes de brainstorming estruturadas |
| `.triviaiox-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | Variante interativa da task de brainstorming |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | Gera prompts de pesquisa profunda para investigacao |
| `.triviaiox-core/development/tasks/advanced-elicitation.md` | `*elicit` | Sessao avancada de elicitacao de requisitos |
| `.triviaiox-core/development/tasks/create-doc.md` | `*doc-out` | Criacao de documentos a partir de templates YAML |
| `.triviaiox-core/development/tasks/document-project.md` | `*create-project-brief` | Documentação de projetos existentes |
| `.triviaiox-core/development/tasks/calculate-roi.md` | (relacionada) | Calculo de ROI e economia de custos |

### Tasks Relacionadas de Analise

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/tasks/analyze-brownfield.md` | Analise de projetos brownfield |
| `.triviaiox-core/development/tasks/analyze-framework.md` | Analise de frameworks existentes |
| `.triviaiox-core/development/tasks/analyze-performance.md` | Analise de performance |
| `.triviaiox-core/development/tasks/analyze-project-structure.md` | Analise de estrutura de projeto |
| `.triviaiox-core/development/tasks/analyze-cross-artifact.md` | Analise cross-artifact |

### Templates do Analyst

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/templates/project-brief-tmpl.yaml` | Template para Project Brief |
| `.triviaiox-core/product/templates/market-research-tmpl.yaml` | Template para Pesquisa de Mercado |
| `.triviaiox-core/product/templates/competitor-analysis-tmpl.yaml` | Template para Analise Competitiva |
| `.triviaiox-core/product/templates/brainstorming-output-tmpl.yaml` | Template para output de sessoes de brainstorming |

### Arquivos de Dados

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/data/triviaiox-kb.md` | Knowledge base do TRIVIAIOX |
| `.triviaiox-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming disponiveis |

### Workflows que Usam o Analyst

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.triviaiox-core/development/workflows/greenfield-fullstack.yaml` | Fase 1 | Discovery & Planning - cria project-brief.md |
| `.triviaiox-core/development/workflows/brownfield-discovery.yaml` | Fase 9 | Relatorio Executivo de Awareness |
...
- [Task: facilitate-brainstorming-session.md](.triviaiox-core/development/tasks/facilitate-brainstorming-session.md)
- [Task: create-deep-research-prompt.md](.triviaiox-core/development/tasks/create-deep-research-prompt.md)
- [Task: advanced-elicitation.md](.triviaiox-core/development/tasks/advanced-elicitation.md)
- [Task: create-doc.md](.triviaiox-core/development/tasks/create-doc.md)
- [Task: document-project.md](.triviaiox-core/development/tasks/document-project.md)

### Templates

- [Template: project-brief-tmpl.yaml](.triviaiox-core/product/templates/project-brief-tmpl.yaml)
- [Template: market-research-tmpl.yaml](.triviaiox-core/product/templates/market-research-tmpl.yaml)
- [Template: competitor-analysis-tmpl.yaml](.triviaiox-core/product/templates/competitor-analysis-tmpl.yaml)
- [Template: brainstorming-output-tmpl.yaml](.triviaiox-core/product/templates/brainstorming-output-tmpl.yaml)

### Workflows

- [Workflow: greenfield-fullstack.yaml](.triviaiox-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-discovery.yaml](.triviaiox-core/development/workflows/brownfield-discovery.yaml)

### Agente

- [Agent: analyst.md](.triviaiox-core/development/agents/analyst.md)

...
O **Squad Creator** (Craft) e o agente especializado do TRIVIAIOX para criação, validação, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/squad-creator.md` | Definição core do agente Squad Creator |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/schemas/squad-schema.json` | Schema de validação do squad.yaml |
| `.triviaiox-core/schemas/squad-design-schema.json` | Schema de validação de blueprints |

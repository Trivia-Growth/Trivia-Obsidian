# Sistema do Agente Product Manager (PM) - TRIVIAIOX
...
Este documento descreve o sistema completo do agente Product Manager (PM) do TRIVIAIOX, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis e integracoes entre agentes.
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/pm.md` | Definição core do agente PM |
| `.claude/commands/TRIVIAIOX/agents/pm.md` | Comando Claude Code para ativar @pm |

### Tasks do @pm

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/create-doc.md` | `*create-prd` | Cria documentos a partir de templates YAML |
| `.triviaiox-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de projeto |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.triviaiox-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | Cria epics para projetos brownfield |
| `.triviaiox-core/development/tasks/brownfield-create-story.md` | `*create-story` | Cria stories para brownfield |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
| `.triviaiox-core/development/tasks/shard-doc.md` | `*shard-prd` | Fragmenta documentos grandes |

### Templates do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/templates/prd-tmpl.yaml` | Template PRD para projetos greenfield |
| `.triviaiox-core/product/templates/brownfield-prd-tmpl.yaml` | Template PRD para projetos brownfield |

### Checklists do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
| `.triviaiox-core/product/checklists/change-checklist.md` | Checklist para navegacao de mudancas |

### Workflows que Utilizam o @pm

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.triviaiox-core/development/workflows/brownfield-discovery.yaml` | Fase 10 | Criacao de epics e stories pos-discovery |
...
**Solucao:**
- Verifique `.triviaiox-core/product/templates/`
...
- [Agent Definition: pm.md](.triviaiox-core/development/agents/pm.md)
- [Task: create-doc.md](.triviaiox-core/development/tasks/create-doc.md)
- [Task: brownfield-create-epic.md](.triviaiox-core/development/tasks/brownfield-create-epic.md)
- [Task: correct-course.md](.triviaiox-core/development/tasks/correct-course.md)
- [Template: prd-tmpl.yaml](.triviaiox-core/product/templates/prd-tmpl.yaml)
- [Template: brownfield-prd-tmpl.yaml](.triviaiox-core/product/templates/brownfield-prd-tmpl.yaml)
- [Checklist: pm-checklist.md](.triviaiox-core/product/checklists/pm-checklist.md)

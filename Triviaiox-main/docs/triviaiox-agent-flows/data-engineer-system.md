...
O agente **@data-engineer (Dara)** e o Database Architect & Operations Engineer do TRIVIAIOX, responsavel pelo design de schemas, migracoes, seguranca (RLS), otimizacao de performance e operacoes de DBA. Este agente atua como um **Sage** que modela dominios de negocio, implementa migracoes seguras com snapshots e rollback, e garante integridade e seguranca dos dados.
...
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/db-domain-modeling.md` | `*model-domain` | Sessao interativa de modelagem de dominio |
| `.triviaiox-core/development/tasks/setup-database.md` | `*setup-database [type]` | Setup de projeto de database (Supabase, PostgreSQL, MongoDB, MySQL, SQLite) |
| `.triviaiox-core/development/tasks/db-bootstrap.md` | `*bootstrap` | Cria estrutura padrao de projeto Supabase |
| `.triviaiox-core/development/tasks/db-env-check.md` | `*env-check` | Valida variaveis de ambiente do database |
| `.triviaiox-core/development/tasks/db-apply-migration.md` | `*apply-migration {path}` | Aplica migracao com snapshot e lock advisory |
| `.triviaiox-core/development/tasks/db-dry-run.md` | `*dry-run {path}` | Testa migracao sem commit |
| `.triviaiox-core/development/tasks/db-seed.md` | `*seed {path}` | Aplica seed data (idempotent) |
| `.triviaiox-core/development/tasks/db-snapshot.md` | `*snapshot {label}` | Cria snapshot do schema |
| `.triviaiox-core/development/tasks/db-rollback.md` | `*rollback {snapshot_or_file}` | Restaura snapshot ou executa rollback |
| `.triviaiox-core/development/tasks/db-smoke-test.md` | `*smoke-test {version}` | Testes abrangentes de database |
| `.triviaiox-core/development/tasks/security-audit.md` | `*security-audit {scope}` | Auditoria de seguranca (rls, schema, full) |
| `.triviaiox-core/development/tasks/analyze-performance.md` | `*analyze-performance {type}` | Analise de performance (query, hotpaths, interactive) |
| `.triviaiox-core/development/tasks/db-policy-apply.md` | `*policy-apply {table} {mode}` | Instala politica RLS (KISS ou granular) |
| `.triviaiox-core/development/tasks/test-as-user.md` | `*test-as-user {user_id}` | Emula usuario para testar RLS |
| `.triviaiox-core/development/tasks/db-verify-order.md` | `*verify-order {path}` | Valida ordenacao DDL para dependencias |
| `.triviaiox-core/development/tasks/db-load-csv.md` | `*load-csv {table} {file}` | Carregador seguro de CSV (staging->merge) |
| `.triviaiox-core/development/tasks/db-run-sql.md` | `*run-sql {file_or_inline}` | Executa SQL raw com transacao |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | `*research {topic}` | Gera prompt de pesquisa profunda |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*execute-checklist {checklist}` | Executa checklist DBA |
| `.triviaiox-core/development/tasks/create-doc.md` | `*doc-out` | Output de documento completo |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/agents/data-engineer.md` | Definição core do agente @data-engineer (persona, comandos, workflows) |
| `.claude/commands/TRIVIAIOX/agents/data-engineer.md` | Comando Claude Code para ativar @data-engineer |
...
| Arquivo | Propósito |
|---------|-----------|
| `.triviaiox-core/development/workflows/brownfield-discovery.yaml` | Workflow de discovery brownfield (Fase 2 e 5) |
...
- [db-domain-modeling.md](.triviaiox-core/development/tasks/db-domain-modeling.md)
- [setup-database.md](.triviaiox-core/development/tasks/setup-database.md)
- [db-apply-migration.md](.triviaiox-core/development/tasks/db-apply-migration.md)
- [security-audit.md](.triviaiox-core/development/tasks/security-audit.md)
- [analyze-performance.md](.triviaiox-core/development/tasks/analyze-performance.md)
- [db-snapshot.md](.triviaiox-core/development/tasks/db-snapshot.md)
- [db-rollback.md](.triviaiox-core/development/tasks/db-rollback.md)
- [db-bootstrap.md](.triviaiox-core/development/tasks/db-bootstrap.md)

### Agente

- [data-engineer.md](.triviaiox-core/development/agents/data-engineer.md)

### Workflows

- [brownfield-discovery.yaml](.triviaiox-core/development/workflows/brownfield-discovery.yaml)

...
TRIVIAIOX (AI-Orchestrated System) is an open-source project maintained by Trivia-Growth Inc. This privacy policy explains how we handle any data that may be collected when you use TriviaGrowth Triviaiox.

## Data Collection

### What We Don't Collect

TriviaGrowth Triviaiox does **NOT** collect:
...
TriviaGrowth Triviaiox uses a **consent-based telemetry system**. The system is designed as follows:
...
```javascript
const triviaiox = new TRIVIAIOX({
  telemetry: { enabled: false },
});
```

You can also revoke consent at any time through the consent management interface or by deleting the `.triviaiox/telemetry/` directory.

## Local Data Storage

TriviaGrowth Triviaiox stores some data locally on your machine:

- Configuration files (`.triviaiox/`, `.triviaiox-core/`)
- Project status cache (`.triviaiox/project-status.yaml`)
...
When using TriviaGrowth Triviaiox, you may interact with third-party services:
...
**Important:** Your interactions with these services are governed by their respective privacy policies. TriviaGrowth Triviaiox does not control or have access to data you share with these services.
...
- **Delete** all local data by removing the `.triviaiox/` and `.ai/` directories
...
- Repository: [github.com/Trivia-Growth/Triviaiox](https://github.com/Trivia-Growth/Triviaiox)
- No hidden data collection mechanisms
- All configuration options are documented

## Children's Privacy

TriviaGrowth Triviaiox is a development tool intended for professional use. We do not knowingly collect any information from children under 13 years of age.
...
- API keys and credentials are never stored by TRIVIAIOX (users manage their own)
- Regular security audits of the codebase

For security vulnerabilities, please [open an issue](https://github.com/Trivia-Growth/Triviaiox/issues) or email security@Trivia-Growth.com.

## Contact

For privacy concerns or questions:

- **GitHub Issues:** [Open an issue](https://github.com/Trivia-Growth/Triviaiox/issues)
- **Email:** privacy@Trivia-Growth.com
...
**Copyright (c) 2025 Trivia-Growth Inc.**

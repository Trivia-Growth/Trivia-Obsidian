...
### Issue 1: "npx triviaiox-core is not recognized"
...
```bash
# Check TRIVIAIOX installation status
npx triviaiox-core status
...
```bash
# Verify .triviaiox-core structure
...
1. Run `npx triviaiox-core status` and note the output
2. Check this troubleshooting guide
3. Search existing [GitHub Issues](https://github.com/Trivia-Growth/Triviaiox/issues)
...
- **GitHub Issues**: [triviaiox-core/issues](https://github.com/Trivia-Growth/Triviaiox/issues)

# Windows Installation Guide for TriviaGrowth Triviaiox
...
2. TRIVIAIOX can integrate via `.continue\` configuration
...
# - Back up customizations to .triviaiox-backup\
...
```powershell
# Remove TRIVIAIOX from project
Remove-Item -Recurse -Force .triviaiox-core
Remove-Item -Recurse -Force .claude\commands\TRIVIAIOX

# Remove global npm packages
npm uninstall -g @trivia-growth/triviaiox
```

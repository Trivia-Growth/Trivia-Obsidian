# macOS Installation Guide for TriviaGrowth Triviaiox
...
1. Commands are installed to `.claude/commands/TRIVIAIOX/`
...
2. TriviaGrowth Triviaiox handles both case-sensitive and case-insensitive filesystems automatically

# Linux Installation Guide for TriviaGrowth Triviaiox
...
git clone https://github.com/Trivia-Growth/Triviaiox.git ~/.triviaiox-core-source

# Navigate to the source
cd ~/.triviaiox-core-source

# Install dependencies
npm install

# Run installer for your project
node bin/triviaiox-init.js ~/projects/my-project
```
...
2. Commands are installed to `.claude/commands/TRIVIAIOX/`
...
2. Configure TRIVIAIOX rules in `.continue/`
...
# TRIVIAIOX configuration
export TRIVIAIOX_HOME="$HOME/.triviaiox-core"
export PATH="$TRIVIAIOX_HOME/bin:$PATH"
...
TriviaGrowth Triviaiox respects XDG directories:

```bash
# Data files: ~/.local/share/triviaiox/
# Config files: ~/.config/triviaiox/
# Cache: ~/.cache/triviaiox/
# State: ~/.local/state/triviaiox/
```
...
git pull
npm install
node bin/triviaiox-init.js ~/projects/my-project --update
```

The updater will:

- Detect your existing installation
- Back up any customizations to `.triviaiox-backup/`
...
```bash
# Remove TRIVIAIOX from a project
rm -rf .triviaiox-core .claude/commands/TRIVIAIOX

# Remove global installation
rm -rf ~/.triviaiox-core-source ~/.npm-global/lib/node_modules/@triviagrowth
```

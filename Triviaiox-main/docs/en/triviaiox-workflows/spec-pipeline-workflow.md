...
> **EN** | [PT](../../triviaiox-workflows/spec-pipeline-workflow.md) | [ES](../../es/triviaiox-workflows/spec-pipeline-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../triviaiox-workflows/spec-pipeline-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../triviaiox-workflows/spec-pipeline-workflow.md).*

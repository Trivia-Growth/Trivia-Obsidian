...
> **EN** | [PT](../../triviaiox-workflows/brownfield-service-workflow.md) | [ES](../../es/triviaiox-workflows/brownfield-service-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../triviaiox-workflows/brownfield-service-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../triviaiox-workflows/brownfield-service-workflow.md).*

# TRIVIAIOX Agent Flows - Detailed Agent Documentation

> **EN** | [PT](../../triviaiox-agent-flows/README.md) | [ES](../../es/triviaiox-agent-flows/README.md) | [ZH](../../zh/triviaiox-agent-flows/README.md)
...
This folder contains detailed documentation for all TRIVIAIOX agents, including:
...
| TRIVIAIOX Workflows | [docs/triviaiox-workflows/](../../triviaiox-workflows/) | Detailed workflows |
...
*TRIVIAIOX Agent Flows Documentation v1.0 - Detailed documentation of the agent system*

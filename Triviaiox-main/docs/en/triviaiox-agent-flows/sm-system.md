...
> **EN** | [PT](../../triviaiox-agent-flows/sm-system.md) | [ES](../../es/triviaiox-agent-flows/sm-system.md)

---

## Summary

**@sm** (River) is the **Facilitator** of the TRIVIAIOX agent system. This agent is responsible for:
...
**[View Full Documentation (PT)](../../triviaiox-agent-flows/sm-system.md)**

---

*TRIVIAIOX Agent Flows - @sm System v1.0*

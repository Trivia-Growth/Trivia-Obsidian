# TriviaGrowth Triviaiox Troubleshooting Guide

> 🌐 **EN** | [PT](./pt/troubleshooting.md) | [ES](./es/troubleshooting.md)

---

This comprehensive guide helps you diagnose and resolve common issues with TriviaGrowth Triviaiox.
...
```javascript
// Edit .triviaiox/memory-config.json
{
...
2. **Collect information:**
   ...
   - TRIVIAIOX version: `npx triviaiox-core version`
...
- **Stack Overflow**: Tag questions with `triviaiox-core`
...
## Steps to Reproduce
1. Run `npx triviaiox-core init test`

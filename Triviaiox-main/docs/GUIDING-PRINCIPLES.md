# TRIVIAIOX Method Guiding Principles

> 🌐 **EN** | [PT](./pt/GUIDING-PRINCIPLES.md) | [ES](./es/GUIDING-PRINCIPLES.md)

---

The TRIVIAIOX Method is a natural language framework for AI-assisted software development. These principles ensure contributions maintain the method's effectiveness.
...
Templates follow the [TRIVIAIOX Document Template](../common/utils/triviaiox-doc-template.md) specification using YAML format:

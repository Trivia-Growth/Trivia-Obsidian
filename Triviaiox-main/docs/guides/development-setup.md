...
Complete guide for developers who want to contribute to the TriviaGrowth Triviaiox project.
...
| Tool                 | Purpose                                 |
| -------------------- | --------------------------------------- |
| **Claude Code**      | AI-powered development with TRIVIAIOX agents |
| **VS Code / Cursor** | IDE with TRIVIAIOX integration               |
...
1. Navigate to [github.com/Trivia-Growth/Triviaiox](https://github.com/Trivia-Growth/Triviaiox)
...
Sync TRIVIAIOX agents to your IDE:
...
Understanding the `triviaiox-core` directory structure:

```
triviaiox-core/
├── .triviaiox-core/                    # Framework source (committed)
...
│   ├── commands/TRIVIAIOX/agents/      # Agent skill commands
│   ├── hooks/                     # Governance hooks
│   └── rules/                     # AI behavior rules
│
├── bin/                           # CLI entry points
│   ├── triviaiox.js                    # Main CLI
│   └── triviaiox-minimal.js            # Minimal CLI
│
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.triviaiox-core/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.triviaiox-core/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.triviaiox-core/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
```bash
# File: .triviaiox-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .triviaiox-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .triviaiox-core/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.triviaiox-core/development/tasks/`:
...
# Examples:
# .triviaiox-core/development/tasks/dev-build-component.md  (dev agent)
# .triviaiox-core/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.triviaiox-core/development/workflows/`:

```bash
# File: .triviaiox-core/development/workflows/my-workflow.yaml
```
...
- Tag `@Trivia-Growth/core-team` for urgent issues

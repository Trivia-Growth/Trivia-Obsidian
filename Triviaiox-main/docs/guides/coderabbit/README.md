...
## TRIVIAIOX Integration Overview

In TRIVIAIOX, CodeRabbit is integrated into the Quality Gates system as part of **Layer 2: PR Automation**.
...
### TRIVIAIOX Agent Configuration

CodeRabbit is configured in agent definition files:

**Location:** `.triviaiox-core/development/agents/qa.md` and `devops.md`
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../triviaiox-core
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../triviaiox-core && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
| Severity     | Description                               | TRIVIAIOX Action                      |
| ------------ | ----------------------------------------- | -------------------------------- |
...
## Integration with TRIVIAIOX Workflow
...
- [Quality Gates Specification](../../../.triviaiox-core/docs/standards/QUALITY-GATES-SPECIFICATION.md)
- [@qa Agent Definition](../../../.triviaiox-core/development/agents/qa.md)
- [@devops Agent Definition](../../../.triviaiox-core/development/agents/devops.md)
- [Pre-Push Quality Gate Task](../../../.triviaiox-core/development/tasks/github-devops-pre-push-quality-gate.md)

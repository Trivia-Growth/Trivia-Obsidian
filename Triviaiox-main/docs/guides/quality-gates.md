# TRIVIAIOX Quality Gate System Guide

> **EN** | [PT](../pt/guides/quality-gates.md) | [ES](../es/guides/quality-gates.md)

---

> Comprehensive guide to the 3-layer quality gate system for TriviaGrowth Triviaiox.
...
The TRIVIAIOX Quality Gate System provides automated quality assurance through three progressive layers of validation. Each layer catches different types of issues at the appropriate stage of development.
...
# Run with options
triviaiox qa run --verbose          # Detailed output
triviaiox qa run --fail-fast        # Stop on first failure
triviaiox qa run --continue-on-fail # Continue despite failures
```
...
_TriviaGrowth Triviaiox v4 Quality Gate System Guide_

...
### Configuration
- `.triviaiox-core/core-config.yaml` - Configuração global (git + agentIdentity sections)

### Agents (Updated)
- `.triviaiox-core/agents/dev.md` - ✅ Command visibility metadata
- `.triviaiox-core/agents/po.md` - ✅ Command visibility metadata
- `.triviaiox-core/agents/*.md` - ⏳ Remaining 9 agents (pending update)
...
A: Use o script de teste: `node .triviaiox-core/development/scripts/test-greeting-system.js`

...
> Document generation and variable substitution engine for TriviaGrowth Triviaiox.
...
The Template Engine provides a consistent way to generate documents (PRDs, ADRs, Stories, etc.) with variable substitution, conditionals, and loops. It powers all document generation tasks in TRIVIAIOX.

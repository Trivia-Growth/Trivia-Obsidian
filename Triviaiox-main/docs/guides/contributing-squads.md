...
How to contribute squads to the TRIVIAIOX ecosystem.

## Overview

There are two ways to share your squad with the community:

1. **triviaiox-squads Repository** - Free, open-source squads on GitHub
2. **TriviaGrowth Marketplace** - Premium squads via TriviaGrowth API
...
| **TRIVIAIOX compatibility** | `triviaiox.minVersion: "2.1.0"` or higher |
...
## Publishing to triviaiox-squads
...
This will:
1. Fork `Trivia-Growth/triviaiox-squads` (if needed)
...
## Publishing to TriviaGrowth Marketplace

### Prerequisites

1. TriviaGrowth account
...
- **Questions**: [GitHub Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions)

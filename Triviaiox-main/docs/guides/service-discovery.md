# TRIVIAIOX Service Discovery Guide

> **EN** | [PT](../pt/guides/service-discovery.md) | [ES](../es/guides/service-discovery.md)

---

> How to discover, query, and use workers in the TRIVIAIOX framework.
...
The Service Discovery system enables finding and using workers (tasks, templates, scripts, workflows) across the TRIVIAIOX framework. The **Service Registry** is the central catalog containing metadata about all available workers.
...
**Location:** `.triviaiox-core/infrastructure/scripts/`
...
_TriviaGrowth Triviaiox v4 Service Discovery Guide_

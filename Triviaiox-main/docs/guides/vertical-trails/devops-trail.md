...
Você está em um projeto TRIVIAIOX e precisa:
...
npx triviaiox-core doctor  # deve retornar healthy
...
✅ Repositório criado: github.com/seu-user/my-triviaiox-project
...
📋 CI Pipeline triggered:
  https://github.com/seu-user/my-triviaiox-project/actions/runs/xxxxx
```
...
Release URL:
  https://github.com/seu-user/my-triviaiox-project/releases/tag/v1.1.0
```
...
*Trilha criada para Story TRIVIAIOX-DIFF-4.3.1*

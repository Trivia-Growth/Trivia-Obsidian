# TriviaGrowth Triviaiox Testing Guide

> **EN** | [PT](../pt/guides/testing-guide.md) | [ES](../es/guides/testing-guide.md)

---

> Comprehensive guide to the testing strategy, tools, and best practices for TriviaGrowth Triviaiox.
...
TRIVIAIOX follows a comprehensive testing strategy that ensures code quality across all layers of the framework. Our testing philosophy is built on:
 ...
 * Agent Backward Compatibility Tests
 *
 * Ensures agents from previous TRIVIAIOX versions continue to work.
 */
...
TRIVIAIOX supports Windows, macOS, and Linux. Cross-platform testing ensures consistent behavior.
...
│   ├── index.html        # Overview
│   └── .triviaiox-core/       # Per-module coverage
...
The TRIVIAIOX Quality Gate System (see [Quality Gates Guide](./quality-gates.md)) integrates testing at multiple layers:
...
_TriviaGrowth Triviaiox v4 Testing Guide_

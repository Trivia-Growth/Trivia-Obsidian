# TRIVIAIOX API Reference

> **EN** | [PT](../pt/guides/api-reference.md) | [ES](../es/guides/api-reference.md)

---

Complete API reference for TriviaGrowth Triviaiox - the AI-Orchestrated System for Full Stack Development.
...
TRIVIAIOX provides a unified API for interacting with specialized AI agents through two primary mechanisms:
...
| `@triviaiox-master`   | Orion  | Orchestrator | Framework orchestration, meta-operations |

### Activation Behavior

When an agent is activated:

1. Agent definition file is loaded from `.triviaiox-core/development/agents/{id}.md`
...
| Command                | Arguments       | Description                                 |
| ---------------------- | --------------- | ------------------------------------------- |
| `*create`              | `{type} {name}` | Create TRIVIAIOX component (agent/task/workflow) |
...
| `*kb`   | -                          | Toggle KB mode (TRIVIAIOX Method knowledge) |
...
| -------------------- | ------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Agent definition missing        | Check `.triviaiox-core/development/agents/` |
...
/triviaiox-master  → Activates @triviaiox-master agent
```
...
- [User Guide](./user-guide.md) - Getting started with TRIVIAIOX
...
- [Squads Guide](./squads-guide.md) - Extending TRIVIAIOX with squads

---

_TriviaGrowth Triviaiox API Reference v4.0.4_

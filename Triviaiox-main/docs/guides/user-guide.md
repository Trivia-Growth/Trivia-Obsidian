# TRIVIAIOX User Guide

> **EN**

---

Complete guide for using TriviaGrowth Triviaiox - the AI-Orchestrated System for Full Stack Development.
...
Before using TRIVIAIOX, ensure you have:
...
TRIVIAIOX provides orchestrated structure while allowing flexibility in communication. This means:
...
### The TRIVIAIOX Difference

| Traditional AI Dev            | TRIVIAIOX                                    |
| ----------------------------- | --------------------------------------- |
...
TRIVIAIOX includes 11 specialized agents, each with a distinct role and personality:
...
@triviaiox-master        # Activate Pax (Orchestrator)
...
Tasks are the primary entry point in TRIVIAIOX. Everything is a task.
...
Squads are modular teams of AI agents that extend TRIVIAIOX functionality.
...
```
my-project/
├── .triviaiox-core/                # Framework configuration
...
The primary configuration is in `.triviaiox-core/core/config/`:
...
TRIVIAIOX supports multiple IDEs. Configuration is synchronized across:
...
TRIVIAIOX implements 3-layer quality gates:
...
_TriviaGrowth Triviaiox User Guide v4.2.11_

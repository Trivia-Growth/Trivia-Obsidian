...
O agente `@devops` (Gage) e o especialista em infraestrutura e operacoes do framework TRIVIAIOX. Ele e responsavel por:
...
|---------|---------|-----------|
| Definicao do Agente | `.triviaiox-core/development/agents/devops.md` | Persona, comandos e comportamentos |

### Arquivos de Tasks

| Task | Caminho | Comando |
|------|---------|---------|
| Pre-Push Quality Gate | `.triviaiox-core/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| Version Management | `.triviaiox-core/development/tasks/github-devops-version-management.md` | `*version-check` |
| Repository Cleanup | `.triviaiox-core/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD Configuration | `.triviaiox-core/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| Release Management | `.triviaiox-core/development/tasks/release-management.md` | `*release` |
| Environment Bootstrap | `.triviaiox-core/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| Search MCP | `.triviaiox-core/development/tasks/search-mcp.md` | `*search-mcp` |
| Add MCP | `.triviaiox-core/development/tasks/add-mcp.md` | `*add-mcp` |
| Setup MCP Docker | `.triviaiox-core/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| Setup GitHub | `.triviaiox-core/development/tasks/setup-github.md` | `*setup-github` |
| Security Audit | `.triviaiox-core/development/tasks/security-audit.md` | `*security-audit` |
| Security Scan | `.triviaiox-core/development/tasks/security-scan.md` | `*security-scan` |
...
| Task | Descricao |
|------|-----------|
| [Pre-Push Quality Gate](.triviaiox-core/development/tasks/github-devops-pre-push-quality-gate.md) | Validacao antes do push |
| [Version Management](.triviaiox-core/development/tasks/github-devops-version-management.md) | Gerenciamento de versoes |
| [CI/CD Configuration](.triviaiox-core/development/tasks/ci-cd-configuration.md) | Configuracao de pipelines |
| [Release Management](.triviaiox-core/development/tasks/release-management.md) | Gerenciamento de releases |
| [Environment Bootstrap](.triviaiox-core/development/tasks/environment-bootstrap.md) | Bootstrap de ambientes |
...
*Documento gerado pelo Sistema TRIVIAIOX - 2026-02-04*
*Mantido por: @devops*

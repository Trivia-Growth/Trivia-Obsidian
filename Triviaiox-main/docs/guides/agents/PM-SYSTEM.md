...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/pm.md` | Definicao core do agente PM |
...
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validacao de checklists |
...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/product/checklists/pm-checklist.md` | Checklist de validacao de PRD |

# Sistema de Criacao e Gerenciamento de Squads TRIVIAIOX
...
O **Squad Creator** (Craft) e o agente especializado do TRIVIAIOX para criacao, validacao, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.

Este sistema implementa a **arquitetura task-first** do TRIVIAIOX, onde tasks sao o ponto de entrada principal para execucao, e agentes orquestram essas tasks.

### Propositos do Sistema

- **Criar squads** seguindo padroes e estrutura do TRIVIAIOX
- **Validar squads** contra JSON Schema e especificacoes de task
- **Listar squads** locais do projeto
- **Distribuir squads** em 3 niveis (Local, triviaiox-squads, TriviaGrowth API)
...
4. **3 Niveis de Distribuicao**: Local, Publico (triviaiox-squads), Marketplace (TriviaGrowth API)
5. **Integracao com triviaiox-core**: Squads trabalham em sinergia com o framework
...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/squad-creator.md` | Definicao core do agente Squad Creator |
| `.claude/commands/TRIVIAIOX/agents/squad-creator.md` | Comando Claude Code para ativar @squad-creator |

### Arquivos de Tasks do @squad-creator

| Arquivo | Comando | Proposito | Status |
|---------|---------|-----------|--------|
| `.triviaiox-core/development/tasks/squad-creator-create.md` | `*create-squad` | Cria novo squad com estrutura completa | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-design.md` | `*design-squad` | Analisa documentacao e gera blueprint | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-validate.md` | `*validate-squad` | Valida squad contra schema e padroes | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-list.md` | `*list-squads` | Lista squads locais | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-analyze.md` | `*analyze-squad` | Analisa estrutura e sugere melhorias | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-extend.md` | `*extend-squad` | Estende squad com novos componentes | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-migrate.md` | `*migrate-to-v2` | Migra squad para formato v2 | Ativo |
| `.triviaiox-core/development/tasks/squad-generate-skills.md` | `*generate-skills` | Gera skills de conhecimento do squad | Ativo |
| `.triviaiox-core/development/tasks/squad-generate-workflow.md` | `*generate-workflow` | Gera workflow de orquestracao YAML | Ativo |
| `.triviaiox-core/development/tasks/squad-creator-download.md` | `*download-squad` | Baixa squad do repositorio publico | Placeholder (Sprint 8) |
| `.triviaiox-core/development/tasks/squad-creator-publish.md` | `*publish-squad` | Publica squad no triviaiox-squads | Placeholder (Sprint 8) |
| `.triviaiox-core/development/tasks/squad-creator-sync-triviagrowth.md` | `*sync-squad-triviagrowth` | Sincroniza squad com TriviaGrowth API | Placeholder (Sprint 8) |

### Arquivos de Tasks Relacionadas

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/create-agent.md` | `*create-agent` | Cria definicao de agente individual |
| `.triviaiox-core/development/tasks/create-task.md` | `*create-task` | Cria arquivo de task individual |
| `.triviaiox-core/development/tasks/create-workflow.md` | `*create-workflow` | Cria workflow de orquestracao |

### Scripts de Suporte

| Arquivo | Classe/Funcao | Proposito |
|---------|---------------|-----------|
| `.triviaiox-core/development/scripts/squad/squad-generator.js` | `SquadGenerator` | Gera estrutura de squad completa |
| `.triviaiox-core/development/scripts/squad/squad-validator.js` | `SquadValidator` | Valida squad contra schema e padroes |
| `.triviaiox-core/development/scripts/squad/squad-loader.js` | `SquadLoader` | Carrega e resolve squads |
| `.triviaiox-core/development/scripts/squad/squad-designer.js` | `SquadDesigner` | Analisa docs e gera blueprints |
| `.triviaiox-core/development/scripts/squad/squad-analyzer.js` | `SquadAnalyzer` | Analisa estrutura de squads |
| `.triviaiox-core/development/scripts/squad/squad-extender.js` | `SquadExtender` | Estende squads existentes |
| `.triviaiox-core/development/scripts/squad/squad-migrator.js` | `SquadMigrator` | Migra squads para v2 |
| `.triviaiox-core/development/scripts/squad/squad-downloader.js` | `SquadDownloader` | Baixa squads do repositorio |
| `.triviaiox-core/development/scripts/squad/squad-publisher.js` | `SquadPublisher` | Publica squads |

### Schemas JSON

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/schemas/squad-schema.json` | Schema de validacao do squad.yaml |
| `.triviaiox-core/schemas/squad-design-schema.json` | Schema de validacao de blueprints |
...
flowchart TB
    ...
    subgraph DISTRIBUTE["🚀 DISTRIBUTION"]
        ...
        PUBLIC["🌐 Public<br/>github.com/Trivia-Growth/triviaiox-squads"]
        MARKET["💰 Marketplace<br/>api.triviagrowth.dev/squads"]
    end

    VALID --> LOCAL
    VALID -->|"*publish-squad"| PUBLIC
    VALID -->|"*sync-squad-triviagrowth"| MARKET
...
| Comando | Task File | Operacao |
|---------|-----------|----------|
| `*download-squad` | `squad-creator-download.md` | DOWNLOAD squad do triviaiox-squads |
| `*publish-squad` | `squad-creator-publish.md` | PUBLISH squad para triviaiox-squads |
| `*sync-squad-triviagrowth` | `squad-creator-sync-triviagrowth.md` | SYNC squad para TriviaGrowth API |
...
flowchart LR
    ...
    SQUADS[("📦 ./squads/")]
    TRIVIAIOX_SQUADS[("🌐 triviaiox-squads")]
    TRIVIAGROWTH[("💰 TriviaGrowth API")]

    SC_CREATE --> SQUADS
    SC_VALIDATE --> SQUADS
    SC_LIST --> SQUADS
    DEVOPS_PUB --> TRIVIAIOX_SQUADS
    DEVOPS_PUB --> TRIVIAGROWTH
...
triviaiox:
  minVersion: string  # versao minima do TRIVIAIOX
  type: squad
...
flowchart LR
    ...
    subgraph PUBLIC["🌐 Nivel 2: Publico"]
        P_REPO["github.com/Trivia-Growth/triviaiox-squads"]
        P_DESC["Squads da comunidade (gratuitos)"]
        P_CMD["*publish-squad"]
    end

    subgraph MARKET["💰 Nivel 3: Marketplace"]
        M_API["api.triviagrowth.dev/squads"]
        M_DESC["Squads premium via TriviaGrowth API"]
        M_CMD["*sync-squad-triviagrowth"]
    end
...
- [Task: squad-creator-create.md](.triviaiox-core/development/tasks/squad-creator-create.md)
- [Task: squad-creator-validate.md](.triviaiox-core/development/tasks/squad-creator-validate.md)
- [Task: squad-creator-design.md](.triviaiox-core/development/tasks/squad-creator-design.md)
- [Script: squad-generator.js](.triviaiox-core/development/scripts/squad/squad-generator.js)
- [Script: squad-validator.js](.triviaiox-core/development/scripts/squad/squad-validator.js)
- [Schema: squad-schema.json](.triviaiox-core/schemas/squad-schema.json)
- [Agent: squad-creator.md](.triviaiox-core/development/agents/squad-creator.md)
- [Command: squad-creator.md](.claude/commands/TRIVIAIOX/agents/squad-creator.md)
...
| **Tasks Placeholder** | 3 (download, publish, sync-triviagrowth) |
...
| **Niveis Distribuicao** | 3 (Local, triviaiox-squads, TriviaGrowth API) |

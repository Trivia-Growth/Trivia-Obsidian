...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/analyst.md` | Definicao core do agente Analyst |
...
| `.triviaiox-core/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |

# Sistema do Agente @triviaiox-master

> **Versao:** 1.0.0
> **Criado:** 2026-02-04
> **Owner:** @triviaiox-master (Orion)
...
O **@triviaiox-master** (Orion - The Orchestrator) e o meta-agente principal do framework TRIVIAIOX-FULLSTACK. Ele atua como orquestrador universal, desenvolvedor de framework e especialista no metodo TRIVIAIOX. Suas principais responsabilidades incluem:
...
- **Knowledge Base**: Acesso ao conhecimento completo do TRIVIAIOX Method
...
- Acessar o Knowledge Base do TRIVIAIOX (*kb)

---

## Lista Completa de Arquivos

### Arquivos Core de Tasks do @triviaiox-master

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/create-agent.md` | `*create agent` | Cria nova definicao de agente usando sistema de templates |
| `.triviaiox-core/development/tasks/create-task.md` | `*create task` | Cria novo arquivo de task com estrutura padronizada |
| `.triviaiox-core/development/tasks/create-workflow.md` | `*create workflow` | Cria nova definicao de workflow multi-agente |
| `.triviaiox-core/development/tasks/modify-agent.md` | `*modify agent` | Modifica agente existente com backup e rollback |
| `.triviaiox-core/development/tasks/modify-task.md` | `*modify task` | Modifica task existente preservando compatibilidade |
| `.triviaiox-core/development/tasks/modify-workflow.md` | `*modify workflow` | Modifica workflow existente mantendo integridade |
| `.triviaiox-core/development/tasks/analyze-framework.md` | `*analyze-framework` | Analisa estrutura do framework, redundancias e performance |
| `.triviaiox-core/development/tasks/deprecate-component.md` | `*deprecate-component` | Deprecia componente com timeline e migracao |
| `.triviaiox-core/development/tasks/propose-modification.md` | `*propose-modification` | Cria proposta de modificacao para revisao colaborativa |
| `.triviaiox-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validacao |
| `.triviaiox-core/development/tasks/create-doc.md` | `*create-doc` | Cria documento a partir de template YAML |
| `.triviaiox-core/development/tasks/advanced-elicitation.md` | `*advanced-elicitation` | Executa elicitacao avancada com multiplos metodos |
| `.triviaiox-core/development/tasks/kb-mode-interaction.md` | `*kb` | Habilita modo Knowledge Base interativo |
| `.triviaiox-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo/qualidade |
| `.triviaiox-core/development/tasks/update-manifest.md` | `*update-manifest` | Atualiza manifesto de equipe com novos agentes |
| `.triviaiox-core/development/tasks/create-next-story.md` | `*create-next-story` | Cria proxima user story |
| `.triviaiox-core/development/tasks/create-deep-research-prompt.md` | - | Gera prompts de pesquisa profunda |
| `.triviaiox-core/development/tasks/improve-self.md` | - | Auto-melhoria do agente |
| `.triviaiox-core/development/tasks/shard-doc.md` | `*shard-doc` | Quebra documento em partes menores |
| `.triviaiox-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao do projeto |
| `.triviaiox-core/development/tasks/index-docs.md` | `*index-docs` | Indexa documentacao para busca |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/triviaiox-master.md` | Definicao completa do agente (persona, comandos, dependencias) |
| `.claude/commands/TRIVIAIOX/agents/triviaiox-master.md` | Comando Claude Code para ativar @triviaiox-master |

### Arquivos de Templates do @triviaiox-master

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/templates/agent-template.yaml` | Template para criacao de novos agentes |
| `.triviaiox-core/development/templates/task-template.md` | Template para criacao de novas tasks |
| `.triviaiox-core/development/templates/workflow-template.yaml` | Template para criacao de novos workflows |
| `.triviaiox-core/development/templates/prd-tmpl.yaml` | Template para PRD |
| `.triviaiox-core/development/templates/story-tmpl.yaml` | Template para stories |
| `.triviaiox-core/development/templates/architecture-tmpl.yaml` | Template para arquitetura |
| `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| `.triviaiox-core/development/templates/competitor-analysis-tmpl.yaml` | Template analise de concorrentes |
| `.triviaiox-core/development/templates/market-research-tmpl.yaml` | Template pesquisa de mercado |
| `.triviaiox-core/development/templates/project-brief-tmpl.yaml` | Template brief de projeto |
| `.triviaiox-core/development/templates/front-end-architecture-tmpl.yaml` | Template arquitetura frontend |
| `.triviaiox-core/development/templates/front-end-spec-tmpl.yaml` | Template spec frontend |
| `.triviaiox-core/development/templates/fullstack-architecture-tmpl.yaml` | Template arquitetura fullstack |

### Arquivos de Dados e Utilidades

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/data/triviaiox-kb.md` | Knowledge Base do TRIVIAIOX Method |
| `.triviaiox-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming |
| `.triviaiox-core/development/data/elicitation-methods.md` | Metodos de elicitacao |
| `.triviaiox-core/development/data/technical-preferences.md` | Preferencias tecnicas |
| `.triviaiox-core/development/utils/security-checker.js` | Validador de seguranca |
| `.triviaiox-core/development/utils/yaml-validator.js` | Validador de YAML |
| `.triviaiox-core/development/utils/workflow-management.md` | Gestao de workflows |

### Arquivos de Workflows do @triviaiox-master

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/workflows/brownfield-fullstack.md` | Workflow fullstack brownfield |
| `.triviaiox-core/development/workflows/brownfield-service.md` | Workflow servico brownfield |
| `.triviaiox-core/development/workflows/brownfield-ui.md` | Workflow UI brownfield |
| `.triviaiox-core/development/workflows/greenfield-fullstack.md` | Workflow fullstack greenfield |
| `.triviaiox-core/development/workflows/greenfield-service.md` | Workflow servico greenfield |
| `.triviaiox-core/development/workflows/greenfield-ui.md` | Workflow UI greenfield |

### Arquivos de Checklists do @triviaiox-master

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/checklists/architect-checklist.md` | Checklist de arquitetura |
| `.triviaiox-core/development/checklists/change-checklist.md` | Checklist de mudancas |
| `.triviaiox-core/development/checklists/pm-checklist.md` | Checklist de PM |
| `.triviaiox-core/development/checklists/po-master-checklist.md` | Checklist de PO |
| `.triviaiox-core/development/checklists/story-dod-checklist.md` | Checklist DoD de stories |
| `.triviaiox-core/development/checklists/story-draft-checklist.md` | Checklist draft de stories |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Proposito |
|---------|--------|-----------|
| `.triviaiox-core/development/tasks/brownfield-create-epic.md` | @pm | Criacao de epics (delegada) |
| `.triviaiox-core/development/tasks/brownfield-create-story.md` | @pm | Criacao de stories (delegada) |
| `.triviaiox-core/development/tasks/analyst-facilitate-brainstorming.md` | @analyst | Brainstorming (delegado) |
| `.triviaiox-core/development/tasks/generate-ai-frontend-prompt.md` | @architect | Geracao de prompts AI (delegada) |
| `.triviaiox-core/development/tasks/create-suite.md` | @qa | Criacao de suites de teste (delegada) |
...
flowchart TB
    subgraph ACTIVATION["🚀 ATIVACAO"]
        USER["👤 Usuario"]
        ACTIVATE["@triviaiox-master"]
        GREETING["greeting-builder.js<br/>Saudacao Inteligente"]
    end

    USER -->|"@triviaiox-master"| ACTIVATE
    ACTIVATE --> GREETING
    ...
    subgraph OUTPUTS["📁 OUTPUTS"]
        AGENTS_DIR[".triviaiox-core/agents/"]
        TASKS_DIR[".triviaiox-core/tasks/"]
        WORKFLOWS_DIR[".triviaiox-core/workflows/"]
        DOCS_DIR["docs/"]
    end
...
```mermaid
flowchart LR
    subgraph MASTER["👑 @triviaiox-master (Orion)"]
...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/core-config.yaml` | Configuracao central do framework |
| `.triviaiox-core/install-manifest.yaml` | Manifesto de instalacao |
| `.triviaiox-core/config/agent-config-requirements.yaml` | Requisitos de configuracao de agentes |
| `.triviaiox/project-registry.yaml` | Registry central de projetos |
...
**Solucao:**
1. Liste templates disponiveis: verifique `.triviaiox-core/development/templates/`
...
**Solucao:**
1. Verifique existencia de `.triviaiox-core/development/data/triviaiox-kb.md`
...
- [Agente triviaiox-master](.triviaiox-core/development/agents/triviaiox-master.md)
- [Knowledge Base](.triviaiox-core/development/data/triviaiox-kb.md)
- [Guia do Usuario](.triviaiox-core/user-guide.md)

### Standards e Documentacao

- [TRIVIAIOX Framework Master](.triviaiox-core/docs/standards/TRIVIAIOX-FRAMEWORK-MASTER.md)
- [TRIVIAIOX Livro de Ouro](.triviaiox-core/docs/standards/TRIVIAIOX-LIVRO-DE-OURO.md)
- [Agent Personalization Standard](.triviaiox-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)

### Diretorio de Tasks

- [Tasks Directory](.triviaiox-core/development/tasks/)
- [Templates Directory](.triviaiox-core/development/templates/)
- [Workflows Directory](.triviaiox-core/development/workflows/)
...
| Aspecto | Detalhes |
|---------|----------|
| **Nome do Agente** | Orion (triviaiox-master) |
...
|------|-------|-----------|
| 2026-02-04 | @triviaiox-master | Documento inicial criado com mapeamento completo |

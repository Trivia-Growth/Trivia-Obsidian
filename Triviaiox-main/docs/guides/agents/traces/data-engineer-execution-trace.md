...
> Agent definition: `.triviaiox-core/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.triviaiox/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.triviaiox-core/development/scripts/generate-greeting.js`.
...
**Template:** `.triviaiox-core/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.triviaiox-core/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/db-domain-modeling.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-env-check.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-bootstrap.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-apply-migration.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-dry-run.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-seed.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-snapshot.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-rollback.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-smoke-test.md`
...
**Task file:** `.triviaiox-core/development/tasks/security-audit.md`
...
**Task file:** `.triviaiox-core/development/tasks/analyze-performance.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-policy-apply.md`
...
**Task file:** `.triviaiox-core/development/tasks/test-as-user.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-verify-order.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-load-csv.md`
...
**Task file:** `.triviaiox-core/development/tasks/db-run-sql.md`
...
**Task file:** `.triviaiox-core/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .triviaiox-core/development/checklists/]
...
**Task file:** `.triviaiox-core/development/tasks/create-deep-research-prompt.md`

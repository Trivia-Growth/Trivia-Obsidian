...
> Agent definition: `.triviaiox-core/development/agents/analyst.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/analyst.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, analyticsLocation |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox-core/product/data/brainstorming-techniques.md` | AgentConfigLoader.loadFile() | Brainstorming techniques (always loaded, 2KB) |
...
analyst:
  config_sections:
    ...
    - analyticsLocation
  files_loaded:
    - path: .triviaiox-core/product/data/brainstorming-techniques.md
      lazy: false
      size: 2KB
...
**Template:** `.triviaiox-core/product/templates/project-brief-tmpl.yaml` (EXISTS)
...
| `.triviaiox-core/product/data/elicitation-methods.md` | Data | Referenced by create-doc |
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/product/templates/market-research-tmpl.yaml` (EXISTS)
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/product/templates/competitor-analysis-tmpl.yaml` (EXISTS)
...
**Task file:** `.triviaiox-core/development/tasks/facilitate-brainstorming-session.md`
**Template:** `.triviaiox-core/product/templates/brainstorming-output-tmpl.yaml` (EXISTS)
**Data file:** `.triviaiox-core/product/data/brainstorming-techniques.md` (EXISTS)
...
**Task file:** `.triviaiox-core/development/tasks/spec-research-dependencies.md`
...
**Script:** `.triviaiox-core/infrastructure/scripts/pattern-extractor.js` (EXISTS)

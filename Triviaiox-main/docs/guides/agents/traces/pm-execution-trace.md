...
> Agent definition: `.triviaiox-core/development/agents/pm.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/pm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog |
...
|-----------|---------|--------|
| `correct-course.md` | Delegated to @triviaiox-master | EXISTS |
...
**Template:** `.triviaiox-core/development/templates/prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.triviaiox-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.triviaiox-core/product/templates/brownfield-prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.triviaiox-core/development/tasks/brownfield-create-epic.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-epic.md` | Task | EXISTS |
| `.triviaiox-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (epic structure) |
| `.triviaiox-core/product/checklists/pm-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.triviaiox-core/development/tasks/brownfield-create-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-story.md` | Task | EXISTS |
| `.triviaiox-core/product/templates/story-tmpl.yaml` | Template | EXISTS (in product/templates/) |
...
**Task file:** `.triviaiox-core/development/tasks/spec-gather-requirements.md`
...
**Task file:** `.triviaiox-core/development/tasks/spec-write-spec.md`
...
| @pm -> @triviaiox-master | Escalate | Course corrections via `*correct-course` |
| @pm -> @devops | Delegate | Git push operations, PR creation |
| @analyst -> @pm | Receives | Project brief for PRD creation |
| @triviaiox-master -> @pm | Receives | Framework modification requests |
...
| Module | Path | Status |
|--------|------|--------|
| TerminalSpawner | `.triviaiox-core/core/orchestration/terminal-spawner.js` | EXISTS |
| ExecutorAssignment | `.triviaiox-core/core/orchestration/executor-assignment.js` | EXISTS |
| PM Script | `.triviaiox-core/scripts/pm.sh` | EXISTS |
...
**Escalates to @triviaiox-master when:**
...
**Note:** All 9 task files referenced in dependencies exist in `.triviaiox-core/development/tasks/`. The 2 templates and 2 checklists are missing from `development/` but exist in `product/` as fallback locations.

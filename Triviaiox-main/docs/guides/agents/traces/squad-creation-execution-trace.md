...
> Agent definition: `.triviaiox-core/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
...
| `*sync-squad-triviagrowth` | squad-creator-sync-triviagrowth.md | full | No |
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-design.md`
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-create.md`
...
| `.triviaiox-core/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-validate.md`
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-list.md`
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-migrate.md`
...
flowchart TD
    ...
    C --> D["Detect: config.yaml, flat structure,<br/>missing triviaiox.type, missing triviaiox.minVersion"]
    D --> E{Needs migration?}
...
**Migration detections:** config.yaml (rename to squad.yaml), flat structure (create dirs), missing fields (triviaiox.type, triviaiox.minVersion, name, version)

---

### `*analyze-squad`

**Task file:** `.triviaiox-core/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.triviaiox-core/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/task-template.md` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/template-template.md` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/script-template.js` | Template | EXISTS |
| `.triviaiox-core/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-download.md`
...
flowchart TD
    ...
    B --> C{--list flag?}
    C -->|yes| D[Fetch registry.json from triviaiox-squads]
...
**Source:** `github.com/Trivia-Growth/triviaiox-squads`

---

### `*publish-squad`

**Task file:** `.triviaiox-core/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
flowchart TD
    ...
    G -->|no| I[Fork/clone triviaiox-squads]
...
**Target:** `github.com/Trivia-Growth/triviaiox-squads` via Pull Request
...
**Task file:** `.triviaiox-core/development/tasks/squad-creator-sync-triviagrowth.md`
**Status:** Active (Sprint 8)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `squad-creator-sync-triviagrowth.md` | Task | EXISTS |
| `squad-validator.js` | Script | EXISTS |
...
```mermaid
flowchart TD
    A["*sync-squad-triviagrowth {path}"] --> B[Load squad-creator-sync-triviagrowth.md task]
    B --> C[Find and validate squad.yaml]
    C --> D{Validation passed?}
    D -->|no| E[Abort: validation failed]
    D -->|yes| F[Calculate SHA-256 checksum]
    F --> G{TRIVIAGROWTH_API_TOKEN set?}
...
**API endpoint:** `https://api.triviagrowth.dev/api/squads/sync`
...
graph TD
    ...
    subgraph "Task Files"
        ...
        T10[squad-creator-sync-triviagrowth.md]
...
| @triviaiox-master -> @squad-creator | Invokes | Component creation (agents, tasks, workflows) |
...
- `.triviaiox-core/development/tasks/squad-creator-design.md`
- `.triviaiox-core/development/tasks/squad-creator-create.md`
- `.triviaiox-core/development/tasks/squad-creator-validate.md`
- `.triviaiox-core/development/tasks/squad-creator-list.md`
- `.triviaiox-core/development/tasks/squad-creator-migrate.md`
- `.triviaiox-core/development/tasks/squad-creator-analyze.md`
- `.triviaiox-core/development/tasks/squad-creator-extend.md`
- `.triviaiox-core/development/tasks/squad-creator-download.md`
- `.triviaiox-core/development/tasks/squad-creator-publish.md`
- `.triviaiox-core/development/tasks/squad-creator-sync-triviagrowth.md`
- `.triviaiox-core/development/tasks/squad-creator-sync-ide-command.md`

**Scripts (11 files in squad/ dir, all EXISTS):**
- `.triviaiox-core/development/scripts/squad/index.js`
- `.triviaiox-core/development/scripts/squad/squad-loader.js`
- `.triviaiox-core/development/scripts/squad/squad-validator.js`
- `.triviaiox-core/development/scripts/squad/squad-generator.js`
- `.triviaiox-core/development/scripts/squad/squad-designer.js`
- `.triviaiox-core/development/scripts/squad/squad-migrator.js`
...
- `.triviaiox-core/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.triviaiox-core/schemas/squad-schema.json`
- `.triviaiox-core/schemas/squad-design-schema.json`
...
- `.triviaiox-core/development/templates/squad/workflow-template.yaml`
...
- `.triviaiox-core/development/templates/squad-template/squad.yaml`
- `.triviaiox-core/development/templates/squad-template/README.md`
- `.triviaiox-core/development/templates/squad-template/package.json`
- `.triviaiox-core/development/templates/squad-template/.gitignore`
- `.triviaiox-core/development/templates/squad-template/LICENSE`
- `.triviaiox-core/development/templates/squad-template/agents/example-agent.yaml`
- `.triviaiox-core/development/templates/squad-template/tasks/example-task.yaml`
- `.triviaiox-core/development/templates/squad-template/workflows/example-workflow.yaml`
- `.triviaiox-core/development/templates/squad-template/templates/example-template.md`
- `.triviaiox-core/development/templates/squad-template/tests/example-agent.test.js`

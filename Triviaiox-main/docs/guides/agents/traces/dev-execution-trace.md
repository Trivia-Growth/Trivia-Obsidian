...
> Agent definition: `.triviaiox-core/development/agents/dev.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/dev.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration + devLoadAlwaysFiles list |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devLoadAlwaysFiles, devStoryLocation, dataLocation |
...
| 8 | `.triviaiox-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.triviaiox/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.triviaiox/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.triviaiox-core/development/tasks/dev-develop-story.md`
...
**Task file:** `.triviaiox-core/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.triviaiox-core/development/tasks/build-autonomous.md`
...
**Task files:** `.triviaiox-core/development/tasks/gotcha.md`, `.triviaiox-core/development/tasks/gotchas.md`
...
**Task files:** `.triviaiox-core/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-fix-issues.md`
...
**Task file:** `.triviaiox-core/development/tasks/waves.md`
...
**Task file:** `.triviaiox-core/development/tasks/create-service.md`

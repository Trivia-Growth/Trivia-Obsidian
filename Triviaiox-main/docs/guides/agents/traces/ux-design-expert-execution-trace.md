...
> Agent definition: `.triviaiox-core/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.triviaiox/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
**Task file:** `.triviaiox-core/development/tasks/ux-user-research.md`
...
**Task file:** `.triviaiox-core/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.triviaiox-core/development/tasks/generate-ai-frontend-prompt.md`
...
**Template:** `.triviaiox-core/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.triviaiox-core/development/tasks/audit-codebase.md`
...
**Task file:** `.triviaiox-core/development/tasks/consolidate-patterns.md`
...
**Task file:** `.triviaiox-core/development/tasks/generate-shock-report.md`
**Template:** `.triviaiox-core/product/templates/shock-report-tmpl.html`
...
**Task file:** `.triviaiox-core/development/tasks/extract-tokens.md`
**Template:** `.triviaiox-core/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.triviaiox-core/development/tasks/setup-design-system.md`
...
**Task file:** `.triviaiox-core/development/tasks/generate-migration-strategy.md`
**Template:** `.triviaiox-core/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.triviaiox-core/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.triviaiox-core/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.triviaiox-core/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.triviaiox-core/product/templates/token-exports-css-tmpl.css`, `.triviaiox-core/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.triviaiox-core/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.triviaiox-core/development/tasks/build-component.md`
**Template:** `.triviaiox-core/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.triviaiox-core/development/tasks/compose-molecule.md`
...
**Task file:** `.triviaiox-core/development/tasks/extend-pattern.md`
...
**Task file:** `.triviaiox-core/development/tasks/generate-documentation.md`
...
**Checklist file:** `.triviaiox-core/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.triviaiox-core/development/tasks/calculate-roi.md`
...
**Task file:** `.triviaiox-core/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.triviaiox-core/product/templates/ds-artifact-analysis.md`
...
**Task file:** `.triviaiox-core/development/tasks/integrate-Squad.md` (MISSING)
...
The agent definition references dependencies using short names (e.g., `triviaiox-core/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `triviaiox-core/tasks/{name}` | `.triviaiox-core/development/tasks/{name}` |
| Templates | `triviaiox-core/templates/{name}` | `.triviaiox-core/product/templates/{name}` |
| Checklists | `triviaiox-core/checklists/{name}` | `.triviaiox-core/product/checklists/{name}` |
| Data | `triviaiox-core/data/{name}` | `.triviaiox-core/data/{name}` or `.triviaiox-core/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.triviaiox-core/data/` and `.triviaiox-core/product/data/`.
...
**Template for state persistence:** `.triviaiox-core/product/templates/state-persistence-tmpl.yaml` (EXISTS)

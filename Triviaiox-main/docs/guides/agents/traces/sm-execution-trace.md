...
> Agent definition: `.triviaiox-core/development/agents/sm.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/sm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog, dataLocation |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox-core/product/data/mode-selection-best-practices.md` | AgentConfigLoader.loadFile() | Mode selection best practices (always loaded, 10KB) |
...
sm:
  config_sections:
    ...
    - dataLocation
  files_loaded:
    - path: .triviaiox-core/product/data/mode-selection-best-practices.md
      lazy: false
      size: 10KB
    - path: .triviaiox-core/data/workflow-patterns.yaml
      lazy: false
      size: 8KB
...
**Task file:** `.triviaiox-core/development/tasks/sm-create-next-story.md`
**Template:** `.triviaiox-core/development/templates/story-tmpl.yaml` (MISSING in development/, EXISTS in `.triviaiox-core/product/templates/story-tmpl.yaml`)
...
| `.triviaiox-core/product/data/mode-selection-best-practices.md` | Data | Referenced by sm config |
...
**Checklist:** `.triviaiox-core/development/checklists/story-draft-checklist.md` (MISSING in development/, EXISTS in `.triviaiox-core/product/checklists/story-draft-checklist.md`)
...
- Course corrections needed (`@triviaiox-master *correct-course`)
...
|------|------|---------------|--------|
| `story-tmpl.yaml` | Template | `*draft` (sm-create-next-story.md) | MISSING in `.triviaiox-core/development/templates/`, EXISTS in `.triviaiox-core/product/templates/story-tmpl.yaml` |
| `story-draft-checklist.md` | Checklist | `*story-checklist` (execute-checklist.md) | MISSING in `.triviaiox-core/development/checklists/`, EXISTS in `.triviaiox-core/product/checklists/story-draft-checklist.md` |

# @triviaiox-master (Orion) - Execution Trace

> Traced from source code, not documentation.
> Agent definition: `.triviaiox-core/development/agents/triviaiox-master.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/triviaiox-master.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, registry |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 6 | `.triviaiox/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |

**NOT loaded on activation:**

| File | Condition | Size |
|------|-----------|------|
| `.triviaiox-core/data/triviaiox-kb.md` | ONLY when user types `*kb` | 35KB |
...
sequenceDiagram
    ...
    participant AMd as triviaiox-master.md
    ...
    CC->>ACL: loadAgentDefinition('triviaiox-master')
...
triviaiox-master:
  config_sections:
    ...
    - registry
  files_loaded:
    - path: .triviaiox-core/data/triviaiox-kb.md
      lazy: true
      condition: kb_command
      size: 35KB
  lazy_loading:
    registry: false      # Always load (15KB, frequently used)
    triviaiox-kb: true        # Load only on *kb command
...
| Role | `persona.role` | Master Orchestrator, Framework Developer & TRIVIAIOX Method Expert |
...
| `*list-components` | (built-in, scans .triviaiox-core/) | full | No |
...
**Task file:** `.triviaiox-core/development/tasks/kb-mode-interaction.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `kb-mode-interaction.md` | Task | EXISTS |
| `.triviaiox-core/data/triviaiox-kb.md` | Data | EXISTS (lazy, 35KB) |
...
flowchart TD
    ...
    B --> C[Load triviaiox-kb.md into context]
    C --> D[Toggle KB mode ON]
    D --> E[Agent now answers with full TRIVIAIOX Method knowledge]
    E --> F[User types *kb again to toggle OFF]
```

**CRITICAL:** triviaiox-kb.md is NEVER loaded unless user explicitly types `*kb`.

---

### `*create`

**Task files:** `.triviaiox-core/development/tasks/create-agent.md`, `create-task.md`, `create-workflow.md`
...
| `agent-template.yaml` | Template | EXISTS (in .triviaiox-core/product/templates/) |
| `task-template.md` | Template | EXISTS (in .triviaiox-core/product/templates/) |
| `workflow-template.yaml` | Template | EXISTS (in .triviaiox-core/product/templates/) |
| `security-checker.js` | Util | EXISTS (in .triviaiox-core/infrastructure/scripts/) |
| `yaml-validator.js` | Util | EXISTS (in .triviaiox-core/infrastructure/scripts/) |
...
flowchart TD
    ...
    M --> N{Validation pass?}
    N -->|yes| O[Write component to .triviaiox-core/development/{type}/]
    N -->|no| P[Report validation errors]
    O --> Q[Update manifest if applicable]
```

**Expected output:** New TRIVIAIOX component file written to appropriate directory.

---

### `*modify`

**Task files:** `.triviaiox-core/development/tasks/modify-agent.md`, `modify-task.md`, `modify-workflow.md`
...
**Task file:** `.triviaiox-core/development/tasks/update-manifest.md`
...
**Task file:** `.triviaiox-core/development/tasks/deprecate-component.md`
...
**Task file:** `.triviaiox-core/development/tasks/propose-modification.md`
...
**Task file:** `.triviaiox-core/development/tasks/undo-last.md`
...
**Task file:** `.triviaiox-core/development/tasks/validate-workflow.md`
...
| `yaml-validator.js` | Util | EXISTS |
| `.triviaiox-core/development/workflows/{name}.yaml` | Workflow | Dynamically loaded |
...
**Task files:** `.triviaiox-core/development/tasks/run-workflow.md`, `run-workflow-engine.md`
**Template:** `.triviaiox-core/development/templates/subagent-step-prompt.md`
...
| `subagent-step-prompt.md` | Template | EXISTS (in .triviaiox-core/development/templates/) |
| `workflow-management.md` | Util | EXISTS (in .triviaiox-core/scripts/) |
| `.triviaiox-core/development/workflows/{name}.yaml` | Workflow | Dynamically loaded |
...
**Task file:** `.triviaiox-core/development/tasks/analyze-framework.md`
...
flowchart TD
    ...
    B --> C[Scan .triviaiox-core/ directory structure]
...
**Task file:** `.triviaiox-core/development/tasks/execute-checklist.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `execute-checklist.md` | Task | EXISTS |
| `.triviaiox-core/product/checklists/{checklist}.md` | Checklist | Dynamically loaded |
...
flowchart TD
    ...
    B --> C{Name provided?}
    C -->|yes| D[Resolve checklist from .triviaiox-core/product/checklists/]
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Templates:** All 15 templates from `.triviaiox-core/product/templates/`
...
| `.triviaiox-core/product/data/elicitation-methods.md` | Data | EXISTS |
...
flowchart TD
    ...
    C -->|yes| D[Load template from .triviaiox-core/product/templates/]
...
**Task file:** `.triviaiox-core/development/tasks/shard-doc.md`
...
**Task file:** `.triviaiox-core/development/tasks/document-project.md`
...
**Task file:** `.triviaiox-core/development/tasks/add-tech-doc.md` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/create-next-story.md`
...
**Task file:** `.triviaiox-core/development/tasks/advanced-elicitation.md`
...
**Task file:** `.triviaiox-core/development/tasks/correct-course.md`
...
**Task file:** `.triviaiox-core/development/tasks/index-docs.md`
...
| `*guide` | Renders the `## TRIVIAIOX Master Guide` section from agent .md |
...
| `*exit` | Exits triviaiox-master mode, returns to base Claude Code |
| `*agent {name}` | Reads and displays info about a specialized agent (use `@` to transform into it) |
| `*list-components` | Scans .triviaiox-core/ and lists all framework components (agents, tasks, workflows, templates, checklists) |
...
|-------------|-----------|---------|
| @triviaiox-master -> @pm | Delegate | Epic/story creation (brownfield-create-epic, brownfield-create-story) |
| @triviaiox-master -> @analyst | Delegate | Brainstorming sessions (*brainstorm) |
| @triviaiox-master -> @qa | Delegate | Test suite creation (*create-suite) |
| @triviaiox-master -> @architect | Delegate | AI prompt generation (*generate-ai-prompt) |
| @triviaiox-master -> @dev | Handoff | Story implementation after story creation |
| @triviaiox-master -> @devops | Delegate | Git push operations, PR creation |
| @triviaiox-master -> any agent | Execute | Can execute any task from any agent directly |
| Any agent -> @triviaiox-master | Escalate | Cross-agent coordination, framework operations |
...
|------------|---------------|-------------|
| `security-checker.js` | `.triviaiox-core/development/utils/` | `.triviaiox-core/infrastructure/scripts/security-checker.js` |
| `yaml-validator.js` | `.triviaiox-core/development/utils/` | `.triviaiox-core/infrastructure/scripts/yaml-validator.js` |
| `workflow-management.md` | `.triviaiox-core/development/utils/` | `.triviaiox-core/scripts/workflow-management.md` |
| `subagent-step-prompt.md` | `.triviaiox-core/product/templates/` | `.triviaiox-core/development/templates/subagent-step-prompt.md` |
| `elicitation-methods.md` | `.triviaiox-core/data/` | `.triviaiox-core/product/data/elicitation-methods.md` |
| `brainstorming-techniques.md` | `.triviaiox-core/data/` | `.triviaiox-core/product/data/brainstorming-techniques.md` |

---

*Traced from source on 2026-02-05 | Story TRIVIAIOX-TRACE-001*

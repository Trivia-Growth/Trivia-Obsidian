...
> Agent definition: `.triviaiox-core/development/agents/po.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/po.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, prd, storyBacklog, templatesLocation |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox-core/product/data/elicitation-methods.md` | AgentConfigLoader.loadFile() | Elicitation methods (always loaded, 5KB) |
...
po:
  config_sections:
    ...
    - templatesLocation
  files_loaded:
    - path: .triviaiox-core/product/data/elicitation-methods.md
      lazy: false
      size: 5KB
  lazy_loading:
...
**Task file:** `.triviaiox-core/development/tasks/po-backlog-add.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `po-backlog-add.md` | Task | EXISTS |
| `.triviaiox-core/product/data/elicitation-methods.md` | Data | EXISTS (pre-loaded) |
...
**Task file:** `.triviaiox-core/development/tasks/po-manage-story-backlog.md`
...
**Task file:** `.triviaiox-core/development/tasks/po-stories-index.md`
...
**Task file:** `.triviaiox-core/development/tasks/validate-next-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-next-story.md` | Task | EXISTS |
| `.triviaiox-core/product/templates/story-tmpl.yaml` | Template | EXISTS |
| `.triviaiox-core/product/checklists/po-master-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.triviaiox-core/development/tasks/po-sync-story.md`
...
flowchart TD
    ...
    E -->|None configured| J[Prompt: run triviaiox init]
...
**Task file:** `.triviaiox-core/development/tasks/po-pull-story.md`
...
| @po -> @triviaiox-master | Escalate | Course corrections via `*correct-course` |
...
**Delegates to @triviaiox-master when:**

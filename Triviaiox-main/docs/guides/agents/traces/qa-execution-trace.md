...
> Agent definition: `.triviaiox-core/development/agents/qa.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/qa.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: qaLocation, dataLocation, storyBacklog |
| 4 | `.triviaiox-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.triviaiox-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 6 | `.triviaiox-core/product/data/test-levels-framework.md` | AgentConfigLoader.loadFile() | Test levels framework (always loaded, 8KB) |
| 7 | `.triviaiox-core/product/data/test-priorities-matrix.md` | AgentConfigLoader.loadFile() | Test priorities matrix (always loaded, 6KB) |
| 8 | `.triviaiox/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 9 | `.triviaiox/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
qa:
  config_sections:
    ...
    - storyBacklog
  files_loaded:
    - path: .triviaiox-core/data/technical-preferences.md
      lazy: false
      size: 15KB
    - path: .triviaiox-core/product/data/test-levels-framework.md
      lazy: false
      size: 8KB
    - path: .triviaiox-core/product/data/test-priorities-matrix.md
      lazy: false
      size: 6KB
  lazy_loading:
...
**Task file:** `.triviaiox-core/development/tasks/qa-run-tests.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-review-story.md`
...
| `.triviaiox-core/product/data/test-levels-framework.md` | Data | Loaded at activation |
| `.triviaiox-core/product/data/test-priorities-matrix.md` | Data | Loaded at activation |
...
**Task file:** `.triviaiox-core/development/tasks/qa-review-build.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-gate.md`
**Template:** `.triviaiox-core/product/templates/qa-gate-tmpl.yaml` (EXISTS in product/templates)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `qa-gate.md` | Task | EXISTS |
| `qa-gate-tmpl.yaml` | Template | EXISTS (in `.triviaiox-core/product/templates/`) |
| `docs/stories/{storyId}` | Input | Required |
...
**Task file:** `.triviaiox-core/development/tasks/qa-nfr-assess.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-risk-profile.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-create-fix-request.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-library-validation.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-security-checklist.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-migration-validation.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-evidence-requirements.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-false-positive-detection.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-browser-console-check.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-test-design.md`
...
**Task file:** `.triviaiox-core/development/tasks/qa-trace-requirements.md`
...
**Task file:** `.triviaiox-core/development/tasks/create-suite.md`
...
**Task file:** `.triviaiox-core/development/tasks/spec-critique.md`
...
**Task file:** `.triviaiox-core/development/tasks/manage-story-backlog.md` (MISSING)
...
| `qa-gate-tmpl.yaml` | Template | `*gate` (in `dependencies.templates`) | EXISTS in `.triviaiox-core/product/templates/` but NOT in `.triviaiox-core/development/templates/` per IDE-FILE-RESOLUTION |
| `story-tmpl.yaml` | Template | (in `dependencies.templates`) | EXISTS in `.triviaiox-core/product/templates/` but NOT in `.triviaiox-core/development/templates/` per IDE-FILE-RESOLUTION |
| `test-levels-framework.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.triviaiox-core/product/data/` (NOT in `.triviaiox-core/data/` where `dependencies.data` resolves) |
| `test-priorities-matrix.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.triviaiox-core/product/data/` (NOT in `.triviaiox-core/data/` where `dependencies.data` resolves) |

**Path Resolution Note:** The `IDE-FILE-RESOLUTION` rule in the agent definition maps `dependencies` to `.triviaiox-core/development/{type}/{name}`. However, 2 templates and 2 data files exist under `.triviaiox-core/product/` instead. The `agent-config-requirements.yaml` correctly references the full paths under `.triviaiox-core/product/data/`, but the agent definition's `dependencies` block uses short names that resolve to `.triviaiox-core/development/templates/` and `.triviaiox-core/development/data/` respectively, where these files do not exist. Actual runtime loading uses `agent-config-requirements.yaml` paths, so functionality is preserved.

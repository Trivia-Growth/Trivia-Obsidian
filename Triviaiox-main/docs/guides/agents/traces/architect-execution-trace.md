...
> Agent definition: `.triviaiox-core/development/agents/architect.md`
...
|-------|------|--------|---------|
| 1 | `.triviaiox-core/development/agents/architect.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.triviaiox-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.triviaiox-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: architecture, dataLocation, templatesLocation |
...
**Template:** `.triviaiox-core/development/templates/fullstack-architecture-tmpl.yaml` (MISSING)
...
| `.triviaiox-core/data/elicitation-methods` | Data | Referenced by create-doc |
| `.triviaiox-core/product/templates/` | Templates dir | Scanned dynamically |
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/front-end-architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.triviaiox-core/development/tasks/create-doc.md`
**Template:** `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml` (MISSING)
...
| `.triviaiox-core/scripts/execute-task.js` | Script | Referenced |
...
flowchart TD
    ...
    B --> C[Resolve checklist file from .triviaiox-core/product/checklists/]
...
**Task file:** `.triviaiox-core/development/tasks/analyze-project-structure.md`
...
**Task file:** `.triviaiox-core/development/tasks/validate-tech-preset.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-tech-preset.md` | Task | EXISTS |
| `.triviaiox-core/data/tech-presets/{name}.md` | Data | Validated |
| `.triviaiox-core/data/tech-presets/_template.md` | Template | Reference |
...
flowchart TD
    ...
    B --> C[Load preset from .triviaiox-core/data/tech-presets/{name}.md]
...
**Task file:** `.triviaiox-core/development/tasks/spec-assess-complexity.md`
...
**Task file:** `.triviaiox-core/development/tasks/plan-create-implementation.md`
...
**Task file:** `.triviaiox-core/development/tasks/plan-create-context.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `plan-create-context.md` | Task | EXISTS |
| `.triviaiox-core/core-config.yaml` | Config | Required |
...
**Script:** `.triviaiox-core/development/scripts/codebase-mapper.js` (MISSING)

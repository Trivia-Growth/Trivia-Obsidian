...
O agente **@qa (Quinn)** e o Test Architect & Quality Advisor do TRIVIAIOX. Seu papel e fornecer analise abrangente de qualidade, decisoes de quality gates e recomendacoes acionaveis para equipes de desenvolvimento.
...
|---------|---------|-----------|
| `.triviaiox-core/development/tasks/qa-gate.md` | `*gate {story}` | Criar arquivo de decisao de quality gate |
| `.triviaiox-core/development/tasks/qa-review-story.md` | `*review {story}` | Revisao completa de story com decisao de gate |
| `.triviaiox-core/development/tasks/qa-test-design.md` | `*test-design {story}` | Criar cenarios de teste abrangentes |
| `.triviaiox-core/development/tasks/qa-risk-profile.md` | `*risk-profile {story}` | Gerar matriz de avaliacao de risco |
| `.triviaiox-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos nao-funcionais |
| `.triviaiox-core/development/tasks/qa-trace-requirements.md` | `*trace {story}` | Mapear requisitos para testes (Given-When-Then) |
| `.triviaiox-core/development/tasks/qa-generate-tests.md` | `*generate-tests` | Gerar suites de teste automaticamente |
| `.triviaiox-core/development/tasks/qa-run-tests.md` | `*run-tests` | Executar suite de testes com gate de qualidade |
| `.triviaiox-core/development/tasks/qa-backlog-add-followup.md` | `*backlog-add` | Adicionar follow-ups ao backlog |
| `.triviaiox-core/development/tasks/qa-create-fix-request.md` | `*create-fix-request {story}` | Gerar documento de fix request para @dev |

### Arquivos de Tasks Secundarias do @qa

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/tasks/qa-browser-console-check.md` | Verificar erros no console do browser |
| `.triviaiox-core/development/tasks/qa-evidence-requirements.md` | Requisitos de evidencia para QA |
| `.triviaiox-core/development/tasks/qa-false-positive-detection.md` | Deteccao de falsos positivos |
| `.triviaiox-core/development/tasks/qa-fix-issues.md` | Task para @dev aplicar fixes de QA |
| `.triviaiox-core/development/tasks/qa-library-validation.md` | Validacao de bibliotecas |
| `.triviaiox-core/development/tasks/qa-migration-validation.md` | Validacao de migracoes |
| `.triviaiox-core/development/tasks/qa-review-build.md` | Revisao de builds |
| `.triviaiox-core/development/tasks/qa-security-checklist.md` | Checklist de seguranca |
| `.triviaiox-core/development/tasks/qa-review-proposal.md` | Revisao de propostas |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/qa.md` | Definicao completa do agente QA |
| `.claude/commands/TRIVIAIOX/agents/qa.md` | Comando Claude Code para ativar @qa |

### Arquivos de Workflow

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/workflows/qa-loop.yaml` | Orquestrador do loop QA (Review -> Fix -> Re-review) |

### Arquivos de Time

| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agent-teams/team-qa-focused.yaml` | Configuracao do time focado em QA (@dev, @qa, @github-devops) |
...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/core-config.yaml` | Configuracao central (qa.qaLocation, etc.) |
| `.triviaiox-core/development/data/technical-preferences.md` | Preferencias tecnicas para QA |
...
wsl bash -c 'cd /mnt/c/.../triviaiox-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
...
- [qa-gate.md](/.triviaiox-core/development/tasks/qa-gate.md)
- [qa-review-story.md](/.triviaiox-core/development/tasks/qa-review-story.md)
- [qa-test-design.md](/.triviaiox-core/development/tasks/qa-test-design.md)
- [qa-risk-profile.md](/.triviaiox-core/development/tasks/qa-risk-profile.md)
- [qa-nfr-assess.md](/.triviaiox-core/development/tasks/qa-nfr-assess.md)
- [qa-trace-requirements.md](/.triviaiox-core/development/tasks/qa-trace-requirements.md)

### Workflows

- [qa-loop.yaml](/.triviaiox-core/development/workflows/qa-loop.yaml)

### Teams

- [team-qa-focused.yaml](/.triviaiox-core/development/agent-teams/team-qa-focused.yaml)

### Agente

- [qa.md](/.triviaiox-core/development/agents/qa.md)

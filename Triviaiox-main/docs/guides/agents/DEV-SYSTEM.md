...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/agents/dev.md` | Definicao core do agente @dev (persona, comandos, workflows) |
...
| `.triviaiox-core/development/scripts/greeting-builder.js` | Constroi greeting adaptativo |

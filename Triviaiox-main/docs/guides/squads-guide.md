...
Complete guide for creating, validating, publishing, and managing Squads in TRIVIAIOX.
...
Squads are modular teams of AI agents that extend TRIVIAIOX functionality. Each squad is a self-contained package containing:
...
│  Level 2: TRIVIAIOX-SQUADS  → github.com/Trivia-Growth (Public/Free)  │
│  Level 3: TRIVIAGROWTH API   → api.triviagrowth.dev      (Marketplace)  │
└─────────────────────────────────────────────────────────────┘
```
...
|-------|---------|-------------|
| [etl-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl) | 2.0.0 | Data collection and transformation |
| [creator-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) | 1.0.0 | Content generation utilities |
...
- Node.js 18+
- TRIVIAIOX project initialized (`.triviaiox-core/` exists)
...
Tasks must follow [TASK-FORMAT-SPECIFICATION-V1](../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Mode | Behavior |
|------|----------|
| `extend` | Add squad rules to core TRIVIAIOX rules |
...
### Level 2: triviaiox-squads Repository (Public)
...
This creates a PR to [Trivia-Growth/triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads).

### Level 3: TriviaGrowth Marketplace
...
- `triviaiox.type` field
- `triviaiox.minVersion` field
...
3. **Add Fields** - `triviaiox.type`, `triviaiox.minVersion`
...
# - triviaiox.type: must be "squad"
# - triviaiox.minVersion: must be valid semver
```
...
### What's the difference between a Squad and legacy TRIVIAIOX squad formats?

**Squads** are the standard format in TRIVIAIOX 2.1+ with:
- Task-first architecture
...
3. Re-publish: `*publish-squad` or `*sync-squad-triviagrowth`
...
- **Level 3**: Sync with `--private` flag: `*sync-squad-triviagrowth my-squad --private`

### What's the minimum TRIVIAIOX version for Squads?

Squads require TRIVIAIOX 2.1.0+. Set in manifest:
...
- [@squad-creator Agent](../../.triviaiox-core/development/agents/squad-creator.md)
- [triviaiox-squads Repository](https://github.com/Trivia-Growth/triviaiox-squads)

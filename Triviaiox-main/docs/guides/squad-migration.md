...
How to migrate legacy squads to TRIVIAIOX 2.1 format.

## Overview

TRIVIAIOX 2.1 introduced a new squad format with:
...
| TRIVIAIOX type field | Missing | `triviaiox.type: squad` |
| Min version | Missing | `triviaiox.minVersion: "2.1.0"` |
...
**Result:**
- Adds missing `triviaiox` fields to manifest
...
- [ ] `triviaiox.type` is `"squad"`
- [ ] `triviaiox.minVersion` is `"2.1.0"` or higher

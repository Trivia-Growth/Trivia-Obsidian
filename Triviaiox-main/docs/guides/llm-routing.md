...
**Option 1: If you have triviaiox-core cloned**
```bash
# From triviaiox-core directory
...
- **Task Definition:** `.triviaiox-core/development/tasks/setup-llm-routing.md`
...
*Generated by TRIVIAIOX Framework - Story 6.7*

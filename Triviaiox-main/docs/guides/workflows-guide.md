...
TRIVIAIOX Workflows are orchestrated sequences of agent activities that automate complex development processes. They provide structured, repeatable patterns for common development scenarios.
...
- **Core**: `.triviaiox-core/development/workflows/{name}.yaml`
...
State is persisted in `.triviaiox/{instance-id}-state.yaml`:
...
TRIVIAIOX detects common workflow patterns based on command history:
...
| **Location** | `.triviaiox-core/development/workflows/` | `.triviaiox-core/development/tasks/` |
...
ls .triviaiox-core/development/workflows/

# Validate a workflow
*validate-workflow {name}

# View workflow details
cat .triviaiox-core/development/workflows/{name}.yaml
```
...
- [TRIVIAIOX Workflows](../triviaiox-workflows/README.md) - Complete documentation for each workflow
...
*TRIVIAIOX Workflows Guide v1.0 - Orchestrating AI-Human Collaboration*

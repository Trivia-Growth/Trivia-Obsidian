...
Introduction to TRIVIAIOX Squads - modular teams of AI agents that extend framework functionality.
...
Squads are modular teams of AI agents that extend TRIVIAIOX functionality for specific domains or use cases. Each squad is a self-contained package that can be installed, shared, and composed with other squads.

> **TRIVIAIOX Squads:** AI agent teams working with you
...
| Traditional Agents   | TRIVIAIOX Squads                |
| -------------------- | -------------------------- |
...
| ----------------- | ------- | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Data collection and transformation | [triviaiox-squads/etl](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Content generation utilities       | [triviaiox-squads/creator](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) |
...
│  Level 2: TRIVIAIOX-SQUADS  --> github.com/Trivia-Growth (Public)     │
...
- **Explore Official Squads:** Check [triviaiox-squads repository](https://github.com/Trivia-Growth/triviaiox-squads)
- **Contribute:** See [Contributing Squads Guide](./contributing-squads.md)
- **Learn Task Format:** Read [TASK-FORMAT-SPECIFICATION-V1](../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Task Format Specification](../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_TRIVIAIOX Squads: AI agent teams working with you_

...
> **Scope:** `.triviaiox-core/development/scripts/` (38 files)
...
| 26 | `workflow-validator.js` | Validates workflow YAML files against TRIVIAIOX conventions (9 checks) | `fs.promises`, `path`, `js-yaml` | 18 files: `validate-workflow.md`, `squad-validator.js`, tasks | @qa, @architect | No |
...
| S6 | `squad-migrator.js` | Migrates legacy squad formats to TRIVIAIOX 2.1 standard (SQS-7) | `fs.promises`, `path`, `js-yaml` | `index.js`, `squad-creator-migrate.md`, tests | @squad-creator | No |
| S7 | `squad-downloader.js` | Downloads squads from triviaiox-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to triviaiox-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The TRIVIAIOX greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.triviaiox-core/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/TRIVIAIOX/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.triviaiox-core/core-config.yaml` under `agentIdentity.greeting.preference`.
...
Used by: @dev, @qa, @architect, @pm, @po, @sm, @analyst, @triviaiox-master, @squad-creator

```yaml
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .triviaiox-core/development/scripts/greeting-builder.js
...
| @triviaiox-master | `\U0001f9e0` | Orchestrator | Leo | "TRIVIAIOX Master Orchestrator ready!" |
...
```
greeting-builder.js
  |-- context-detector.js          (.triviaiox-core/core/session/)
  |-- git-config-detector.js       (.triviaiox-core/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.triviaiox-core/infrastructure/scripts/)
  |-- PermissionMode               (.triviaiox-core/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.triviaiox-core/scripts/)
  |-- project-status-loader.js     (.triviaiox-core/infrastructure/scripts/)
...
| @triviaiox-master | greeting-builder, agent-config-loader | 2 |
...
```
C:\Users\AllFluence-User\Workspaces\TRIVIAIOX\Trivia-Growth\triviaiox-core\.triviaiox-core\development\scripts\
```

Full absolute paths for top-level scripts:
```
.triviaiox-core/development/scripts/agent-assignment-resolver.js
.triviaiox-core/development/scripts/agent-config-loader.js
.triviaiox-core/development/scripts/agent-exit-hooks.js
.triviaiox-core/development/scripts/apply-inline-greeting-all-agents.js
.triviaiox-core/development/scripts/audit-agent-config.js
.triviaiox-core/development/scripts/backlog-manager.js
.triviaiox-core/development/scripts/batch-update-agents-session-context.js
.triviaiox-core/development/scripts/decision-context.js
.triviaiox-core/development/scripts/decision-log-generator.js
.triviaiox-core/development/scripts/decision-log-indexer.js
.triviaiox-core/development/scripts/decision-recorder.js
.triviaiox-core/development/scripts/dev-context-loader.js
.triviaiox-core/development/scripts/generate-greeting.js
.triviaiox-core/development/scripts/greeting-builder.js
.triviaiox-core/development/scripts/greeting-config-cli.js
.triviaiox-core/development/scripts/greeting-preference-manager.js
.triviaiox-core/development/scripts/migrate-task-to-v2.js
.triviaiox-core/development/scripts/story-index-generator.js
.triviaiox-core/development/scripts/story-manager.js
.triviaiox-core/development/scripts/story-update-hook.js
.triviaiox-core/development/scripts/task-identifier-resolver.js
.triviaiox-core/development/scripts/test-greeting-system.js
.triviaiox-core/development/scripts/validate-task-v2.js
.triviaiox-core/development/scripts/verify-workflow-gaps.js
.triviaiox-core/development/scripts/workflow-navigator.js
.triviaiox-core/development/scripts/workflow-state-manager.js
.triviaiox-core/development/scripts/workflow-validator.js
```
...
*Cross-Reference Phase 3 Analysis - TRIVIAIOX Framework*
*Generated: 2026-02-05*

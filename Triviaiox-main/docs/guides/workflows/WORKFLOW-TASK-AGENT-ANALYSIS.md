# TRIVIAIOX Workflow / Task / Agent Cross-Reference Analysis
...
| Workflow | @triviaiox-master | @analyst | @architect | @data-eng | @dev | @devops | @pm | @po | @qa | @sm | @ux-expert | @squad-creator |
|----------|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
| 10 | `create-doc.md` | @pm, @architect, @ux-expert, @analyst, @triviaiox-master | GF, GU, GS, BU, BS, SP | `*create-prd`, `*create-*-architecture`, etc. |
| 11 | `shard-doc.md` | @po, @pm, @triviaiox-master | GF, GU, GS, BF, BU, BS | `*shard-doc` |
| 12 | `execute-checklist.md` | @po, @architect, @data-eng, @triviaiox-master | GF, GU, GS, BF, BU, BS | `*execute-checklist-po`, `*execute-checklist` |
| 13 | `document-project.md` | @architect, @analyst, @triviaiox-master | BD, BF, BU, BS | `*document-project` |
| 14 | `correct-course.md` | @pm, @sm, @triviaiox-master | (any - course correction) | `*correct-course` |
...
| 17 | `create-deep-research-prompt.md` | @analyst, @architect, @data-eng, @triviaiox-master | GF, GU, GS | `*research {topic}` |
...
| `@triviaiox-master` (Orion) | META-AGENT | Orchestrates other agents. Not a workflow participant but a workflow creator/executor. |
...
The `checklists/` directory does NOT exist at `.triviaiox-core/development/checklists/`. Multiple agents reference checklists:
- `@dev` → `story-dod-checklist.md`
- `@po` → `po-master-checklist.md`, `change-checklist.md`

**Impact:** If agents resolve checklists via the standard `dependencies → checklists → .triviaiox-core/development/checklists/{name}` path, these will fail.
...
*Analysis generated by TRIVIAIOX Cross-Reference Audit*

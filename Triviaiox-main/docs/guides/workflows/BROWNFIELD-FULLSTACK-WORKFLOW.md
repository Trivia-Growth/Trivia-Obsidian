...
| Arquivo | Proposito |
|---------|-----------|
| `.triviaiox-core/development/workflows/brownfield-fullstack.yaml` | Definicao do workflow |
...
| `.triviaiox-core/product/checklists/po-master-checklist.md` | Checklist de validacao PO |

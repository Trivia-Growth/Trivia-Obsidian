...
**Scope:** `.triviaiox-core/infrastructure/` -- scripts, integrations, tools, templates, tests
...
These scripts are imported in `.triviaiox-core/infrastructure/index.js` and exposed as the module's public API.
...
| 7 | `scripts/status-mapper.js` | PM Integration | Maps story status between TRIVIAIOX and PM tools | -- | clickup-helpers, tests/clickup, tasks | No |
...
| 9 | `scripts/template-engine.js` | Template/Generation | Template rendering engine (Handlebars-like) | `fs`, `yaml` | component-generator, template-validator, tasks, triviaiox-core index | No |
| 10 | `scripts/component-generator.js` | Template/Generation | TRIVIAIOX component generation (agents, tasks, templates) | template-engine, yaml-validator, security-checker, transaction-manager | tasks (15+ tasks), triviaiox-core index | No |
| 11 | `scripts/component-metadata.js` | Template/Generation | Metadata management for TRIVIAIOX components | `fs`, `yaml` | component-generator, transaction-manager, tasks/modify-agent | No |
| 12 | `scripts/component-search.js` | Template/Generation | Search across TRIVIAIOX components | `fs` | triviaiox-core index, tasks (analyze-framework, qa-generate-tests) | No |
| 13 | `scripts/batch-creator.js` | Template/Generation | Batch creation of TRIVIAIOX components | component-generator, dependency-analyzer, transaction-manager | triviaiox-core index, tasks/cleanup-utilities | No |
| 14 | `scripts/triviaiox-validator.js` | Validation | Validates TRIVIAIOX component structure and schema | `fs`, `yaml` | CI (ci.yml), installer tests, README, git-workflow-guide | No |
...
| 18 | `scripts/dependency-analyzer.js` | Analysis | Analyzes component dependencies | `fs` | batch-creator, modification-validator, triviaiox-core index, tasks | No |
...
| 22 | `scripts/security-checker.js` | Analysis | Security validation for components | -- | component-generator, elicitation-engine, triviaiox-master agent | No |
...
| 42 | `scripts/usage-analytics.js` | Utilities | Analytics for TRIVIAIOX feature usage | -- | tasks/analyze-framework | No |
...
| 48 | `scripts/repository-detector.js` | System | Detects repository type and structure | -- | triviaiox-init.js, agent devops, tasks | No |
...
| 53 | `scripts/yaml-validator.js` | Config | YAML file validation | -- | component-generator, modification-validator, triviaiox-master agent | No |
...
| 2 | `scripts/asset-inventory.js` | Analysis (Epic 2) | Creates comprehensive inventory of TRIVIAIOX assets | `fs`, `yaml` | agent devops, many docs, install-manifest | No |
...
| # | File | Category | Purpose | Orphan? |
|---|------|----------|---------|---------|
| 1 | `templates/gitignore/gitignore-triviaiox-base.tmpl` | Gitignore | Base TRIVIAIOX gitignore template | No |
...
| 2 | `templates/triviaiox-sync.yaml.template` | IDE Sync | TRIVIAIOX sync configuration template | No |
...
| **Validation** | 6 | TRIVIAIOX validator, template validator, output pattern, spot check, agent validator, yaml validator |
...
The infrastructure module is the **base layer** of the TRIVIAIOX modular architecture:
...
- `infrastructure/` has **NO** dependencies on other TRIVIAIOX modules
...
*Generated as part of TRIVIAIOX cross-reference analysis, Phase 4.*

...
2. **TRIVIAIOX-Core Disponivel**
   - Templates em `.triviaiox-core/development/templates/`
   - Tasks em `.triviaiox-core/development/tasks/`
   - Checklists em `.triviaiox-core/development/checklists/`
...
| Problema | Causa Provavel | Solucao |
|----------|----------------|---------|
| Templates nao encontrados | Path incorreto | Verificar `.triviaiox-core/development/templates/` |
...
| Arquivo | Caminho |
|---------|---------|
| Definicao do Workflow | `.triviaiox-core/development/workflows/greenfield-ui.yaml` |
| Knowledge Base | `.triviaiox-core/data/triviaiox-kb.md` |

### Agentes

| Agente | Caminho |
|--------|---------|
| @analyst | `.triviaiox-core/development/agents/analyst.md` |
| @pm | `.triviaiox-core/development/agents/pm.md` |
| @ux-expert | `.triviaiox-core/development/agents/ux-design-expert.md` |
| @architect | `.triviaiox-core/development/agents/architect.md` |
| @po | `.triviaiox-core/development/agents/po.md` |
| @sm | `.triviaiox-core/development/agents/sm.md` |
| @dev | `.triviaiox-core/development/agents/dev.md` |
| @qa | `.triviaiox-core/development/agents/qa.md` |

### Templates Principais

| Template | Caminho |
|----------|---------|
| Project Brief | `.triviaiox-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.triviaiox-core/development/templates/prd-tmpl.yaml` |
| Frontend Spec | `.triviaiox-core/development/templates/front-end-spec-tmpl.yaml` |
| Frontend Architecture | `.triviaiox-core/development/templates/front-end-architecture-tmpl.yaml` |
| Story | `.triviaiox-core/development/templates/story-tmpl.yaml` |

### Checklists

| Checklist | Caminho |
|-----------|---------|
| PO Master | `.triviaiox-core/development/checklists/po-master-checklist.md` |
| Story Draft | `.triviaiox-core/development/checklists/story-draft-checklist.md` |
| Story DoD | `.triviaiox-core/development/checklists/story-dod-checklist.md` |

### Documentacao Relacionada

- [TRIVIAIOX Knowledge Base](.triviaiox-core/data/triviaiox-kb.md) - Base de conhecimento central
...
*Documento gerado automaticamente a partir de `.triviaiox-core/development/workflows/greenfield-ui.yaml`*

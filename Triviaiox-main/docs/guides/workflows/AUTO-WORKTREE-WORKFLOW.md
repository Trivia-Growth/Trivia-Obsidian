...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Nao existe| ERR3[Erro: TRIVIAIOX incompleto]
...
**Estrutura Criada:**
```
.triviaiox/worktrees/{storyId}/     # Diretorio de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localizacao** | `.triviaiox-core/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versao** | 1.0 |
| **Story** | 1.3 |
...
3. Aumentar limite (se necessario) em `.triviaiox/config.yaml`
...
*Documentacao gerada automaticamente pelo TRIVIAIOX-FULLSTACK*

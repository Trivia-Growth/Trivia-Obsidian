...
2. **Ambiente Configurado**
   ...
   - Acesso aos templates TRIVIAIOX
...
4. **Templates Disponiveis**
   - `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml`
   - `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml`
   - `.triviaiox-core/development/templates/story-tmpl.yaml`

5. **Checklists Disponiveis**
   - `.triviaiox-core/development/checklists/po-master-checklist.md`
   - `.triviaiox-core/development/checklists/story-draft-checklist.md`
   - `.triviaiox-core/development/checklists/story-dod-checklist.md`
...
|---------|-----------|---------|
| Workflow Definition | Definicao YAML do workflow | `.triviaiox-core/development/workflows/brownfield-service.yaml` |
| PRD Template | Template para brownfield PRD | `.triviaiox-core/development/templates/brownfield-prd-tmpl.yaml` |
| Architecture Template | Template para arquitetura | `.triviaiox-core/development/templates/brownfield-architecture-tmpl.yaml` |
| Story Template | Template para stories | `.triviaiox-core/development/templates/story-tmpl.yaml` |
| PO Master Checklist | Checklist de validacao | `.triviaiox-core/development/checklists/po-master-checklist.md` |
| Story Draft Checklist | Checklist de story | `.triviaiox-core/development/checklists/story-draft-checklist.md` |
| Story DoD Checklist | Definition of Done | `.triviaiox-core/development/checklists/story-dod-checklist.md` |

### Agentes

| Agente | Arquivo | Caminho |
|--------|---------|---------|
| @architect | Aria | `.triviaiox-core/development/agents/architect.md` |
| @pm | Morgan | `.triviaiox-core/development/agents/pm.md` |
| @po | Pax | `.triviaiox-core/development/agents/po.md` |
| @sm | River | `.triviaiox-core/development/agents/sm.md` |
| @analyst | Atlas | `.triviaiox-core/development/agents/analyst.md` |
| @dev | Dex | `.triviaiox-core/development/agents/dev.md` |
| @qa | Quinn | `.triviaiox-core/development/agents/qa.md` |

### Documentacao Relacionada

- [TRIVIAIOX Knowledge Base](../../../.triviaiox-core/data/triviaiox-kb.md) - Base de conhecimento do framework
- [Technical Preferences](../../../.triviaiox-core/development/data/technical-preferences.md) - Preferencias tecnicas do projeto
- [IDE Development Workflow](../../../.triviaiox-core/data/triviaiox-kb.md#IDE-Development-Workflow) - Fluxo de desenvolvimento no IDE
...
*Documento gerado a partir do workflow `brownfield-service.yaml` - TRIVIAIOX Framework v2.2*

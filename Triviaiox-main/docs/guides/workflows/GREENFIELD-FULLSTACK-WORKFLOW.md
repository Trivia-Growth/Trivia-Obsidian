...
**Arquivo Fonte:** `.triviaiox-core/development/workflows/greenfield-fullstack.yaml`

---

## Visao Geral

O **Greenfield Full-Stack Workflow** e o fluxo de trabalho principal do TRIVIAIOX para construcao de aplicacoes full-stack desde o conceito ate o desenvolvimento. Este workflow suporta tanto planejamento abrangente para projetos complexos quanto prototipagem rapida para projetos simples.
...
flowchart TD
    subgraph FASE0["FASE 0: Environment Bootstrap"]
        ...
        CHECK -->|Verificar| ENV_REPORT[".triviaiox/environment-report.json existe?"]
...
|------|--------|------|---------|-------|-------------|
| 1 | @devops (Gage) | `environment-bootstrap.md` | `project_name`, `project_path`, `github_org` | `.triviaiox/config.yaml`, `.triviaiox/environment-report.json`, `.gitignore`, `README.md`, `package.json` | Sim |

### Artefatos Criados

| Arquivo | Descricao |
|---------|-----------|
| `.triviaiox/config.yaml` | Configuracao do projeto TRIVIAIOX |
| `.triviaiox/environment-report.json` | Relatorio completo do ambiente |
...
- Pular apenas se o projeto ja tiver `.triviaiox/environment-report.json`
...
| Fase | Entrada | Saida |
|------|---------|-------|
| 0 | Nome do projeto, organizacao GitHub | Config TRIVIAIOX, repo Git, estrutura de pastas |
...
|------|------------------|--------|----------|
| 0 | Ambiente pronto? | Pular / Executar bootstrap | Existencia de `.triviaiox/environment-report.json` |
...
flowchart TD
    D1{Ambiente pronto?}
    D1 -->|Verificar .triviaiox/environment-report.json| D1_CHECK
...
| Problema | Causa | Solucao |
|----------|-------|---------|
| Template nao encontrado | Caminho incorreto | Verificar `.triviaiox-core/development/templates/` |
...
```bash
# Verificar ambiente
cat .triviaiox/environment-report.json
...
|------|---------|-----------|
| Workflow | `.triviaiox-core/development/workflows/greenfield-fullstack.yaml` | Definicao do workflow |
| Task | `.triviaiox-core/development/tasks/environment-bootstrap.md` | Bootstrap do ambiente |
| Task | `.triviaiox-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| Task | `.triviaiox-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| Agente | `.triviaiox-core/development/agents/*.md` | Definicoes de agentes |
| Template | `.triviaiox-core/development/templates/*.yaml` | Templates de documentos |
| Checklist | `.triviaiox-core/development/checklists/*.md` | Checklists de validacao |
...
**Mantido por:** TRIVIAIOX Development Team

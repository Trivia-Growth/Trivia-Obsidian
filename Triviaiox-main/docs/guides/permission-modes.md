...
> Control how much autonomy TRIVIAIOX agents have over your system.

---

## Overview

Permission Modes let you control the level of autonomy TRIVIAIOX agents have. Whether you're exploring a new codebase or running fully autonomous builds, there's a mode for your workflow.
...
Mode is persisted in `.triviaiox/config.yaml`:
...
Check `.triviaiox/config.yaml` exists and is writable:

...
We take security seriously at Trivia-Growth. If you discover a security vulnerability in TRIVIAIOX, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to [Security Advisories](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
   - Click "Report a vulnerability"
   - Fill out the form with details

2. **GitHub Issues (Private)**
   - Open a [private security advisory](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
...
When using TRIVIAIOX Framework, we recommend:
...
TRIVIAIOX Framework executes AI-generated code and commands. Users should:
...
- TRIVIAIOX may process sensitive data through AI providers

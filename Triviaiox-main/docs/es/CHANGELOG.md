...
Todos los cambios notables en TriviaGrowth Triviaiox seran documentados en este archivo.
...
- **Estructura de Directorios**: Renombrado `.legacy-core/` a `.triviaiox-core/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/TRIVIAIOX/agents/`
...
- Proceso de instalacion manual (usar `npx triviaiox-core install` en su lugar)
...
- Lanzamiento publico inicial de TriviaGrowth Triviaiox
...
**Cambios clave:**
1. Directorio renombrado: `.legacy-core/` → `.triviaiox-core/`
...
- [Repositorio GitHub](https://github.com/Trivia-Growth/Triviaiox)

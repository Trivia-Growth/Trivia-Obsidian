<!--
  Traducción: ES
  Original: /docs/en/triviaiox-nomenclature-specification.md
  Última sincronización: 2026-01-26
-->

# Especificación de Nomenclatura de TRIVIAIOX

> 🌐 [EN](../triviaiox-nomenclature-specification.md) | [PT](../pt/triviaiox-nomenclature-specification.md) | **ES**
...
Este documento establece nomenclatura clara para TRIVIAIOX para diferenciar entre:
...
**Características:**
- **Alcance:** Interno a un único archivo de tarea (`.triviaiox-core/tasks/*.md`)
...
- **Ubicación:** Definido en `.triviaiox-core/workflows/*.yaml` o secciones de workflow de stories
...
**Concepto:** Inspirado por el protocolo Organizer-Worker de AsyncThink, los workflows de TRIVIAIOX pueden usar un **Agente Organizador** que coordina **Agentes Trabajadores** ejecutando tareas en paralelo.

**Aplicación a TRIVIAIOX:**
...
**Archivos de Tarea:**
- Ubicación: `.triviaiox-core/tasks/{task-name}.md`
- Contiene: Task workflow (Step-by-Step Execution)
- Ejemplo: `.triviaiox-core/tasks/security-scan.md`

**Archivos de Workflow:**
- Ubicación: `.triviaiox-core/workflows/{workflow-name}.yaml`
- Contiene: Definición de orquestación multi-tarea
- Ejemplo: `.triviaiox-core/workflows/story-development-workflow.yaml`
...
```yaml
# .triviaiox-core/workflows/story-development-workflow.yaml
workflow:
  id: story-development-workflow
  name: Story Development Flow
...
3. **Gestión de Workflows TRIVIAIOX:** Patrones de workflow existentes en TRIVIAIOX

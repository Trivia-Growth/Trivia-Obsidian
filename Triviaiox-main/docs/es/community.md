# Comunidad de TriviaGrowth Triviaiox

> 🇧🇷 [Versão em Português](COMMUNITY-PT.md)

¡Bienvenido a la comunidad de TriviaGrowth Triviaiox!
...
4. Preséntate en [Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions)

### Encuentra tu Primera Contribución

- Busca issues etiquetados como [`good-first-issue`](https://github.com/Trivia-Growth/Triviaiox/labels/good-first-issue)
- Revisa [`help-wanted`](https://github.com/Trivia-Growth/Triviaiox/labels/help-wanted) para tareas más complejas
- Explora las [Discussions abiertas](https://github.com/Trivia-Growth/Triviaiox/discussions) para ayudar a otros

## Canales de Comunicación

### GitHub Discussions (Principal)

Nuestro centro de comunicación principal para todos los repositorios TRIVIAIOX:

- **Announcements** - Actualizaciones del proyecto de los mantenedores
- **General** - Discusiones generales sobre TRIVIAIOX
- **Ideas** - Propón nuevas características y mejoras
- **Q&A** - Obtén ayuda con preguntas técnicas
- **Show and Tell** - Comparte tus proyectos usando TRIVIAIOX
- **Troubleshooting** - Obtén ayuda con problemas
- **Squads** - Discusiones sobre TRIVIAIOX Squads (equipos de agentes modulares)
- **MCP Ecosystem** - Discusiones sobre herramientas e integraciones MCP

[Únete a la Discusión](https://github.com/Trivia-Growth/Triviaiox/discussions)

### Issue Tracker

Para reportes de bugs y solicitudes de características:

- [triviaiox-core Issues](https://github.com/Trivia-Growth/Triviaiox/issues) - Framework principal
- [triviaiox-squads Issues](https://github.com/Trivia-Growth/triviaiox-squads/issues) - TRIVIAIOX Squads
- [mcp-ecosystem Issues](https://github.com/Trivia-Growth/mcp-ecosystem/issues) - Herramientas MCP
...
Cualquiera que haya contribuido a TRIVIAIOX de cualquier manera.
- Listados en nuestra [página de Contribuidores](https://github.com/Trivia-Growth/Triviaiox/graphs/contributors)
...
- [@Trivia-Growth](https://github.com/Trivia-Growth) - Líder del Proyecto
...
Todos los contribuidores son reconocidos en nuestra [página de Contribuidores](https://github.com/Trivia-Growth/Triviaiox/graphs/contributors).
...
Reporta violaciones a: conduct@Trivia-Growth.com
...
2. Busca en [Discussions existentes](https://github.com/Trivia-Growth/Triviaiox/discussions)
3. Pregunta en Q&A Discussions
4. Abre una discusión de Troubleshooting

### ¿Encontraste un bug?

1. Busca en [issues existentes](https://github.com/Trivia-Growth/Triviaiox/issues)
2. Si es nuevo, [abre un reporte de bug](https://github.com/Trivia-Growth/Triviaiox/issues/new?template=bug_report.md)

### ¿Tienes una idea?

1. Verifica si existe en [Ideas](https://github.com/Trivia-Growth/Triviaiox/discussions/categories/ideas)
2. Si es nueva, [comparte tu idea](https://github.com/Trivia-Growth/Triviaiox/discussions/new?category=ideas)
...
1. **Votando** en ideas en [Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions/categories/ideas)
...
### Aprendiendo TRIVIAIOX

- [Guía de Inicio](docs/getting-started.md)
- [Visión General de Arquitectura](docs/architecture.md)
- [Guía de Usuario](.triviaiox-core/user-guide.md)

### Recursos Externos

- [Organización de TRIVIAIOX en GitHub](https://github.com/Trivia-Growth)
...
- Versión Actual: Ver [releases](https://github.com/Trivia-Growth/Triviaiox/releases)
...
**¡Gracias por ser parte de la comunidad TRIVIAIOX!**

---

*Este documento es mantenido por la comunidad TRIVIAIOX.*

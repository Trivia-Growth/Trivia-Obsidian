...
# Guía de Instalación de TriviaGrowth Triviaiox para macOS
...
1. Los comandos se instalan en `.claude/commands/TRIVIAIOX/`
...
sudo chown -R $(whoami) .triviaiox-core
```
...
2. TriviaGrowth Triviaiox maneja automáticamente tanto sistemas de archivos sensibles como insensibles a mayúsculas

# Guía de Inicio Rápido TRIVIAIOX v4
...
## Paso 1: Instalar TRIVIAIOX Core
...
npx triviaiox-core@latest init mi-proyecto
cd mi-proyecto
```
...
```bash
npx triviaiox-core@latest doctor
```
...
TRIVIAIOX usa agentes especializados para diferentes tareas. En tu IDE con IA o Claude Code CLI, escribe:
...
Las stories dirigen el desarrollo en TRIVIAIOX. Activa el Product Owner y crea una:
...
```bash
# Instalación y setup
npx triviaiox-core@latest           # Ejecutar wizard
npx triviaiox-core@latest doctor    # Ejecutar diagnósticos
npx triviaiox-core@latest info      # Mostrar info del sistema

# Desarrollo
npm run lint                           # Verificar estilo de código
npm run typecheck                      # Verificar tipos TypeScript
npm test                               # Ejecutar pruebas unitarias
npm run validate:structure             # Validar estructura TRIVIAIOX
```
...
```
tu-proyecto/
├── .triviaiox-core/                    # Core del framework
│   ├── core/                      # Módulos core
...
│   ├── commands/TRIVIAIOX/agents/      # Skills de agentes
...
3. **Aprende sobre agentes:** [Definiciones de Agentes](../../../.triviaiox-core/development/agents/)
...
3. Verifica que el archivo del agente existe: `ls .triviaiox-core/development/agents/`
...
### Estructura TRIVIAIOX no encontrada

```bash
# Reinstalar TRIVIAIOX en el proyecto actual
...
- **Documentación:** [Repositorio GitHub](https://github.com/Trivia-Growth/Triviaiox)
- **GitHub Issues:** [github.com/Trivia-Growth/Triviaiox/issues](https://github.com/Trivia-Growth/Triviaiox/issues)
- **Comunidad Discord:** [discord.gg/gk8jAdXWmj](https://discord.gg/gk8jAdXWmj)

---

**¡Bienvenido a TRIVIAIOX! ¡Feliz coding!**

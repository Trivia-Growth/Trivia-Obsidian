...
# Guía de Instalación Windows para TriviaGrowth Triviaiox
...
2. Comandos se instalan en `.claude\commands\TRIVIAIOX\`
...
# - Hará respaldo de personalizaciones en .triviaiox-backup\

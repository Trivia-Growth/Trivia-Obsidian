# TRIVIAIOX Agent Flows - Documentacion Detallada de los Agentes

> [PT](../../triviaiox-agent-flows/README.md) | [EN](../../en/triviaiox-agent-flows/README.md) | **ES** | [ZH](../../zh/triviaiox-agent-flows/README.md)
...
Esta carpeta contiene la documentacion detallada de todos los agentes de TRIVIAIOX, incluyendo:
...
|--------|---------|-----------|-----------|
| **@triviaiox-master** | Orion | Orchestrator | [triviaiox-master-system.md](./triviaiox-master-system.md) |
...
| TRIVIAIOX Workflows | [docs/triviaiox-workflows/](../../triviaiox-workflows/) | Detalle de workflows |
...
*TRIVIAIOX Agent Flows Documentation v1.0 - Documentacion detallada del sistema de agentes*

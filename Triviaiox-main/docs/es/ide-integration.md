...
Guía para integrar TRIVIAIOX con IDEs compatibles y plataformas de desarrollo con IA.
...
TRIVIAIOX es compatible con 6 plataformas de desarrollo potenciadas por IA. Elige la que mejor se adapte a tu flujo de trabajo.
...
| IDE | Paridad de Hooks vs Claude | Qué se degrada sin hooks completos | Mitigación en TRIVIAIOX |
| --- | --- | --- | --- |
| Claude Code | Completa | Ninguno (comportamiento de referencia) | Hooks nativos + pipeline completo de TRIVIAIOX |
...
**Nivel de Recomendación:** Mejor integración con TRIVIAIOX
...
1. TRIVIAIOX crea automáticamente el directorio `.claude/` al inicializar
...
4. Usa `/skills` y selecciona `triviaiox-<agent-id>`
...
1. TRIVIAIOX crea el directorio `.cursor/` al inicializar
...
2. TRIVIAIOX crea `.github/copilot-instructions.md`
...
1. TRIVIAIOX crea el directorio `.antigravity/`
...
TRIVIAIOX mantiene una única fuente de verdad para las definiciones de agentes y las sincroniza con todos los IDEs configurados:

```
┌─────────────────────────────────────────────────────┐
│                    TRIVIAIOX Core                         │
│  .triviaiox-core/development/agents/  (Fuente de Verdad) │
│                        │                             │
│            ┌───────────┼───────────┐                │
│            ▼           ▼           ▼                │
│  .claude/     .codex/      .cursor/                  │
...
TRIVIAIOX puede configurarse para sincronizar automáticamente cuando hay cambios en los agentes:
...
ls .claude/commands/TRIVIAIOX/agents/  # Para Claude Code
```
...
├── Sí --> Claude Code (Mejor integración con TRIVIAIOX)
└── No
    └── ¿Prefieres VS Code?
...
_Guía de Integración con IDEs de TriviaGrowth Triviaiox v4.0_

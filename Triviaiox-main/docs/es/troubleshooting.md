...
# Guia de Solucion de Problemas de TriviaGrowth Triviaiox

> 🌐 [EN](../troubleshooting.md) | [PT](../pt/troubleshooting.md) | **ES**

---

Esta guia completa te ayuda a diagnosticar y resolver problemas comunes con TriviaGrowth Triviaiox.
...
2. **Recopilar informacion:**
   ...
   - Version de TRIVIAIOX: `npx triviaiox-core version`
...
- **Stack Overflow**: Etiqueta preguntas con `triviaiox-core`
...
1. Ejecutar `npx triviaiox-core init test`

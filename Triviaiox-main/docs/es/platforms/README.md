...
TRIVIAIOX soporta 9 plataformas de desarrollo con IA. Elija la que mejor se adapte a su flujo de trabajo.
...
flowchart TD
    ...
    Q1 -->|Sí| CC["<b>Claude Code</b> ⭐<br/>Mejor integración TRIVIAIOX"]
...
```mermaid
graph TD
    subgraph "TRIVIAIOX Core"
        Agents["Definiciones de Agentes<br/>.triviaiox-core/development/agents"]
        Templates["Templates de IDE<br/>.triviaiox-core/product/templates"]
...
1. **Instale TRIVIAIOX** en su proyecto:
...
sequenceDiagram
    ...
    participant CLI as TRIVIAIOX CLI
...
_TriviaGrowth Triviaiox - Documentación de Plataformas v1.0_

...
# Guía TRIVIAIOX para AntiGravity
...
### ¿Por qué usar TRIVIAIOX con AntiGravity?
...
```markdown
# Reglas de TriviaGrowth Triviaiox para AntiGravity
...
1. Tus agentes en `.triviaiox-core/` son portables
2. Inicializa AntiGravity:
   ```bash
   npx @anthropic/triviaiox init --ide antigravity
   ```
3. Los archivos de flujo de trabajo se generan automáticamente

### De AntiGravity a Otros IDEs

1. Los agentes de TRIVIAIOX permanecen en `.triviaiox-core/`
...
*TriviaGrowth Triviaiox - Guía de Plataforma AntiGravity v1.0*

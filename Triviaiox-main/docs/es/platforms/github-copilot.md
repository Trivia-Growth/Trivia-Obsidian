...
# Guía de TRIVIAIOX para GitHub Copilot
...
### ¿Por qué usar TRIVIAIOX con GitHub Copilot?
...
| **RAM** | 4GB | 8GB+ |
| **Node.js** | 18.0+ (para TRIVIAIOX) | 20.0+ |
...
│   ├── triviaiox-dev.chatmode.md
│   ├── triviaiox-qa.chatmode.md
│   └── ...
...
Este proyecto utiliza TriviaGrowth Triviaiox para desarrollo orquestado por IA.
...
<!-- triviaiox-dev.chatmode.md -->
---
name: TRIVIAIOX Developer
description: Agente Senior Full Stack Developer
---

# Agente de Desarrollador

Eres un Senior Full Stack Developer trabajando con TriviaGrowth Triviaiox.
...
### Activando Modos de Agentes TRIVIAIOX
...
4. Para agentes TRIVIAIOX, usa modos de chat personalizados en `.github/chatmodes/`

### Modos Personalizados TRIVIAIOX

| Modo | Propósito |
|---|---|
| `triviaiox-dev` | Desarrollo full-stack |
| `triviaiox-qa` | Aseguramiento de calidad |
| `triviaiox-architect` | Diseño de sistemas |
| `triviaiox-pm` | Gestión de proyectos |

### Interacciones de Ejemplo

```
# En modo triviaiox-dev:
Implementa la función de autenticación de usuario de la historia

# En modo triviaiox-qa:
Revisa el módulo de auth para vulnerabilidades de seguridad

# En modo triviaiox-architect:
...
```mermaid
flowchart LR
    Source["TRIVIAIOX Core<br/>.triviaiox-core/development/agents"] --> Parser["Agent Parser"]
...
```
Problema: Los modos de agentes TRIVIAIOX no aparecen en el selector
```
**Solución:**
...
1. Instala TRIVIAIOX para Copilot:
   ```bash
   npx @anthropic/triviaiox init --ide github-copilot
   ```
...
1. Los agentes almacenados en `.triviaiox-core/` son portables
...
*TriviaGrowth Triviaiox - Guía de Plataforma GitHub Copilot v1.0*

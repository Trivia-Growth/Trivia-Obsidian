...
La funcionalidad de Estado del Proyecto muestra automáticamente tu contexto de trabajo actual cuando cualquier agente TRIVIAIOX se activa. Esto incluye:
...
3. Crea el archivo de caché `.triviaiox/project-status.yaml`
...
1. Editar `.triviaiox-core/core-config.yaml`:
   ```yaml
   projectStatus:
     enabled: true
...
Ubicación: `.triviaiox-core/core-config.yaml`
...
projectStatus:
  ...
  statusFile: .triviaiox/project-status.yaml  # Ubicación del archivo de caché
...
1. **Verifica caché** - Busca `.triviaiox/project-status.yaml`
...
- **Ubicación del Caché:** `.triviaiox/project-status.yaml`
...
Los 11 agentes TRIVIAIOX muestran estado del proyecto:
...
3. ¿Existe `.triviaiox-core/infrastructure/scripts/project-status-loader.js`?
...
R: Sí, todos los agentes usan el mismo archivo de caché (`.triviaiox/project-status.yaml`).
...
- **Config:** `.triviaiox-core/core-config.yaml` (sección projectStatus)
- **Script:** `.triviaiox-core/infrastructure/scripts/project-status-loader.js`
- **Init Task:** `.triviaiox-core/tasks/init-project-status.md`
- **Tests:** `.triviaiox-core/infrastructure/scripts/__tests__/project-status-loader.test.js`

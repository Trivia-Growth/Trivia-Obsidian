...
# Guia de Usuario TRIVIAIOX

> **ES** | [EN](../../guides/user-guide.md)

---

Guia completa para usar TriviaGrowth Triviaiox - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
Antes de usar TRIVIAIOX, asegurate de tener:
...
TRIVIAIOX proporciona estructura orquestada mientras permite flexibilidad en la comunicacion. Esto significa:
...
### La Diferencia TRIVIAIOX

| Desarrollo IA Tradicional       | TRIVIAIOX                                       |
| ------------------------------- | ------------------------------------------ |
...
TRIVIAIOX incluye 11 agentes especializados, cada uno con un rol y personalidad distintos:
...
| **Pax**   | `@triviaiox-master`   | Orquestador  | Orquestacion del framework |
...
@triviaiox-master        # Activar Pax (Orquestador)
...
Las Tasks son el punto de entrada principal en TRIVIAIOX. Todo es una task.
...
| `brownfield-integration` | Agregar TRIVIAIOX a existente       | dev, architect       |
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de TRIVIAIOX.
...
```
my-project/
├── .triviaiox-core/                # Configuracion del framework
...
La configuracion principal esta en `.triviaiox-core/core/config/`:
...
TRIVIAIOX soporta multiples IDEs. La configuracion se sincroniza a traves de:
...
TRIVIAIOX implementa quality gates de 3 capas:
...
_Guia de Usuario TriviaGrowth Triviaiox v4.0_

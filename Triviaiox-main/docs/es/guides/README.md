...
Índice completo de documentación para las guías del sistema TRIVIAIOX.
...
> **Nota:** La documentación de 1MCP ha sido descontinuada. TRIVIAIOX ahora usa Docker MCP Toolkit exclusivamente (Story 5.11). Los documentos archivados están disponibles en `.github/deprecated-docs/guides/`.

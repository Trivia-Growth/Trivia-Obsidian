...
**Opcion 1: Si tienes triviaiox-core clonado**
```bash
# Desde el directorio triviaiox-core
...
**Windows:** `.triviaiox-core/infrastructure/scripts/llm-routing/templates/claude-free.cmd`
**Unix:** `.triviaiox-core/infrastructure/scripts/llm-routing/templates/claude-free.sh`
...
- **Definicion de Herramienta:** `.triviaiox-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalacion:** `.triviaiox-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definicion de Tarea:** `.triviaiox-core/development/tasks/setup-llm-routing.md`
...
*Generado por TRIVIAIOX Framework - Story 6.7*

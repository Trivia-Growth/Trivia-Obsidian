...
Guia completa para desarrolladores que quieren contribuir al proyecto TriviaGrowth Triviaiox.
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes TRIVIAIOX |
| **VS Code / Cursor** | IDE con integracion TRIVIAIOX                    |
...
1. Navega a [github.com/Trivia-Growth/Triviaiox](https://github.com/Trivia-Growth/Triviaiox)
...
```bash
# Clonar tu fork
git clone https://github.com/YOUR_USERNAME/triviaiox-core.git
cd triviaiox-core

# Agregar remote upstream
git remote add upstream https://github.com/Trivia-Growth/Triviaiox.git

# Verificar remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/triviaiox-core.git (fetch)
# origin    https://github.com/YOUR_USERNAME/triviaiox-core.git (push)
# upstream  https://github.com/Trivia-Growth/Triviaiox.git (fetch)
# upstream  https://github.com/Trivia-Growth/Triviaiox.git (push)
```
...
TRIVIAGROWTH_API_TOKEN=your-triviagrowth-token
```
...
Sincroniza los agentes TRIVIAIOX con tu IDE:
...
Entendiendo la estructura de directorios de `triviaiox-core`:

```
triviaiox-core/
├── .triviaiox-core/                    # Fuente del framework (committed)
...
│   ├── commands/TRIVIAIOX/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.triviaiox-core/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.triviaiox-core/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.triviaiox-core/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.triviaiox-core/development/agents/`:

```bash
# Archivo: .triviaiox-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .triviaiox-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .triviaiox-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.triviaiox-core/development/tasks/`:
...
# Ejemplos:
# .triviaiox-core/development/tasks/dev-build-component.md  (agente dev)
# .triviaiox-core/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (TRIVIAIOX Task Format V1.0)
...
Crea un nuevo archivo en `.triviaiox-core/development/workflows/`:

```bash
# Archivo: .triviaiox-core/development/workflows/my-workflow.yaml
```
...
npx js-yaml .triviaiox-core/development/agents/my-agent.md

# Verificar que existan dependencias
ls .triviaiox-core/development/tasks/my-task.md
```
...
TRIVIAIOX_DEBUG=true npm run trace -- workflow-name

# Verificar estado de workflow
cat .triviaiox/state/workflow-state.json
```
...
- **GitHub Discussions:** [github.com/Trivia-Growth/Triviaiox/discussions](https://github.com/Trivia-Growth/Triviaiox/discussions)
- **Issue Tracker:** [github.com/Trivia-Growth/Triviaiox/issues](https://github.com/Trivia-Growth/Triviaiox/issues)
...
- Etiquetar `@Trivia-Growth/core-team` para issues urgentes
...
_TriviaGrowth Triviaiox Guia de Configuracion para Desarrollo v1.0.0_

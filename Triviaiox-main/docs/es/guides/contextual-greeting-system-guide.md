...
El Sistema de Saludo Contextual es una mejora de UX que hace que los saludos de los agentes TRIVIAIOX sean inteligentes y adaptativos, mostrando información y comandos relevantes basados en el contexto de la sesión.

## Lo Que Se Ha Implementado

### Componentes Core (Story 6.1.2.5)

1. **ContextDetector** (`.triviaiox-core/core/session/context-detector.js`)
...
2. **GitConfigDetector** (`.triviaiox-core/infrastructure/scripts/git-config-detector.js`)
   - Detecta configuración de git del proyecto
   - Caché con TTL de 5 minutos
   - Protección de timeout de 1000ms

3. **GreetingBuilder** (`.triviaiox-core/development/scripts/greeting-builder.js`)
...
4. **WorkflowNavigator** (`.triviaiox-core/development/scripts/workflow-navigator.js`)
...
5. **Workflow Patterns** (`.triviaiox-core/data/workflow-patterns.yaml`)
...
### Scripts Core
- `.triviaiox-core/core/session/context-detector.js` - Detección de tipo de sesión
- `.triviaiox-core/infrastructure/scripts/git-config-detector.js` - Detección de git config
- `.triviaiox-core/development/scripts/greeting-builder.js` - Construcción del saludo
- `.triviaiox-core/development/scripts/workflow-navigator.js` - Navegación de workflow
- `.triviaiox-core/development/scripts/agent-exit-hooks.js` - Hooks de salida (para persistencia)

### Archivos de Datos
- `.triviaiox-core/data/workflow-patterns.yaml` - Definiciones de workflows
...
### Configuración
- `.triviaiox-core/core-config.yaml` - Configuración global (secciones git + agentIdentity)

### Agentes (Actualizados)
- `.triviaiox-core/agents/dev.md` - Metadatos de visibilidad de comandos
- `.triviaiox-core/agents/po.md` - Metadatos de visibilidad de comandos
- `.triviaiox-core/agents/*.md` - 9 agentes restantes (actualización pendiente)
...
R: Usa el script de prueba: `node .triviaiox-core/development/scripts/test-greeting-system.js`

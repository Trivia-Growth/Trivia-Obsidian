# Guia de Testing de TriviaGrowth Triviaiox

> [EN](../../guides/testing-guide.md) | [PT](../../pt/guides/testing-guide.md) | **ES**

---

> Guia completa de la estrategia de testing, herramientas y mejores practicas para TriviaGrowth Triviaiox.
...
TRIVIAIOX sigue una estrategia de testing integral que asegura la calidad del codigo en todas las capas del framework. Nuestra filosofia de testing esta construida sobre:
...
module.exports = {
  ...
  testMatch: [
    '**/tests/**/*.test.js',
    '**/tests/**/*.spec.js',
    '**/.triviaiox-core/**/__tests__/**/*.test.js',
  ],
...
const {
  QualityGateManager,
} = require('../../../.triviaiox-core/core/quality-gates/quality-gate-manager');
...
process.env.TRIVIAIOX_DEBUG = 'false';
 ...
 * Tests de Compatibilidad Retroactiva de Agentes
 *
 * Asegura que agentes de versiones anteriores de TRIVIAIOX continuen funcionando.
 */

const { loadAgent } = require('../../.triviaiox-core/core/registry/agent-loader');
...
TRIVIAIOX soporta Windows, macOS y Linux. El testing cross-platform asegura comportamiento consistente.
...
function getTempDir() {
  return path.join(os.tmpdir(), 'triviaiox-tests');
}
...
module.exports = {
  collectCoverageFrom: [
    ...
    '!.triviaiox-core/core/health-check/checks/**',
    '!.triviaiox-core/core/config/**',
    '!.triviaiox-core/core/manifest/**',
    '!.triviaiox-core/core/registry/**',
    '!.triviaiox-core/core/utils/**',
  ],
...
│   └── .triviaiox-core/       # Cobertura por modulo
...
El Sistema de Quality Gate de TRIVIAIOX (ver [Guia de Quality Gates](./quality-gates.md)) integra testing en multiples capas:
...
jest.mock('../../.triviaiox-core/integrations/clickup-client');
const clickupClient = require('../../.triviaiox-core/integrations/clickup-client');
...
_Guia de Testing de TriviaGrowth Triviaiox v4_

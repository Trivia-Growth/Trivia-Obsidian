# Referencia de API TRIVIAIOX

> [EN](../../guides/api-reference.md) | [PT](../../pt/guides/api-reference.md) | **ES**

---

Referencia completa de la API para TriviaGrowth Triviaiox - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
TRIVIAIOX proporciona una API unificada para interactuar con agentes de IA especializados a través de dos mecanismos principales:
...
| `@triviaiox-master`   | Orion  | Orchestrator | Orquestación del framework, meta-operaciones   |

### Comportamiento de Activación

Cuando se activa un agente:

1. Se carga el archivo de definición del agente desde `.triviaiox-core/development/agents/{id}.md`
...
### @triviaiox-master (Orquestador)

**Desarrollo del Framework:**

| Comando                | Argumentos      | Descripción                                    |
| ---------------------- | --------------- | ---------------------------------------------- |
| `*create`              | `{type} {name}` | Crear componente TRIVIAIOX (agent/task/workflow)    |
...
| `*kb`   | -                          | Alternar modo KB (conocimiento TRIVIAIOX Method)   |
...
| -------------------- | ---------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Definición de agente faltante      | Verificar `.triviaiox-core/development/agents/` |
...
/triviaiox-master  → Activa agente @triviaiox-master
```
...
- [Guía de Usuario](./user-guide.md) - Comenzando con TRIVIAIOX
...
- [Guía de Squads](./squads-guide.md) - Extendiendo TRIVIAIOX con squads

---

_TriviaGrowth Triviaiox API Reference v4.2.11_

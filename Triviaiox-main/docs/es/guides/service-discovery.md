...
# Guía de Descubrimiento de Servicios de TRIVIAIOX

> 🌐 [EN](../../guides/service-discovery.md) | [PT](../../pt/guides/service-discovery.md) | **ES**

---

> Cómo descubrir, consultar y usar workers en el framework TRIVIAIOX.
...
El sistema de Descubrimiento de Servicios permite encontrar y usar workers (tareas, plantillas, scripts, workflows) en todo el framework TRIVIAIOX. El **Registro de Servicios** es el catálogo central que contiene metadatos sobre todos los workers disponibles.
...
```bash
# Buscar por texto
triviaiox discover "create story"

# Buscar por categoría
triviaiox discover --category task

# Buscar por etiqueta
triviaiox discover --tag testing

# Buscar para agente
triviaiox discover --agent dev

# Combinar filtros
triviaiox discover --category task --tag development --agent dev
```
...
Encontrados 5 workers que coinciden con "create story":
  ...
  [task] po-create-story
         Ruta: .triviaiox-core/development/tasks/po-create-story.md
         Etiquetas: task, creation, story, product
         Agentes: po

  [task] dev-create-brownfield-story
         Ruta: .triviaiox-core/development/tasks/dev-create-brownfield-story.md
...
triviaiox info create-story

# Obtener info del worker con ruta completa
triviaiox info --path .triviaiox-core/development/tasks/po-create-story.md
```
...
triviaiox list tasks

# Listar todas las plantillas
triviaiox list templates

# Listar workers para agente
triviaiox list --agent dev

# Listar con paginación
triviaiox list tasks --page 1 --limit 20
```
...
**Ubicación:** `.triviaiox-core/development/tasks/`
...
**Ubicación:** `.triviaiox-core/product/templates/`
...
**Ubicación:** `.triviaiox-core/development/workflows/`
...
**Ubicación:** `.triviaiox-core/product/checklists/`
...
- `.triviaiox-core/infrastructure/scripts/**/*.js`
- `.triviaiox-core/product/checklists/**/*.md`
- `.triviaiox-core/development/workflows/**/*.yaml`
- `.triviaiox-core/core/data/**/*`
...
```javascript
const { getRegistry } = require('./.triviaiox-core/core/registry/registry-loader');
...
```javascript
const { getRegistry } = require('./.triviaiox-core/core/registry/registry-loader');
const { TaskExecutor } = require('./.triviaiox-core/development/scripts/task-executor');
...
ls .triviaiox-core/core/registry/service-registry.json
...
_Guía de Descubrimiento de Servicios de TriviaGrowth Triviaiox v4_

...
Como contribuir squads al ecosistema TRIVIAIOX.

## Descripcion General

Hay dos formas de compartir tu squad con la comunidad:

1. **Repositorio triviaiox-squads** - Squads gratuitos y de codigo abierto en GitHub
2. **Marketplace de TriviaGrowth** - Squads premium via API de TriviaGrowth
...
| **Compatibilidad TRIVIAIOX** | `triviaiox.minVersion: "2.1.0"` o superior |
...
## Publicando en triviaiox-squads
...
Esto:
1. Hara fork de `Trivia-Growth/triviaiox-squads` (si es necesario)
...
## Publicando en el Marketplace de TriviaGrowth

### Prerequisitos

1. Cuenta de TriviaGrowth
...
*publish-squad ./squads/my-squad
# o
*sync-squad-triviagrowth ./squads/my-squad
```
...
- Seguir convenciones de TRIVIAIOX
...
- **Preguntas**: [Discusiones de GitHub](https://github.com/Trivia-Growth/Triviaiox/discussions)
- **Issues**: [Rastreador de Issues](https://github.com/Trivia-Growth/Triviaiox/issues)

...
# Guía de Instalación y Solución de Problemas de TRIVIAIOX-Core
...
Este comando descarga y ejecuta la última versión del instalador de TRIVIAIOX-Core.
...
```bash
npx github:Trivia-Growth/Triviaiox install
```
...
### Windows (CMD)
```cmd
curl -o diagnose.cmd https://raw.githubusercontent.com/Trivia-Growth/Triviaiox/main/tools/quick-diagnose.cmd && diagnose.cmd
```

### Windows (PowerShell)
```powershell
irm https://raw.githubusercontent.com/Trivia-Growth/Triviaiox/main/tools/quick-diagnose.ps1 | iex
```

### macOS/Linux
```bash
curl -fsSL https://raw.githubusercontent.com/Trivia-Growth/Triviaiox/main/tools/diagnose-installation.js | node
```
...
npx --ignore-existing triviaiox-core@latest
...
npm view triviaiox-core version
...
1. **GitHub Issues**: https://github.com/Trivia-Growth/Triviaiox/issues
2. **Ejecutar diagnósticos**: `npx triviaiox-core@latest doctor`
3. **Verificar información del sistema**: `npx triviaiox-core@latest info`
...
| Comando | Descripción |
|---------|-------------|
| `npx triviaiox-core@latest` | Instalar/ejecutar asistente |
| `npx triviaiox-core@latest --version` | Mostrar versión |
| `npx triviaiox-core@latest --help` | Mostrar ayuda |
| `npx triviaiox-core@latest install` | Instalar en directorio actual |
| `npx triviaiox-core@latest init <name>` | Crear nuevo proyecto |
| `npx triviaiox-core@latest doctor` | Ejecutar diagnósticos |
| `npx triviaiox-core@latest info` | Mostrar información del sistema |

---

*Última actualización: Diciembre 2025 | TRIVIAIOX-Core v2.2.0*

...
Guia completa para crear, validar, publicar y gestionar Squads en TRIVIAIOX.

> **TRIVIAIOX Squads:** Equipos de agentes de IA trabajando contigo
...
Los Squads son equipos modulares de agentes de IA que extienden la funcionalidad de TRIVIAIOX. Cada squad es un paquete autocontenido que incluye:
...
│  Nivel 2: TRIVIAIOX-SQUADS  → github.com/Trivia-Growth (Publico/Gratis)│
│  Nivel 3: TRIVIAGROWTH API   → api.triviagrowth.dev      (Marketplace)   │
└─────────────────────────────────────────────────────────────┘
```
...
| -------------------------------------------------------------------------- | ------- | ------------------------------------- |
| [etl-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl)         | 2.0.0   | Recoleccion y transformacion de datos |
| [creator-squad](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) | 1.0.0   | Utilidades de generacion de contenido |
...
- Node.js 18+
- Proyecto TRIVIAIOX inicializado (`.triviaiox-core/` existe)
...
Las tareas deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamiento                                     |
| ---------- | -------------------------------------------------- |
| `extend`   | Agregar reglas del squad a las reglas base de TRIVIAIOX |
...
```javascript
const { SquadAnalyzer } = require('./.triviaiox-core/development/scripts/squad/squad-analyzer');
const { SquadExtender } = require('./.triviaiox-core/development/scripts/squad/squad-extender');
...
### Nivel 2: Repositorio triviaiox-squads (Publico)
...
Esto crea un PR a [Trivia-Growth/triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads).

### Nivel 3: Marketplace de TriviaGrowth

```bash
# Configurar autenticacion
export TRIVIAGROWTH_API_TOKEN="your-token"

# Sincronizar al marketplace
*sync-squad-triviagrowth ./squads/my-squad --public
```
...
- Campo `triviaiox.type`
- Campo `triviaiox.minVersion`
...
3. **Agregar Campos** - `triviaiox.type`, `triviaiox.minVersion`
...
```
1. Local     → ./squads/{name}/
2. npm       → node_modules/@triviaiox-squads/{name}/
3. Workspace → ../{name}/ (monorepo)
4. Registry  → api.triviagrowth.dev/squads/{name}
```
...
# - triviaiox.type: debe ser "squad"
# - triviaiox.minVersion: debe ser semver valido
```
...
### Cual es la diferencia entre un Squad y formatos legados de squad en TRIVIAIOX?

**Squads** son el formato estandar en TRIVIAIOX 2.1+ con:
...
3. Re-publicar: `*publish-squad` o `*sync-squad-triviagrowth`
...
- **Nivel 3**: Sincronizar con bandera `--private`: `*sync-squad-triviagrowth my-squad --private`

### Cual es la version minima de TRIVIAIOX para Squads?

Los Squads requieren TRIVIAIOX 2.1.0+. Configurar en el manifiesto:
...
- [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Agente @squad-creator](../../../.triviaiox-core/development/agents/squad-creator.md)
- [Repositorio triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads)

---

## Obteniendo Ayuda

- [Discusiones de GitHub](https://github.com/Trivia-Growth/Triviaiox/discussions)
- [Rastreador de Issues](https://github.com/Trivia-Growth/Triviaiox/issues)

---

_TRIVIAIOX Squads: Equipos de agentes de IA trabajando contigo_

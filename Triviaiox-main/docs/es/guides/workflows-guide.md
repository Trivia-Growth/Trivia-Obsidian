# Guia de Workflows de TRIVIAIOX
...
Los Workflows de TRIVIAIOX son secuencias orquestadas de actividades de agents que automatizan procesos de desarrollo complejos. Proporcionan patrones estructurados y repetibles para escenarios de desarrollo comunes.
...
El state se persiste en `.triviaiox/{instance-id}-state.yaml`:
...
TRIVIAIOX detecta patrones comunes de workflow basados en el historial de comandos:
...
| **Ubicacion** | `.triviaiox-core/development/workflows/` | `.triviaiox-core/development/tasks/` |
...
*Guia de Workflows de TRIVIAIOX v1.0 - Orquestando la Colaboracion IA-Humano*

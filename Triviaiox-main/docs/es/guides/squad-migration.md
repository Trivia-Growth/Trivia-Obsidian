...
Como migrar squads legacy al formato TRIVIAIOX 2.1.

## Descripcion General

TRIVIAIOX 2.1 introdujo un nuevo formato de squad con:
...
| Campo de tipo TRIVIAIOX    | Faltante      | `triviaiox.type: squad`         |
| Version minima        | Faltante      | `triviaiox.minVersion: "2.1.0"` |
...
- Agrega campos `triviaiox` faltantes al manifiesto
...
- [ ] `triviaiox.type` es `"squad"`
- [ ] `triviaiox.minVersion` es `"2.1.0"` o superior

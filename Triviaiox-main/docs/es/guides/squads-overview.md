...
Introduccion a TRIVIAIOX Squads - equipos modulares de agentes IA que extienden la funcionalidad del framework.
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de TRIVIAIOX para dominios o casos de uso especificos. Cada squad es un paquete autocontenido que puede ser instalado, compartido y compuesto con otros squads.

> **TRIVIAIOX Squads:** Equipos de agentes IA trabajando contigo
...
| Agentes Tradicionales      | TRIVIAIOX Squads                    |
| -------------------------- | ------------------------------ |
...
| ----------------- | ------- | ------------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Recoleccion y transformacion de datos | [triviaiox-squads/etl](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Utilidades de generacion de contenido | [triviaiox-squads/creator](https://github.com/Trivia-Growth/triviaiox-squads/tree/main/creator) |
...
│  Nivel 2: TRIVIAIOX-SQUADS  --> github.com/Trivia-Growth (Publico)    │
...
Las tasks deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).

### 2. Usar Herencia de Config Sabiamente

| Modo       | Comportamiento                              |
| ---------- | ------------------------------------------- |
| `extend`   | Agregar reglas del squad a reglas core TRIVIAIOX |
...
- **Explorar Squads Oficiales:** Revisar [repositorio triviaiox-squads](https://github.com/Trivia-Growth/triviaiox-squads)
- **Contribuir:** Ver [Guia de Contribucion de Squads](./contributing-squads.md)
- **Aprender Formato de Tasks:** Leer [TASK-FORMAT-SPECIFICATION-V1](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificacion de Formato de Tasks](../../../.triviaiox-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_TRIVIAIOX Squads: Equipos de agentes IA trabajando contigo_

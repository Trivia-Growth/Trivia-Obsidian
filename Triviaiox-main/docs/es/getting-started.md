...
# Primeros Pasos con TriviaGrowth Triviaiox

> 🌐 [EN](../getting-started.md) | [PT](../pt/getting-started.md) | **ES**

---

Bienvenido a TriviaGrowth Triviaiox! Esta guia te llevara a traves de tus primeros pasos con el framework de desarrollo auto-modificable impulsado por IA.
...
Antes de instalar TriviaGrowth Triviaiox, asegurate de tener:
...
TriviaGrowth Triviaiox ofrece opciones de instalacion flexibles:
...
```
my-first-project/
├── .triviaiox/                    # Configuracion del framework
...
El archivo de configuracion principal (`.triviaiox/config.json`) contiene:
...
El meta-agente es el nucleo de TriviaGrowth Triviaiox - una IA que entiende y puede modificar su propia base de codigo.
...
- **[Tutoriales en Video](https://triviaiox-core.dev/tutorials)**: Aprendizaje visual
...
- **Twitter**: Sigue [@triviaioxfullstack](https://twitter.com/triviaioxfullstack)
...
Recuerda: TriviaGrowth Triviaiox aprende y mejora con el uso. Cuanto mas interactues con el, mejor entendera tu estilo de desarrollo y necesidades.

Feliz programacion con TriviaGrowth Triviaiox!

...
Tomamos la seguridad en serio en Trivia-Growth. Si descubres una vulnerabilidad de seguridad en TRIVIAIOX, por favor repórtala de manera responsable.
...
1. **GitHub Security Advisories** (Preferido)
   - Ve a [Security Advisories](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
   - Haz clic en "Report a vulnerability"
   - Completa el formulario con los detalles

2. **GitHub Issues (Privado)**
   - Abre un [security advisory privado](https://github.com/Trivia-Growth/Triviaiox/security/advisories)
...
Al usar TRIVIAIOX Framework, recomendamos:
...
TRIVIAIOX Framework ejecuta código y comandos generados por AI. Los usuarios deben:
...
- TRIVIAIOX puede procesar datos sensibles a través de proveedores de AI

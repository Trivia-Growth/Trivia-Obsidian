...
# Guía de Flujo de Trabajo Git de TRIVIAIOX
...
TriviaGrowth Triviaiox implementa una estrategia de validación de **Defensa en Profundidad** con tres capas progresivas que detectan problemas tempranamente y aseguran la calidad del código antes del merge.
...
```bash
# Validación manual
node .triviaiox-core/utils/triviaiox-validator.js pre-push
node .triviaiox-core/utils/triviaiox-validator.js stories

# Validar una sola story
node .triviaiox-core/utils/triviaiox-validator.js story docs/stories/1.1-story.yaml
...
**Ubicación:** `.triviaiox-core/utils/triviaiox-validator.js`
...
- name: Validate story checkboxes
  run: node .triviaiox-core/utils/triviaiox-validator.js stories
```
...
# Verificar corrección
node .triviaiox-core/utils/triviaiox-validator.js story docs/stories/X.X-story.yaml
...
```javascript
// .triviaiox-core/utils/custom-validator.js
...
```bash
# .husky/pre-commit
node .triviaiox-core/utils/triviaiox-validator.js pre-commit
node .triviaiox-core/utils/custom-validator.js
```
...
- name: Custom validation
  run: node .triviaiox-core/utils/custom-validator.js
```
...
- **TRIVIAIOX Validator:** [.triviaiox-core/utils/triviaiox-validator.js](../../.triviaiox-core/utils/triviaiox-validator.js)
...
- [Abrir un Issue](https://github.com/Trivia-Growth/Triviaiox/issues)

...
Guía para configurar servidores MCP (Model Context Protocol) basados en Docker con TRIVIAIOX.
...
- Proyecto **TRIVIAIOX** inicializado
...
- `~/.triviaiox/mcp/servers/` - Configuraciones de servidores individuales
...
TRIVIAIOX usa Docker MCP Toolkit como infraestructura MCP principal:
...
- [Agente DevOps](../.triviaiox-core/development/agents/devops.md)

---

_Guía de Configuración de Docker MCP de TriviaGrowth Triviaiox v4.0_

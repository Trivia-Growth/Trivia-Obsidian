...
# Documentación del Framework TRIVIAIOX
...
**Objetivo de Migración:** Q2 2026 → repositorio `Trivia-Growth/Triviaiox`

---

## Descripción General

Este directorio contiene la **documentación oficial del framework TRIVIAIOX** que define estándares, patrones y estructuras aplicables a todos los proyectos TRIVIAIOX (greenfield y brownfield).
...
**IMPORTANTE**: Estos documentos ahora están en el repositorio `Trivia-Growth/Triviaiox`. La migración desde la antigua organización `triviaiox/triviaiox-core` se completó en diciembre de 2024 como parte del OSR-9 (Rebranding).

### Cronograma de Migración

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Documentación del framework separada en `docs/framework/`
- **Fase 2 (Q4 2024):** Repositorio migrado a `Trivia-Growth/Triviaiox` (OSR-9)
...
- **Alcance**: Portable a través de todos los proyectos TRIVIAIOX
- **Ejemplos**: Estándares de codificación, stack tecnológico, estructura del árbol de código fuente
- **Ciclo de vida**: Reside en el repositorio `Trivia-Growth/Triviaiox`
...
1. **Lea la documentación del framework durante la incorporación** - Comprenda los estándares de TRIVIAIOX
...
### Para Mantenedores del Framework TRIVIAIOX
...
**Mantenedor**: Equipo del Framework TRIVIAIOX

...
# Estructura del Árbol de Código Fuente TRIVIAIOX
...
**Repositorio:** Trivia-Growth/Triviaiox
...
- [Core del Framework (.triviaiox-core/)](#core-del-framework-triviaiox-core)
...
TRIVIAIOX utiliza una **arquitectura modular** con clara separación de responsabilidades:

1. **Core del Framework** (`.triviaiox-core/`) - Componentes portables del framework organizados por dominio
...
```
triviaiox-core/                             # Proyecto raíz
├── .triviaiox-core/                        # Core del framework (modular)
...
│
├── bin/                               # Ejecutables CLI
│   └── triviaiox.js                        # Punto de entrada principal CLI
│
...
## Core del Framework (.triviaiox-core/)
...
│   └── triviaiox-kb.md                     # Base de conocimiento TRIVIAIOX
│
├── development/                       # Assets de Desarrollo
│   ├── agents/                        # Definiciones de agentes (11 agentes core)
│   │   ├── triviaiox-master.md             # Orquestador maestro
...
│   ├── triviaiox migration/                # Stories de migración TRIVIAIOX
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a TRIVIAIOX. A diferencia de los Squads deprecados, los Squads siguen una estructura de template estandarizada.
...
```
triviaiox-core/
├── .triviaiox-core/                        # Assets del framework (modular v2.0)
│   ├── cli/                           # Comandos CLI y utilidades
│   ├── core/                          # Esenciales del framework
│   │   ├── config/                    # Sistema de configuración
...
```
squads/
├── verified/                          # Squads curados por TRIVIAIOX
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
### REPO 4: Trivia-Growth/certified-partners (Privado)
...
### REPO 5: Trivia-Growth/mmos (Privado + NDA)
...
Ubicación: .triviaiox-core/development/agents/{agent-name}.md
Ejemplo: .triviaiox-core/development/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicación: .triviaiox-core/development/tasks/{task-name}.md
Ejemplo: .triviaiox-core/development/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicación: .triviaiox-core/development/workflows/{workflow-name}.yaml
Ejemplo: .triviaiox-core/development/workflows/continuous-deployment.yaml

# Estoy creando un nuevo template:
Ubicación: .triviaiox-core/product/templates/{template-name}-tmpl.{yaml|md}
Ejemplo: .triviaiox-core/product/templates/deployment-plan-tmpl.yaml

# Estoy creando un nuevo checklist:
Ubicación: .triviaiox-core/product/checklists/{checklist-name}-checklist.md
Ejemplo: .triviaiox-core/product/checklists/security-review-checklist.md

# Estoy creando un comando CLI:
Ubicación: .triviaiox-core/cli/commands/{category}/{command-name}.js
Ejemplo: .triviaiox-core/cli/commands/generate/workflow.js

# Estoy creando una utilidad core:
Ubicación: .triviaiox-core/core/utils/{utility-name}.js
Ejemplo: .triviaiox-core/core/utils/performance-monitor.js

# Estoy creando un script de infraestructura:
Ubicación: .triviaiox-core/infrastructure/scripts/{category}/{script-name}.js
Ejemplo: .triviaiox-core/infrastructure/scripts/llm-routing/router.js

# Estoy agregando un adaptador de herramienta PM:
Ubicación: .triviaiox-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Ejemplo: .triviaiox-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
| 1.1     | 2025-12-14 | Actualizada org a Trivia-Growth, reemplazado Squads con sistema de Squads [Story 6.10]                                          | Dex (dev)        |
...
_Este es un estándar oficial del framework TRIVIAIOX. Toda colocación de archivos debe seguir esta estructura._

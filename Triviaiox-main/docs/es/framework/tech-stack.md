...
# Stack Tecnológico de TRIVIAIOX
...
**Aviso de Migración:** Este documento migrará al repositorio `Trivia-Growth/Triviaiox` en Q2 2026 (ver Decision 005)
...
TRIVIAIOX está construido sobre JavaScript/TypeScript moderno con runtime Node.js, optimizado para desarrollo CLI multiplataforma con UX interactiva y capacidades de orquestación de agentes.
...
| 1.1     | 2025-12-14 | Actualizado aviso de migración a Trivia-Growth/Triviaiox, semantic-release a v25.0.2 [Story 6.10] | Dex (dev)        |

---

_Este es un estándar oficial del framework TRIVIAIOX. Todas las elecciones tecnológicas deben alinearse con este stack._

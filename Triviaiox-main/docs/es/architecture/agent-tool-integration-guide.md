...
Esta guía explica cómo se integran las herramientas con los agentes TRIVIAIOX. Las herramientas amplían las capacidades de los agentes proporcionando acceso a servicios externos, APIs y recursos del sistema.
...
| `tasks`      | Archivos de flujo de trabajo          | `.triviaiox-core/development/tasks/`  |
| `checklists` | Listas de validación                  | `.triviaiox-core/product/checklists/` |

### Ejemplo de Declaración

```yaml
# De .triviaiox-core/development/agents/dev.md
dependencies:
  checklists:
...
TRIVIAIOX implementa gobernanza estricta de operaciones de git:
...
- [Definiciones de Agentes](../../../.triviaiox-core/development/agents/)

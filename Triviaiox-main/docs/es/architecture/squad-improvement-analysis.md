...
| **Icono** | 🏗️ |
| **Archivo** | `.triviaiox-core/development/agents/squad-creator.md` |
...
| `*publish-squad` | squad-creator-publish.md | ⏳ Placeholder | Publicar a triviaiox-squads |
| `*sync-squad-triviagrowth` | squad-creator-sync-triviagrowth.md | ⏳ Placeholder | Sincronizar al marketplace |
...
| SquadPublisher | squad-publisher.js | Publicar a triviaiox-squads |

...
**Fuente:** `gh api repos/Trivia-Growth/Triviaiox/branches/main/protection`
...
**Fuente:** `gh api repos/Trivia-Growth/Triviaiox`
...
**Fuente:** `gh api repos/Trivia-Growth/Triviaiox/actions/workflows`
...
1. Crear `.coderabbit.yaml` con reglas especificas de TRIVIAIOX
...
- `.triviaiox/audit/branch-protection.json`
- `.triviaiox/audit/repo-settings.json`

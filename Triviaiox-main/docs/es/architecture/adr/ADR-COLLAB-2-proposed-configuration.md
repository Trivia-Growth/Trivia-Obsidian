...
Siguiendo la [Auditoria de Estado Actual](./ADR-COLLAB-1-current-state-audit.md), este documento propone cambios de configuracion especificos para habilitar contribuciones externas seguras a TRIVIAIOX.
...
```bash
gh api repos/Trivia-Growth/Triviaiox/branches/main/protection -X PUT \
...
# Configuracion CodeRabbit para TRIVIAIOX
# Historia: COLLAB-1
...
reviews:
  ...
  path_instructions:
    ...
    '.triviaiox-core/development/agents/**':
      - 'Verificar que el agente sigue la estructura YAML de agentes TRIVIAIOX (persona_profile, commands, dependencies)'
    ...
    '.triviaiox-core/development/tasks/**':
      - 'Verificar que la tarea sigue el formato de tareas TRIVIAIOX con puntos de elicitacion claros'
    ...
    '.triviaiox-core/product/templates/**':
      - 'Asegurar que la plantilla sigue las convenciones de plantillas TRIVIAIOX'
    ...
    '**/*.js':
      ...
      - 'Asegurar que el codigo sigue los estandares de codigo TRIVIAIOX'
...
# ============================================
* @Trivia-Growth/maintainers

# ============================================
# Framework Core
# ============================================
# Definiciones de agentes - requiere revision del equipo core
.triviaiox-core/development/agents/ @Trivia-Growth/core-team

# Definiciones de tareas - requiere revision del equipo core
.triviaiox-core/development/tasks/ @Trivia-Growth/core-team

# Definiciones de workflows - requiere revision del equipo core
.triviaiox-core/development/workflows/ @Trivia-Growth/core-team

# Plantillas - requiere revision de arquitecto/equipo core
.triviaiox-core/product/templates/ @Trivia-Growth/core-team
templates/ @Trivia-Growth/core-team

# Utilidades core - requiere revision senior
.triviaiox-core/core/ @Trivia-Growth/core-team
.triviaiox-core/cli/ @Trivia-Growth/core-team

# ============================================
# Infraestructura
# ============================================
# CI/CD - requiere aprobacion de devops
.github/ @Trivia-Growth/devops

# Configuraciones de Docker
.docker/ @Trivia-Growth/devops

# Archivos de configuracion
.triviaiox-core/core-config.yaml @Trivia-Growth/core-team
package.json @Trivia-Growth/maintainers
package-lock.json @Trivia-Growth/maintainers

# ============================================
# Documentacion (Mas Permisiva)
# ============================================
# Documentacion general - mantenedores pueden aprobar
docs/ @Trivia-Growth/maintainers

# Decisiones de arquitectura - requiere equipo core
docs/architecture/ @Trivia-Growth/core-team
docs/framework/ @Trivia-Growth/core-team

# Historias - mantenedores (documentacion de desarrollo interno)
docs/stories/ @Trivia-Growth/maintainers

# Guias - mantenedores (amigable para contribuidores)
docs/guides/ @Trivia-Growth/maintainers

# ============================================
# Archivos Sensibles de Seguridad
# ============================================
# Configuraciones de seguridad
.github/CODEOWNERS @Trivia-Growth/core-team
.github/workflows/semantic-release.yml @Trivia-Growth/devops
.github/workflows/npm-publish.yml @Trivia-Growth/devops

# Archivos de configuracion raiz
.env* @Trivia-Growth/core-team
*.config.js @Trivia-Growth/maintainers
```

**Equipos de GitHub Requeridos:**

- `@Trivia-Growth/maintainers` - Mantenedores generales (acceso de escritura)
- `@Trivia-Growth/core-team` - Desarrolladores core del framework
- `@Trivia-Growth/devops` - CI/CD e infraestructura
...
- [ ] El agente sigue la estructura YAML de agentes TRIVIAIOX
...
- [ ] La tarea sigue el formato de tareas TRIVIAIOX
...
gh api -X DELETE repos/Trivia-Growth/Triviaiox/branches/main/protection
...
echo "* @Trivia-Growth" > .github/CODEOWNERS

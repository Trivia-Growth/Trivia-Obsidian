...
# Estructura del Arbol de Codigo Fuente TRIVIAIOX
...
**Aviso de Migracion:** Este documento migrara al repositorio `Trivia-Growth/Triviaiox` en Q2 2026 (ver Decision 005)
...
- [Estructura Actual (triviaiox-core Brownfield)](#estructura-actual-triviaiox-core-brownfield)
...
TRIVIAIOX usa una **arquitectura de doble capa**:

1. **Framework Core** (`.triviaiox-core/`) - Componentes portables del framework
...
## Estructura Actual (triviaiox-core Brownfield)

```
triviaiox-core/                             # Raiz (proyecto brownfield)
├── .triviaiox-core/                        # Framework core (portable)
...
│
├── bin/                               # Ejecutables CLI
│   ├── triviaiox-core.js           # Punto de entrada principal del CLI
│   └── triviaiox-minimal.js                # CLI minimo
│
...
**Proposito:** Componentes portables del framework que funcionan en cualquier proyecto TRIVIAIOX.
...
│
├── stories/                           # Historias de desarrollo
│   ├── triviaiox migration/                # Historias de migracion TRIVIAIOX
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Los Squads son extensiones modulares que agregan capacidades especializadas a TRIVIAIOX. A diferencia de los Paquetes de Expansion obsoletos, los Squads siguen una estructura de plantilla estandarizada.
...
│   └── cli/                           # Interfaz CLI
│
├── .triviaiox-core/                        # Assets del framework (estructura actual)
│   ├── agents/
│   ├── tasks/
│   ├── templates/
│   └── ...
...
Ubicacion: .triviaiox-core/agents/{nombre-agente}.md
Ejemplo: .triviaiox-core/agents/security-expert.md

# Estoy creando una nueva tarea:
Ubicacion: .triviaiox-core/tasks/{nombre-tarea}.md
Ejemplo: .triviaiox-core/tasks/deploy-to-production.md

# Estoy creando un nuevo workflow:
Ubicacion: .triviaiox-core/workflows/{nombre-workflow}.yaml
Ejemplo: .triviaiox-core/workflows/continuous-deployment.yaml

# Estoy creando una nueva plantilla:
Ubicacion: .triviaiox-core/product/templates/{nombre-plantilla}-tmpl.{yaml|md}
...
Ejemplo: docs/stories/triviaiox migration/story-6.1.2.6.md
...
Ubicacion: .triviaiox-core/utils/{nombre-utilidad}.js
Ejemplo: .triviaiox-core/utils/performance-monitor.js
...
| 1.1     | 2025-12-14 | Actualizada org a Trivia-Growth, reemplazados Paquetes de Expansion con sistema de Squads [Story 6.10] | Dex (dev)        |

---

_Este es un estandar oficial del framework TRIVIAIOX. Toda colocacion de archivos debe seguir esta estructura._

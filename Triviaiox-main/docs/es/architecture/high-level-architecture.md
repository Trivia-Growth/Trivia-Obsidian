...
# Arquitectura de Alto Nivel TRIVIAIOX v4
...
**TRIVIAIOX (AI Operating System)** es un framework sofisticado para orquestar agentes de IA, workers y humanos en flujos de trabajo complejos de desarrollo de software. La versión 2.1 introduce una arquitectura modular con 4 módulos, estrategia multi-repositorio y quality gates de 3 capas.
...
```
triviaiox-core/
├── .triviaiox-core/                    # Capa del framework
...
| ------------------ | ---------------------------- | ------------------------ | ----------------------------------- |
| **Core**           | `.triviaiox-core/core/`           | Fundación del framework  | Config, Registry, QG, MCP, Session  |
| **Development**    | `.triviaiox-core/development/`    | Artefactos de desarrollo | Agentes, Tareas, Workflows, Scripts |
| **Product**        | `.triviaiox-core/product/`        | Artefactos PM            | Plantillas, Checklists, Data        |
| **Infrastructure** | `.triviaiox-core/infrastructure/` | Config del sistema       | Scripts, Tools, Integraciones       |
...
| Pax    | `triviaiox-master`   | Orquestador  | Orquestación del framework |
...
- [TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.triviaiox-core/docs/standards/TRIVIAIOX-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guía completa del framework

...
**Propósito:** Definir patrones estándar para integrar scripts de utilidades en el framework TRIVIAIOX

---

## ¿Qué es la Integración de Utilidades?

**Definición:** La integración de utilidades es el proceso de hacer que un script de utilidad huérfano sea **descubrible, documentado y utilizable** dentro del framework TRIVIAIOX.
...
```yaml
# .triviaiox-core/agents/dev.yaml
id: dev
...
- `.triviaiox-core/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.triviaiox-core/core-config.yaml` (registrar si es necesario)
- `.triviaiox-core/utils/README.md` (documentar utilidad)
...
```yaml
# .triviaiox-core/tasks/generate-commit-message.md
...
**Archivos Modificados:**
- `.triviaiox-core/tasks/{task}.md` (agregar execution.utils)
- `.triviaiox-core/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.triviaiox-core/core-config.yaml` (registrar si es necesario)
- `.triviaiox-core/utils/README.md` (documentar utilidad)
...
**Archivos Modificados:**
- `.triviaiox-core/core-config.yaml` (registrar bajo framework)
- `.triviaiox-core/utils/README.md` (documentar como utilidad de framework)
...
```yaml
# .triviaiox-core/agents/architect.yaml
dependencies:
  utils:
...
**Archivos Modificados:**
- `.triviaiox-core/agents/{agent}.yaml`
- `.triviaiox-core/tasks/{task}.md` (si se crea tarea)
- `.triviaiox-core/core-config.yaml`
- `.triviaiox-core/utils/README.md`
...
**Ejemplos:** triviaiox-validator, code-quality-improver, coverage-analyzer
...
const utility = require('.triviaiox-core/utils/{utility-name}');
...
**Ubicación:** `.triviaiox-core/utils/{name}.js`

...
# Arquitectura del Sistema de Módulos TRIVIAIOX

> 🌐 [EN](../../architecture/module-system.md) | [PT](../../pt/architecture/module-system.md) | **ES**

---

> Guía completa de la arquitectura modular v4.2 para TriviaGrowth Triviaiox.
...
TriviaGrowth Triviaiox organiza el directorio `.triviaiox-core/` en cuatro módulos principales:
...
| `data/`          | `triviaiox-kb.md`, `workflow-patterns.yaml`           | Base de conocimiento del framework     |
...
**Ruta:** `.triviaiox-core/development/`
...
| --------------- | ------------------ | -------------------------- |
| TRIVIAIOX Master     | `triviaiox-master`      | Orquestación del framework |
...
**Ruta:** `.triviaiox-core/infrastructure/`
...
_Arquitectura del Sistema de Módulos TriviaGrowth Triviaiox v4_

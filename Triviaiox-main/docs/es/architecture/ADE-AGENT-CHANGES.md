# Cambios en los Agentes ADE - Alteraciones en los Agentes TRIVIAIOX
...
Este documento registra todas las alteraciones realizadas en los archivos de definición de los agentes TRIVIAIOX para soportar el TRIVIAIOX Autonomous Development Engine (ADE).

**Archivos modificados:**

- `.triviaiox-core/development/agents/*.md` (fuente)
- `.claude/commands/TRIVIAIOX/agents/*.md` (sincronizado)
...
**Archivo:** `.triviaiox-core/development/agents/devops.md`
...
**Archivo:** `.triviaiox-core/development/agents/pm.md`
...
**Archivo:** `.triviaiox-core/development/agents/architect.md`
...
**Archivo:** `.triviaiox-core/development/agents/analyst.md`
...
**Archivo:** `.triviaiox-core/development/agents/qa.md`
...
**Archivo:** `.triviaiox-core/development/agents/dev.md`
...
- name: list-gotchas
  visibility: [full, quick]
  description: 'Listar gotchas conocidos de .triviaiox/gotchas.md'
```
...
```
.triviaiox-core/development/agents/   →   .claude/commands/TRIVIAIOX/agents/
         (fuente)                           (sincronizado)
```
...
- `.triviaiox-core/infrastructure/schemas/agent-v3-schema.json`

**Comando para validar:**

```bash
node .triviaiox-core/infrastructure/scripts/migrate-agent.js --validate
```

...
**Migration Notice:** This document will migrate to `Trivia-Growth/Triviaiox` repository in Q2 2026 (see Decision 005)
...
TRIVIAIOX is built on modern JavaScript/TypeScript with Node.js runtime, optimized for cross-platform CLI development with interactive UX and agent orchestration capabilities.
...
TRIVIAIOX integrates with Model Context Protocol (MCP) servers:
...
| 1.1     | 2025-12-14 | Updated migration notice to Trivia-Growth/Triviaiox, semantic-release to v25.0.2 [Story 6.10] | Dex (dev)        |

---

_This is an official TRIVIAIOX framework standard. All technology choices must align with this stack._

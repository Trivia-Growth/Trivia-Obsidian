...
|---|---|---|---|
| Constitution | Framework | L1 | Generated by installer, references `.triviaiox-core/constitution.md` |
...
| Sistema de Agentes | Framework | L2 | Agent definitions from `.triviaiox-core/development/agents/` |
...
- `<!-- FRAMEWORK-OWNED: Generated by TRIVIAIOX installer, do not customize -->` for L1/L2 sections
...
Use `.triviaiox-core/development/checklists/memory-audit-checklist.md` periodically to:

# TRIVIAIOX Framework Documentation
...
**Migration Target:** Q2 2026 → `Trivia-Growth/Triviaiox` repository

---

## 📋 Overview

This directory contains **official TRIVIAIOX framework documentation** that defines standards, patterns, and structures applicable across all TRIVIAIOX projects (greenfield and brownfield).
...
**⚠️ IMPORTANT**: These documents are now in the `Trivia-Growth/Triviaiox` repository. The migration from the old `triviaiox/triviaiox-core` org was completed in December 2024 as part of OSR-9 (Rebranding).

### Migration Timeline

- **Phase 1 (Q1 2026 - Story 6.1.2.6):** ✅ Framework docs separated into `docs/framework/`
- **Phase 2 (Q4 2024):** ✅ Repository migrated to `Trivia-Growth/Triviaiox` (OSR-9)
...
- **Scope**: Portable across all TRIVIAIOX projects
- **Examples**: Coding standards, tech stack, source tree structure
- **Lifecycle**: Lives in `Trivia-Growth/Triviaiox` repository
...
### For Developers
1. **Read framework docs during onboarding** - Understand TRIVIAIOX standards
...
### For TRIVIAIOX Framework Maintainers
...
**Maintainer**: TRIVIAIOX Framework Team

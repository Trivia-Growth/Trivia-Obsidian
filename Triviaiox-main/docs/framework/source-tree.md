# TRIVIAIOX Source Tree Structure
...
**Repository:** Trivia-Growth/Triviaiox
...
- [Framework Core (.triviaiox-core/)](#framework-core-triviaiox-core)
...
TRIVIAIOX uses a **modular architecture** with clear separation of concerns:

1. **Framework Core** (`.triviaiox-core/`) - Portable framework components organized by domain
...
├── .triviaiox-core/                        # Framework core (modular)
...
│
├── bin/                               # CLI executables
│   └── triviaiox.js                        # Main CLI entry point
│
...
│
├── data/                              # Shared Data
│   ├── triviaiox-kb.md                     # TRIVIAIOX knowledge base (@triviaiox-master, lazy-loaded)
...
│   │   ├── triviaiox-master.md             # Master orchestrator
...
```yaml
Agents:
  Location: .triviaiox-core/development/agents/
  Format: Markdown with YAML frontmatter
  Naming: {agent-name}.md (kebab-case)
  Example: dev.md, qa.md, architect.md

Tasks:
  Location: .triviaiox-core/development/tasks/
...
Workflows:
  Location: .triviaiox-core/development/workflows/
  Format: YAML
...
### Shared Data Files (.triviaiox-core/data/)

| File | Owner | Fill Rule | Update Trigger | Used By |
|------|-------|-----------|----------------|---------|
| `triviaiox-kb.md` | @triviaiox-master | Updated on major framework changes | Manual edit | @triviaiox-master (lazy) |
...
### Product Data Files (.triviaiox-core/product/data/)
...
│   ├── triviaiox migration/                # TRIVIAIOX migration stories
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads are modular extensions that add specialized capabilities to TRIVIAIOX. Unlike the deprecated Squads, Squads follow a standardized template structure.
...
```bash
# Future CLI (planned):
npx create-triviaiox-squad my-squad-name
...
### REPO 1: Trivia-Growth/Triviaiox (MIT)

```
triviaiox-core/
├── .triviaiox-core/                        # Framework assets (modular v2.0)
│   ├── cli/                           # CLI commands and utilities
│   ├── core/                          # Framework essentials
│   │   ├── config/                    # Configuration system
...
### REPO 2: Trivia-Growth/squads (MIT)

```
squads/
├── verified/                          # TRIVIAIOX-curated squads
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
└── tools/                             # Squad development tools
    └── create-triviaiox-squad/
```

### REPO 3: Trivia-Growth/mcp-ecosystem (Apache 2.0)
...
### REPO 4: Trivia-Growth/certified-partners (Private)
...
### REPO 5: Trivia-Growth/mmos (Private + NDA)
...
Location: .triviaiox-core/development/agents/{agent-name}.md
Example: .triviaiox-core/development/agents/security-expert.md

# I'm creating a new task:
Location: .triviaiox-core/development/tasks/{task-name}.md
Example: .triviaiox-core/development/tasks/deploy-to-production.md

# I'm creating a new workflow:
Location: .triviaiox-core/development/workflows/{workflow-name}.yaml
Example: .triviaiox-core/development/workflows/continuous-deployment.yaml

# I'm creating a new template:
Location: .triviaiox-core/product/templates/{template-name}-tmpl.{yaml|md}
Example: .triviaiox-core/product/templates/deployment-plan-tmpl.yaml

# I'm creating a new checklist:
Location: .triviaiox-core/product/checklists/{checklist-name}-checklist.md
Example: .triviaiox-core/product/checklists/security-review-checklist.md

# I'm creating a CLI command:
Location: .triviaiox-core/cli/commands/{category}/{command-name}.js
Example: .triviaiox-core/cli/commands/generate/workflow.js

# I'm creating a core utility:
Location: .triviaiox-core/core/utils/{utility-name}.js
Example: .triviaiox-core/core/utils/performance-monitor.js

# I'm creating an infrastructure script:
Location: .triviaiox-core/infrastructure/scripts/{category}/{script-name}.js
Example: .triviaiox-core/infrastructure/scripts/llm-routing/router.js

# I'm adding a PM tool adapter:
Location: .triviaiox-core/infrastructure/integrations/pm-adapters/{adapter-name}.js
Example: .triviaiox-core/infrastructure/integrations/pm-adapters/monday-adapter.js
...
The ADE is configured via `.triviaiox-core/core-config.yaml`:
...
ade:
  ...
  memoryLayer:
    enabled: true
    patternStore: .triviaiox/patterns/
```

### ADE Runtime State

Runtime state is persisted in `.triviaiox/`:
...
| 1.1     | 2025-12-14 | Updated org to Trivia-Growth, replaced Squads with Squads system [Story 6.10]                                                                                           | Dex (dev)        |
...
| 3.1     | 2026-02-06 | Added Data File Governance section: documented 7 missing data files with owner, fill rule, and update trigger. Expanded .triviaiox-core/data/ and product/data/ tree listings. [Story ACT-8] | Dex (dev) |

---

_This is an official TRIVIAIOX framework standard. All file placement must follow this structure._

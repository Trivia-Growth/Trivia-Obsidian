...
const PIPELINE_MODULES = [
  '.triviaiox-core/development/scripts/unified-activation-pipeline',
  '.triviaiox-core/development/scripts/greeting-builder',
  '.triviaiox-core/development/scripts/agent-config-loader',
  '.triviaiox-core/development/scripts/greeting-preference-manager',
  '.triviaiox-core/development/scripts/workflow-navigator',
  '.triviaiox-core/core/session/context-loader',
  '.triviaiox-core/core/session/context-detector',
  '.triviaiox-core/core/permissions',
  '.triviaiox-core/infrastructure/scripts/project-status-loader',
  '.triviaiox-core/infrastructure/scripts/git-config-detector',
  '.triviaiox-core/core/config/config-resolver',
  '.triviaiox-core/core/config/config-cache',
];
...
async function runBenchmark(options) {
  const pipelinePath = path.resolve(
    PROJECT_ROOT, '.triviaiox-core/development/scripts/unified-activation-pipeline',
  );

...
const claudeCode = require('../../.triviaiox-core/infrastructure/scripts/ide-sync/transformers/claude-code');
const cursor = require('../../.triviaiox-core/infrastructure/scripts/ide-sync/transformers/cursor');
const antigravity = require('../../.triviaiox-core/infrastructure/scripts/ide-sync/transformers/antigravity');
...
describe('IDE Transformers', () => {
  ...
  describe('claude-code transformer', () => {
    ...
    it('should add sync footer if not present', () => {
      const result = claudeCode.transform(sampleAgent);
      expect(result).toContain('Synced from .triviaiox-core/development/agents/dev.md');
    });

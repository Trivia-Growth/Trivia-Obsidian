...
const { formatReport } = jest.requireActual(
  '../../../.triviaiox-core/core/synapse/diagnostics/report-formatter',
);
...
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/collectors/hook-collector');
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/collectors/session-collector');
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/collectors/manifest-collector');
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/collectors/pipeline-collector');
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/collectors/uap-collector');
jest.mock('../../../.triviaiox-core/core/synapse/diagnostics/report-formatter');
jest.mock('../../../.triviaiox-core/core/synapse/domain/domain-loader');

const { collectHookStatus } = require('../../../.triviaiox-core/core/synapse/diagnostics/collectors/hook-collector');
const { collectSessionStatus } = require('../../../.triviaiox-core/core/synapse/diagnostics/collectors/session-collector');
const { collectManifestIntegrity } = require('../../../.triviaiox-core/core/synapse/diagnostics/collectors/manifest-collector');
const { collectPipelineSimulation } = require('../../../.triviaiox-core/core/synapse/diagnostics/collectors/pipeline-collector');
const { collectUapBridgeStatus } = require('../../../.triviaiox-core/core/synapse/diagnostics/collectors/uap-collector');
const { formatReport: mockFormatReport } = require('../../../.triviaiox-core/core/synapse/diagnostics/report-formatter');
const { parseManifest } = require('../../../.triviaiox-core/core/synapse/domain/domain-loader');

const { runDiagnostics, runDiagnosticsRaw } = require('../../../.triviaiox-core/core/synapse/diagnostics/synapse-diagnostics');

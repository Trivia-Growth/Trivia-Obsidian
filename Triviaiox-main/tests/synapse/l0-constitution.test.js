...
const os = require('os');
const LayerProcessor = require('../../.triviaiox-core/core/synapse/layers/layer-processor');
const L0ConstitutionProcessor = require('../../.triviaiox-core/core/synapse/layers/l0-constitution');

...
const {
  ...
  main,
  ROMAN_TO_ARABIC,
} = require('../../.triviaiox-core/core/synapse/scripts/generate-constitution');
const { parseManifest, loadDomainFile } = require('../../.triviaiox-core/core/synapse/domain/domain-loader');
 ...
 */
const FULL_CONSTITUTION = `# TriviaGrowth Triviaiox Constitution
...
describe('generateConstitution', () => {
  ...
  test('should include header comments', () => {
    ...
    expect(output).toContain('# Auto-generated from .triviaiox-core/constitution.md');
...
describe('integration: real constitution.md', () => {
  const realConstitutionPath = path.join(__dirname, '..', '..', '.triviaiox-core', 'constitution.md');

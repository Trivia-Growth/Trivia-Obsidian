...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.triviaiox-core/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.triviaiox-core/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.triviaiox', 'dashboard', 'events.jsonl');
  });

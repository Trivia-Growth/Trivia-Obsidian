...
jest.mock('../../.triviaiox-core/core/memory/gotchas-memory', () => { throw new Error('mocked'); });

const { SubagentDispatcher } = require('../../.triviaiox-core/core/execution/subagent-dispatcher');

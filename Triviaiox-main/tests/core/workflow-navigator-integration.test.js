...
const { SessionState } = require('../../.triviaiox-core/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.triviaiox-core/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.triviaiox-core/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.triviaiox-core/development/scripts/greeting-builder');
      ...
      const { UnifiedActivationPipeline } = require('../../.triviaiox-core/development/scripts/unified-activation-pipeline');
      const MockWorkflowNavigator = require('../../.triviaiox-core/development/scripts/workflow-navigator');

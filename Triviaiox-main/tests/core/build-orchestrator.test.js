...
jest.mock('../../.triviaiox-core/workflow-intelligence/engine/wave-analyzer', () => null);
jest.mock('../../.triviaiox-core/infrastructure/scripts/worktree-manager', () => { throw new Error('not available'); });
jest.mock('../../.triviaiox-core/core/memory/gotchas-memory', () => { throw new Error('not available'); });
...
const {
  ...
  Phase,
  DEFAULT_CONFIG,
} = require('../../.triviaiox-core/core/execution/build-orchestrator');

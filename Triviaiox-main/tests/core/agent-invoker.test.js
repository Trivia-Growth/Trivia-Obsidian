...
const {
  ...
  SUPPORTED_AGENTS,
  InvocationStatus,
} = require('../../.triviaiox-core/core/orchestration/agent-invoker');
...
describe('Agent Invoker (Story 0.7)', () => {
  ...
  beforeEach(async () => {
    ...
    const agentsDir = path.join(tempDir, '.triviaiox-core', 'development', 'agents');
    ...
    const tasksDir = path.join(tempDir, '.triviaiox-core', 'development', 'tasks');
...
describe('Integration with MasterOrchestrator', () => {
  ...
  it('should integrate AgentInvoker with MasterOrchestrator', async () => {
    const { MasterOrchestrator } = require('../../.triviaiox-core/core/orchestration');

...
} = require('../../../.triviaiox-core/core/orchestration/bob-status-writer');
...
describe('BobStatusWriter', () => {
  ...
  describe('constructor', () => {
    ...
    it('should set correct paths', () => {
      ...
      expect(writer.dashboardDir).toBe(path.join(tempDir, '.triviaiox', 'dashboard'));
      expect(writer.statusPath).toBe(path.join(tempDir, '.triviaiox', 'dashboard', 'bob-status.json'));
    });
  });

...
const {
  ...
  PostDiscoveryChoice,
  PhaseFailureAction,
} = require('../../../.triviaiox-core/core/orchestration/brownfield-handler');
  ...
  describe('constructor', () => {
    ...
    test('should set correct workflow path', () => {
      expect(handler.workflowPath).toBe(
        path.join(TEST_PROJECT_ROOT, '.triviaiox-core/development/workflows/brownfield-discovery.yaml'),
      );
    });
  });

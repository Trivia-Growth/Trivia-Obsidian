...
const { validateUserProfile } = require('../../.triviaiox-core/infrastructure/scripts/validate-user-profile');

// Import modules under test after mocks
const GreetingPreferenceManager = require('../../.triviaiox-core/development/scripts/greeting-preference-manager');
...
describe('validate-user-profile standalone', () => {
  ...
  const actualValidateUserProfile = jest.requireActual(
    '../../.triviaiox-core/infrastructure/scripts/validate-user-profile',
  ).validateUserProfile;

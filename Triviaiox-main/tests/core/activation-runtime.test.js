...
jest.mock('../../.triviaiox-core/development/scripts/unified-activation-pipeline', () => ({
...
const { ActivationRuntime, activateAgent } = require('../../.triviaiox-core/development/scripts/activation-runtime');

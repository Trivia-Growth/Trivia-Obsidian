...
describe('License System Integration', () => {
  ...
  beforeEach(() => {
    ...
    testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'triviaiox-integration-test-'));
  ...
  describe('Cache Expiry → Grace Period → Degradation (AC-2, AC-3)', () => {
    it('should transition through license states correctly', () => {
      ...
      expect(graceStatus.action).toBe('triviaiox pro validate');
  ...
  describe('Corrupted Cache → Reactivation Flow', () => {
    it('should handle corrupted cache gracefully', () => {
      ...
      const cachePath = path.join(testDir, '.triviaiox', 'license.cache');

...
describe('license-api', () => {
  ...
  beforeEach(() => {
    ...
    testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'triviaiox-api-test-'));
  ...
  describe('LicenseApiClient constructor', () => {
    it('should use default config', () => {
      ...
      expect(client.baseUrl).toBe(process.env.TRIVIAIOX_LICENSE_API_URL || 'https://triviaiox-license-server.vercel.app');
    ...
    it('should successfully activate license (AC-1)', async () => {
      ...
      await createMockServer((req, res) => {
        ...
        req.on('end', () => {
          ...
          expect(data.triviaioxCoreVersion).toBe('3.0.0');

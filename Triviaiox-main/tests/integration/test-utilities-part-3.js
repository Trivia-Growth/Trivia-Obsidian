...
utilities.forEach(util => {
  try {
    const utilPath = path.join(__dirname, '../../triviaiox-core/utils', `${util}.js`);
    require(utilPath);
...
const agents = [
  { name: 'qa', path: '.triviaiox-core/development/agents/qa.md' },
  { name: 'po', path: '.triviaiox-core/development/agents/po.md' },
  { name: 'devops', path: '.triviaiox-core/development/agents/devops.md' },
  { name: 'dev', path: '.triviaiox-core/development/agents/dev.md' },
];

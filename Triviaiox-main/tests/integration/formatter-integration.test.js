...
const PersonalizedOutputFormatter = require('../../.triviaiox-core/infrastructure/scripts/output-formatter');
const OutputPatternValidator = require('../../.triviaiox-core/infrastructure/scripts/validate-output-pattern');
const fs = require('fs');
...
- .triviaiox-core/scripts/output-formatter.js
- .triviaiox-core/scripts/validate-output-pattern.js

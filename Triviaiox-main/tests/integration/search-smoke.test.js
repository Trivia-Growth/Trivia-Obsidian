...
const { searchKeyword } = require('../../.triviaiox-core/cli/commands/workers/search-keyword');
const { applyFilters } = require('../../.triviaiox-core/cli/commands/workers/search-filters');
const { formatOutput, formatJSON } = require('../../.triviaiox-core/cli/utils/output-formatter-cli');
...
describe('Smoke Tests - Search CLI', () => {
   ...
   * `triviaiox workers search "validator"` returns results

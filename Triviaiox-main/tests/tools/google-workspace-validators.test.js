...
describeIntegration('Google Workspace Tool Validators', () => {
  ...
  beforeAll(async () => {
    // Set search path to triviaiox-core/tools
    const toolsPath = path.join(__dirname, '../../triviaiox-core/tools');
  ...
  describeIntegration('Tool Resolution', () => {
    test('should resolve google-workspace tool from triviaiox-core/tools/mcp', async () => {

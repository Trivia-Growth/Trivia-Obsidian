...
const { RegistryProvider, LAYER_PRIORITY } = require('../../../.triviaiox-core/core/code-intel/providers/registry-provider');
const { CodeIntelProvider } = require('../../../.triviaiox-core/core/code-intel/providers/provider-interface');
const { CodeGraphProvider } = require('../../../.triviaiox-core/core/code-intel/providers/code-graph-provider');
const { CodeIntelClient, CB_CLOSED } = require('../../../.triviaiox-core/core/code-intel/code-intel-client');
...
entities:
  tasks:
    create-story:
      path: .triviaiox-core/development/tasks/create-story.md
      layer: L2
      type: task
      ...
      dependencies:
        - story-template
    validate-story:
      path: .triviaiox-core/development/tasks/validate-story.md
      layer: L2
      type: task
  ...
  agents:
    dev-agent:
      path: .triviaiox-core/development/agents/dev.md
      layer: L2
      type: agent
      ...
      dependencies:
        - create-story
    sm-agent:
      path: .triviaiox-core/development/agents/sm.md
      layer: L2
      type: agent
  ...
  templates:
    story-template:
      path: .triviaiox-core/development/templates/story-tmpl.yaml
      layer: L2
      type: template
  ...
  core:
    code-intel-client:
      path: .triviaiox-core/core/code-intel/code-intel-client.js
      layer: L1
      type: module
...
entities:
  tasks:
    yaml-validator:
      path: .triviaiox-core/development/tasks/yaml-validator.md
      layer: L2
      type: task
      ...
      dependencies: []
    index:
      path: .triviaiox-core/development/tasks/index.md
      layer: L2
      type: task
  ...
  scripts:
    yaml-validator:
      path: .triviaiox-core/development/scripts/yaml-validator.js
      layer: L2
      type: script
      ...
      dependencies: []
    backup-manager:
      path: .triviaiox-core/development/scripts/backup-manager.js
      layer: L2
      type: script
  ...
  core:
    yaml-validator:
      path: .triviaiox-core/core/yaml-validator.js
      layer: L1
      type: module
      ...
      dependencies: []
    index:
      path: .triviaiox-core/core/index.js
      layer: L1
      type: module
      ...
      dependencies: []
    backup-manager:
      path: .triviaiox-core/core/backup-manager.js
      layer: L1
      type: module
  ...
  templates:
    yaml-validator:
      path: .triviaiox-core/development/templates/yaml-validator.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    index:
      path: .triviaiox-core/development/templates/index.yaml
      layer: L3
      type: template
      ...
      dependencies: []
    backup-manager:
      path: .triviaiox-core/development/templates/backup-manager.yaml
      layer: L3
      type: template
...
describe('RegistryProvider — 5 Implemented Primitives', () => {
  ...
  describe('findDefinition()', () => {
    test('finds entity by exact name', async () => {
      ...
      expect(result.file).toBe('.triviaiox-core/development/tasks/create-story.md');
  ...
  describe('findReferences()', () => {
    ...
    test('finds references via dependencies field', async () => {
      ...
      expect(paths).toContain('.triviaiox-core/development/tasks/create-story.md');
    });
...
describe('RegistryProvider — Entity Name Disambiguation', () => {
  ...
  test('yaml-validator has 4 entries, all preserved in index', async () => {
    ...
    expect(result.file).toBe('.triviaiox-core/core/yaml-validator.js');
  });
  ...
  test('index has 3 entries, all preserved', async () => {
    ...
    expect(result).not.toBeNull();
    // L1 core should win
    expect(result.file).toBe('.triviaiox-core/core/index.js');
  });

  test('backup-manager has 3 entries, L1 wins', async () => {
    const result = await provider.findDefinition('backup-manager');
    expect(result).not.toBeNull();
    expect(result.file).toBe('.triviaiox-core/core/backup-manager.js');
  });
  ...
  test('disambiguation scoring: L1 > L2 > L3', async () => {
    ...
    const result = await provider.findDefinition('yaml-validator');
    expect(result.file).toContain('.triviaiox-core/core/');
  });
});

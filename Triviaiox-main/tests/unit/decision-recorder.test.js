...
const {
  ...
  getCurrentContext,
} = require('../../.triviaiox-core/development/scripts/decision-recorder');

// Mock decision-log-generator
jest.mock('../../.triviaiox-core/development/scripts/decision-log-generator', () => ({
...
describe('decision-recorder', () => {
  ...
  describe('completeDecisionLogging', () => {
    it('should complete logging and generate log file', async () => {
      const { generateDecisionLog } = require('../../.triviaiox-core/development/scripts/decision-log-generator');

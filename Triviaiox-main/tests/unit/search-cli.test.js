...
// Test modules
const { searchKeyword, fuzzyMatchScore, levenshteinDistance } = require('../../.triviaiox-core/cli/commands/workers/search-keyword');
const { applyFilters, filterByCategory, filterByTags } = require('../../.triviaiox-core/cli/commands/workers/search-filters');
const { formatOutput, formatTable, formatJSON, formatYAML } = require('../../.triviaiox-core/cli/utils/output-formatter-cli');
const { calculateScores, sortByScore, calculateSearchAccuracy } = require('../../.triviaiox-core/cli/utils/score-calculator');
const { isSemanticAvailable, cosineSimilarity, buildSearchText } = require('../../.triviaiox-core/cli/commands/workers/search-semantic');
...
const mockWorkers = [
  {
    ...
    path: '.triviaiox-core/development/tasks/data/json-csv-transformer.md',
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'data', 'json', 'csv'],
    path: '.triviaiox-core/development/tasks/data/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.triviaiox-core/development/tasks/validation/json-validator.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.triviaiox-core/development/tasks/code/api-generator.md',
  },
  {
    id: 'test-runner',
    name: 'Test Runner',
    ...
    path: '.triviaiox-core/development/tasks/testing/test-runner.md',
  },
];
  ...
  const testResults = [
    {
      ...
      tags: ['etl', 'json', 'csv'],
      score: 95,
      path: '.triviaiox-core/tasks/json-csv-transformer.md',
    },
  ];

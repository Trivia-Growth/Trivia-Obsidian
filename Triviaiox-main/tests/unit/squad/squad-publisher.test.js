...
describe('SquadPublisher', () => {
  ...
  describe('Constants', () => {
    it('should export TRIVIAIOX_SQUADS_REPO', () => {
      expect(TRIVIAIOX_SQUADS_REPO).toBe('Trivia-Growth/triviaiox-squads');
    });
  ...
  describe('Constructor', () => {
    ...
    it('should use default repo when not specified', () => {
      const defaultPublisher = new SquadPublisher();
      expect(defaultPublisher.repo).toBe(TRIVIAIOX_SQUADS_REPO);
    });
  ...
  describe('publish()', () => {
    ...
    it('should return preview in dry run mode', async () => {
      ...
      expect(result.preview.repo).toBe(TRIVIAIOX_SQUADS_REPO);
  ...
  describe('generatePRBody()', () => {
    ...
    it('should include checklist in PR body', () => {
      ...
      expect(body).toContain('[x] Squad follows TRIVIAIOX task-first architecture');
    ...
    it('should include submit attribution', () => {
      ...
      expect(body).toContain('TRIVIAIOX-FullStack');
    });
  });

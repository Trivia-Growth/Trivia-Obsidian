...
} = require('../../../.triviaiox-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer');

describe('Brownfield Analyzer', () => {
  let tempDir;

  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'triviaiox-brownfield-test-'));
  });

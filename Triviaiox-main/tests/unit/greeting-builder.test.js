...
const { resolveConfig: mockResolveConfig } = require('../../.triviaiox-core/core/config/config-resolver');
...
const { loadProjectStatus, formatStatusDisplay } = require('../../.triviaiox-core/infrastructure/scripts/project-status-loader');

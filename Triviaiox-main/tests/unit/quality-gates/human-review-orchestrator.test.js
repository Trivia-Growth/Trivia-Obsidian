...
describe('HumanReviewOrchestrator', () => {
  ...
  beforeEach(() => {
    orchestrator = new HumanReviewOrchestrator({
      statusPath: '.triviaiox/qa-status-test.json',
      reviewRequestsPath: '.triviaiox/human-review-requests-test',
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('should create orchestrator with custom config', () => {
      expect(orchestrator.statusPath).toBe('.triviaiox/qa-status-test.json');
      expect(orchestrator.reviewRequestsPath).toBe('.triviaiox/human-review-requests-test');
    });
  });

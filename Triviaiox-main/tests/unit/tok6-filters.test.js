...
const { filterContent, stripHtml, truncateAtBoundary, extractFields, CHARS_PER_TOKEN } = require('../../.triviaiox-core/utils/filters/content-filter');
const { filterSchema, projectFields } = require('../../.triviaiox-core/utils/filters/schema-filter');
const { filterFields } = require('../../.triviaiox-core/utils/filters/field-filter');
const { applyFilter, loadFilterConfig } = require('../../.triviaiox-core/utils/filters/index');
...
describe('constants.js', () => {
  it('exports CHARS_PER_TOKEN as 4', () => {
    const { CHARS_PER_TOKEN } = require('../../.triviaiox-core/utils/filters/constants');
    expect(CHARS_PER_TOKEN).toBe(4);
  });

  it('is the same value used by content-filter and schema-filter', () => {
    const { CHARS_PER_TOKEN: contentCPT } = require('../../.triviaiox-core/utils/filters/content-filter');
    const { CHARS_PER_TOKEN: schemaCPT } = require('../../.triviaiox-core/utils/filters/schema-filter');
    const { CHARS_PER_TOKEN: sharedCPT } = require('../../.triviaiox-core/utils/filters/constants');
...
describe('index.js (filter dispatcher)', () => {
  const registryPath = path.join(__dirname, '..', '..', '.triviaiox-core', 'data', 'tool-registry.yaml');

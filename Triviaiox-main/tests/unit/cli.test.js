 ...
 * Tests for bin/triviaiox.js command routing and version checking
 */
  ...
  describe('Command Routing', () => {
    ...
    it('should handle --help flag', (done) => {
      ...
      child.on('close', (code) => {
        ...
        expect(output).toContain('npx triviaiox-core@latest');
        done();
      });
    });
    ...
    it('should handle doctor command', (done) => {
      ...
      child.on('close', (code) => {
        ...
        expect(combined).toContain('TRIVIAIOX Doctor');
        done();
      });
    });

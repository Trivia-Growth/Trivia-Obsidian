...
const { onPreCompact, getHookConfig } = require('../../../../.triviaiox-core/hooks/unified/runners/precompact-runner');
...
describe('PreCompact Hook Runner', () => {
  ...
  describe('onPreCompact', () => {
    ...
    it('should gracefully no-op when triviaiox-pro not available', async () => {
      proDetector.isProAvailable.mockReturnValue(false);
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[PreCompact] triviaiox-pro not available, skipping session digest',
      );
    });

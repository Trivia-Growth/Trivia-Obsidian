# Contributing to TriviaGrowth Triviaiox

> **[Versao em Portugues](docs/pt/contributing.md)**

Welcome to TRIVIAIOX! Thank you for your interest in contributing. This guide will help you understand our development workflow, contribution process, and how to submit your changes.
...
```
.triviaiox-core/development/agents/your-agent.md
```
...
```
.triviaiox-core/development/tasks/your-task.md
```
...
- [Squad Discussions](https://github.com/Trivia-Growth/Triviaiox/discussions/categories/ideas) - Share ideas
...
- Security concerns
- TRIVIAIOX-specific patterns (agents, tasks, workflows)
- Performance issues
...
TRIVIAIOX implements a **Defense in Depth** strategy with 3 validation layers:
...
| Path | Why |
|------|-----|
| `.triviaiox-core/core/orchestration/` | Orchestration layer (MasterOrchestrator, GateEvaluator) |
| `.triviaiox-core/core/execution/` | Execution engine (WaveExecutor, ParallelExecutor) |
| `packages/` | Installer, CLI, shared libraries |
| `.github/` | CI/CD workflows, branch protection |
| `.triviaiox-core/core-config.yaml` | Framework configuration |
...
- **Discussions:** [Start a discussion](https://github.com/Trivia-Growth/Triviaiox/discussions)
...
TRIVIAIOX uses an Open Core model with a private `pro/` git submodule (see [ADR-PRO-001](docs/architecture/adr/adr-pro-001-repository-strategy.md)).
...
git clone https://github.com/<your-fork>/triviaiox-core.git
cd triviaiox-core
...
git clone --recurse-submodules https://github.com/Trivia-Growth/Triviaiox.git

# Or add to existing clone
git submodule update --init pro
```

**Push order:** Always push `pro/` changes first, then `triviaiox-core`.
...
**Thank you for contributing to TriviaGrowth Triviaiox!**

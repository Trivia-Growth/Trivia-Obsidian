# @trivia-growth/triviaiox-install

NPX installer for TRIVIAIOX - AI-Orchestrated System for Full Stack Development.

## Quick Start

```bash
npx @trivia-growth/triviaiox-install
```

That's it! The installer will guide you through setting up TRIVIAIOX in less than 5 minutes.
...
- **Brownfield support**: Detects existing TRIVIAIOX installations and offers migration
...
```bash
npx @trivia-growth/triviaiox-install --help
...
```bash
npx @trivia-growth/triviaiox-install --dry-run
```
...
```bash
npx @trivia-growth/triviaiox-install --profile bob
npx @trivia-growth/triviaiox-install --profile advanced
```
...
If you have an existing TRIVIAIOX installation, the installer will:
...
- Documentation: https://github.com/Trivia-Growth/Triviaiox

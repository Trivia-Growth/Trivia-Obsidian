/**
 * TRIVIAIOX Color Palette v5.0.0
 *
 * Brand color system for CLI tools and terminal output.
 * Colors derived from TRIVIAIOX brand identity: Lime + Cream on Dark surfaces.
 *
 * @see docs/standards/TRIVIAIOX-COLOR-PALETTE-V2.1.md
 * @module triviaiox-colors
 */

const chalk = require('chalk');

/**
 * TRIVIAIOX Brand Color Palette
...
const colors = {
  ...
  /**
   * Primary branding - Bold lime for TRIVIAIOX brand moments
   */
...
const examples = {
  welcome: () => {
    console.log(headings.h1('🎉 Welcome to TRIVIAIOX v4 Installer!'));
  ...
  complete: () => {
    ...
    console.log(colors.info('Your TRIVIAIOX project is ready to use.'));

 ...
 *
 * Modular question system for TRIVIAIOX installation wizard
 ...
 * PRD: TRIVIAIOX v2.0 "Projeto Bob" - Seção 2.4
 *
 * @returns {Object} Inquirer question object
 */
...
function getMCPQuestions() {
  return [
    ...
    // Note: API keys are configured later via triviaiox-master or directly in .env
  ];
}
 ...
 * directly in triviaiox-init.js using the squads/ directory.
 *
 * @returns {Object[]} Array of inquirer question objects
 * @deprecated Use squads/ directory directly in triviaiox-init.js
 */
  ...
  return [
    {
      ...
      choices: [
        ...
        {
          name: 'None' + colors.dim(' - Let TRIVIAIOX decide based on project'),
          value: 'none',
        },
      ],
      default: 0,
...
function buildQuestionSequence(_context = {}) {
  ...
  // Squad Selection - DISABLED: Handled directly in triviaiox-init.js

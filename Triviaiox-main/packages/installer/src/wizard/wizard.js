...
/**
 * Interactive Wizard for TRIVIAIOX Installation
 *
...
async function runWizard(options = {}) {
  ...
  try {
    ...
    console.log('🚀 Welcome to TRIVIAIOX Installer\n');
...
async function confirmProjectType(detectedType) {
  ...
  const typeDescriptions = {
    GREENFIELD: 'New project - TRIVIAIOX will create complete structure',
    BROWNFIELD: 'Existing project - TRIVIAIOX will integrate with current setup',
    EXISTING_TRIVIAIOX: 'TRIVIAIOX already installed - Would you like to update or reinstall?',

 ...
 *
 * Spinners, progress bars, and status indicators using TRIVIAIOX Color System v4.0.4
 *
...
const { colors, status, headings } = require('../utils/triviaiox-colors');
const { t } = require('./i18n');

/**
 * Create and start a spinner with TRIVIAIOX styling
 *
...
/**
 * Create progress bar with TRIVIAIOX styling
 *
...
/**
 * ASCII Art Banner for TriviaGrowth Triviaiox
 */
const BANNER = `
████████╗██████╗ ██╗██╗   ██╗██╗ █████╗ ██╗ ██████╗ ██╗  ██╗
╚══██╔══╝██╔══██╗██║██║   ██║██║██╔══██╗██║██╔═══██╗╚██╗██╔╝

...
const TROUBLESHOOTING_DATABASE = {
  ENV_FILE_MISSING: {
    ...
    solutions: [
      'Re-run wizard: npx @Trivia-Growth/triviaiox@latest init',
      'Manually create .env from template: cp .env.example .env',
      'Check file permissions in project directory',
    ],
    docs: 'https://docs.Trivia-Growth.com/installation/environment',
    priority: 'critical',
  },
  ...
  CORE_CONFIG_MISSING: {
    ...
    causes: [
      'Environment configuration step failed',
      '.triviaiox-core directory missing',
      'File creation failed',
    ],
    solutions: [
      'Re-run wizard: npx @Trivia-Growth/triviaiox@latest init',
      'Check .triviaiox-core directory exists',
      'Manually create from template',
    ],
    docs: 'https://docs.Trivia-Growth.com/configuration/core-config',
    priority: 'high',
  },
  ...
  MCP_HEALTH_CHECK_FAILED: {
    ...
    docs: 'https://docs.Trivia-Growth.com/mcps/troubleshooting',
    priority: 'medium',
  },
  ...
  GITIGNORE_CRITICAL_MISSING: {
    ...
    docs: 'https://docs.Trivia-Growth.com/security/gitignore',
    priority: 'high',
  },
  ...
  DEPS_INSTALL_FAILED: {
    ...
    docs: 'https://docs.Trivia-Growth.com/installation/dependencies',
    priority: 'critical',
  },
  ...
  ENV_PERMISSIONS_INSECURE: {
    ...
    docs: 'https://docs.Trivia-Growth.com/security/file-permissions',
    priority: 'medium',
  },
};
...
async function offerTroubleshooting(errors) {
  ...
  if (viewLogs) {
    ...
    console.log(chalk.dim('  - .triviaiox/install-log.txt'));
    console.log(chalk.dim('  - .triviaiox/install-errors.log'));
    console.log('');
    console.log(chalk.dim('View with: cat .triviaiox/install-log.txt'));
  }
  ...
  if (openDocs) {
    ...
    console.log(chalk.green('  https://docs.Trivia-Growth.com/troubleshooting'));
    console.log('');
  }
  ...
  console.log(chalk.dim('  - GitHub Issues: https://github.com/Trivia-Growth/triviaiox/issues'));
  console.log(chalk.dim('  - Documentation: https://docs.Trivia-Growth.com'));
  console.log('');
}
...
function displayGenericTroubleshooting(code, errorInstances) {
  ...
  console.log(chalk.green('  2. Check installation logs in .triviaiox/'));

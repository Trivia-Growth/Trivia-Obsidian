...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.triviaiox-core/core-config.yaml';
    ...
    // Validate directory structure - only .triviaiox-core is required
    const requiredDirs = ['.triviaiox-core'];

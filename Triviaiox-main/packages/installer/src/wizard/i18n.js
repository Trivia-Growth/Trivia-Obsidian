/**
 * Internationalization (i18n) for TRIVIAIOX Wizard
 *
...
const TRANSLATIONS = {
  en: {
    ...
    // Progress messages
    installingCore: 'Installing TRIVIAIOX core...',
    ...
    proNoAccess: 'No TRIVIAIOX Pro access found for this email.',
    proContactSupport: 'If you believe this is an error, please contact support:',
    proPurchase: 'Purchase Pro: https://pro.triviagrowth.ai',
    ...
    proForgotPassword: 'Forgot your password? Visit https://triviaiox-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'Or open an issue: https://github.com/Trivia-Growth/Triviaiox/issues',
    proAuthFailed: 'Authentication failed: {message}',
    proCreateAccount: 'Create your TRIVIAIOX Pro account to get started.',
    ...
    proPurchaseAt: 'Purchase Pro at https://pro.triviagrowth.ai',
    ...
    proModuleNotAvailable: 'Pro license module not available. Ensure @triviaiox-fullstack/pro is installed.',
    proModuleBootstrap: 'Pro license module not found locally. Installing @triviaiox-fullstack/pro to bootstrap...',
    ...
    proInstallingPackage: 'Installing @triviaiox-fullstack/pro...',
    proPackageInstalled: 'Pro package installed',
    proPackageInstallFailed: 'Failed to install Pro package',
    proScaffolderNotAvailable: 'Pro scaffolder not available. Ensure @triviaiox-fullstack/pro is installed.',
    ...
    proInstallComplete: 'TRIVIAIOX Pro installation complete!',
    proNeedHelp: 'Need help? Run: npx triviaiox-pro recover',
    proCISetEnv: 'CI mode: Set TRIVIAIOX_PRO_EMAIL + TRIVIAIOX_PRO_PASSWORD or TRIVIAIOX_PRO_KEY environment variables.',
    ...
    proNpmInstallFailed: 'npm install @triviaiox-fullstack/pro failed: {message}. Try manually: npm install @triviaiox-fullstack/pro',
  },
  ...
  pt: {
    ...
    // User Profile (Story 10.2 - Epic 10: User Profile System)
    // PRD: TRIVIAIOX v2.0 "Projeto Bob" - Seção 2.4 (exact copy)
    ...
    // Progress messages
    installingCore: 'Instalando TRIVIAIOX core...',
    ...
    proNoAccess: 'Nenhum acesso TRIVIAIOX Pro encontrado para este email.',
    proContactSupport: 'Se você acredita que isso é um erro, entre em contato com o suporte:',
    proPurchase: 'Comprar Pro: https://pro.triviagrowth.ai',
    ...
    proForgotPassword: 'Esqueceu sua senha? Acesse https://triviaiox-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'Ou abra uma issue: https://github.com/Trivia-Growth/Triviaiox/issues',
    proAuthFailed: 'Falha na autenticação: {message}',
    proCreateAccount: 'Crie sua conta TRIVIAIOX Pro para começar.',
    ...
    proPurchaseAt: 'Compre o Pro em https://pro.triviagrowth.ai',
    ...
    proModuleNotAvailable: 'Módulo de licença Pro não disponível. Certifique-se de que @triviaiox-fullstack/pro está instalado.',
    proModuleBootstrap: 'Módulo de licença Pro não encontrado localmente. Instalando @triviaiox-fullstack/pro...',
    ...
    proInstallingPackage: 'Instalando @triviaiox-fullstack/pro...',
    proPackageInstalled: 'Pacote Pro instalado',
    proPackageInstallFailed: 'Falha ao instalar pacote Pro',
    proScaffolderNotAvailable: 'Scaffolder Pro não disponível. Certifique-se de que @triviaiox-fullstack/pro está instalado.',
    ...
    proInstallComplete: 'Instalação do TRIVIAIOX Pro completa!',
    proNeedHelp: 'Precisa de ajuda? Execute: npx triviaiox-pro recover',
    proCISetEnv: 'Modo CI: Defina as variáveis TRIVIAIOX_PRO_EMAIL + TRIVIAIOX_PRO_PASSWORD ou TRIVIAIOX_PRO_KEY.',
    ...
    proNpmInstallFailed: 'npm install @triviaiox-fullstack/pro falhou: {message}. Tente manualmente: npm install @triviaiox-fullstack/pro',
  },
  ...
  es: {
    ...
    proNoAccess: 'No se encontró acceso TRIVIAIOX Pro para este email.',
    ...
    proForgotPassword: '¿Olvidó su contraseña? Visite https://triviaiox-license-server.vercel.app/reset-password',
    proContactSupportEmail: 'O abra un issue: https://github.com/Trivia-Growth/Triviaiox/issues',
    proAuthFailed: 'Error de autenticación: {message}',
    proCreateAccount: 'Cree su cuenta TRIVIAIOX Pro para comenzar.',
    ...
    proPurchaseAt: 'Compre Pro en https://pro.triviagrowth.ai',
    ...
    proModuleNotAvailable: 'Módulo de licencia Pro no disponible. Asegúrese de que @triviaiox-fullstack/pro esté instalado.',
    proModuleBootstrap: 'Módulo de licencia Pro no encontrado localmente. Instalando @triviaiox-fullstack/pro...',
    ...
    proScaffolderNotAvailable: 'Scaffolder Pro no disponible. Asegúrese de que @triviaiox-fullstack/pro esté instalado.',
    ...
    proInstallComplete: '¡Instalación de TRIVIAIOX Pro completa!',
    proNeedHelp: '¿Necesita ayuda? Ejecute: npx triviaiox-pro recover',
    proCISetEnv: 'Modo CI: Configure las variables TRIVIAIOX_PRO_EMAIL + TRIVIAIOX_PRO_PASSWORD o TRIVIAIOX_PRO_KEY.',
    ...
    proNpmInstallFailed: 'npm install @triviaiox-fullstack/pro falló: {message}. Intente manualmente: npm install @triviaiox-fullstack/pro',
  },
};

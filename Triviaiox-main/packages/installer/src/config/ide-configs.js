 ...
 * IDE Configuration Metadata
 *
 * TriviaGrowth Triviaiox v4 supports 6 main IDEs:
...
const IDE_CONFIGS = {
  'claude-code': {
    ...
    format: 'text',
    recommended: true,
    agentFolder: path.join('.claude', 'commands', 'TRIVIAIOX', 'agents'),
  },
  codex: {
    name: 'Codex CLI',
    description: '',
  ...
  gemini: {
    ...
    requiresDirectory: true,
    format: 'text',
    agentFolder: path.join('.gemini', 'rules', 'TRIVIAIOX', 'agents'),
  },
  cursor: {
    name: 'Cursor',
    description: '',

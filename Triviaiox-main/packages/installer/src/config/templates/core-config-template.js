 ...
 *
 * Generates YAML configuration file for TRIVIAIOX framework
 *
 ...
 * @param {string} options.projectType - Project type from Story 1.3 (GREENFIELD|BROWNFIELD|EXISTING_TRIVIAIOX)
 ...
 * @param {string} [options.triviaioxVersion] - TRIVIAIOX version (default: 2.1.0)
...
function generateCoreConfig(options = {}) {
  ...
  const config = {
    ...
    scriptsLocation: '.triviaiox-core/scripts',
    dataLocation: '.triviaiox-core/data',
    elicitationLocation: '.triviaiox-core/elicitation',
    ...
    boundary: {
      ...
      // L3 paths — mutable exceptions (allowed even within .triviaiox-core/)
      exceptions: [
        '.triviaiox-core/data/**',
        '.triviaiox-core/development/agents/*/MEMORY.md',
        '.triviaiox-core/core/config/schemas/**',
        '.triviaiox-core/core/config/template-overrides.js',
      ],
    },

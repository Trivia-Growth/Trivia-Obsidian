...
/**
 * Get the current TRIVIAIOX version from package.json
 * @returns {string} The version string
 */
function getTriviaioxVersion() {
  try {
...
const TRIVIAIOX_VERSION = getTriviaioxVersion();
...
function generateEnvContent(apiKeys = {}) {
  const content = `# ============================================
# TriviaGrowth Triviaiox Environment Configuration
# ============================================
# Generated by TRIVIAIOX Installer
...
# --------------------------------------------
# TRIVIAIOX Core Configuration
# --------------------------------------------
NODE_ENV=development
TRIVIAIOX_VERSION=${TRIVIAIOX_VERSION}

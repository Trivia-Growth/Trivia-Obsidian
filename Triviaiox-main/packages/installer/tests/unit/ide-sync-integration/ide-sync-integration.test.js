...
jest.mock('../../../../../.triviaiox-core/infrastructure/scripts/ide-sync/index', () => ({
...
describe('IDE Sync Integration (Story INS-4.5)', () => {
  ...
  describe('AC3: Graceful failure', () => {
    ...
    test('failure message suggests triviaiox doctor --fix', () => {
      expect(wizardSource).toContain("triviaiox doctor --fix");
    });

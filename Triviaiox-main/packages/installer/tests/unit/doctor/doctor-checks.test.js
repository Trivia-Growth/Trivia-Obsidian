 ...
 * Story INS-4.1: triviaiox doctor rewrite
...
const nodeVersionCheck = require('../../../../../.triviaiox-core/core/doctor/checks/node-version');
const npmPackagesCheck = require('../../../../../.triviaiox-core/core/doctor/checks/npm-packages');
const settingsJsonCheck = require('../../../../../.triviaiox-core/core/doctor/checks/settings-json');
const rulesFilesCheck = require('../../../../../.triviaiox-core/core/doctor/checks/rules-files');
const agentMemoryCheck = require('../../../../../.triviaiox-core/core/doctor/checks/agent-memory');
const entityRegistryCheck = require('../../../../../.triviaiox-core/core/doctor/checks/entity-registry');
const gitHooksCheck = require('../../../../../.triviaiox-core/core/doctor/checks/git-hooks');
const coreConfigCheck = require('../../../../../.triviaiox-core/core/doctor/checks/core-config');
const claudeMdCheck = require('../../../../../.triviaiox-core/core/doctor/checks/claude-md');
const graphDashboardCheck = require('../../../../../.triviaiox-core/core/doctor/checks/graph-dashboard');
const codeIntelCheck = require('../../../../../.triviaiox-core/core/doctor/checks/code-intel');
const ideSyncCheck = require('../../../../../.triviaiox-core/core/doctor/checks/ide-sync');
const skillsCountCheck = require('../../../../../.triviaiox-core/core/doctor/checks/skills-count');
const commandsCountCheck = require('../../../../../.triviaiox-core/core/doctor/checks/commands-count');
const hooksClaudeCountCheck = require('../../../../../.triviaiox-core/core/doctor/checks/hooks-claude-count');
const { loadChecks } = require('../../../../../.triviaiox-core/core/doctor/checks');
...
describe('settings-json check', () => {
  it('should PASS with valid settings and sufficient deny rules', async () => {
    ...
    const mockSettings = {
      permissions: {
        deny: new Array(50).fill('Edit(.triviaiox-core/core/)'),
        allow: ['Edit(docs/)'],
      },
    };
...
describe('code-intel check', () => {
  ...
  it('should PASS with RegistryProvider when entity-registry exists', async () => {
    ...
    const registryPath = path.join(realProjectRoot, '.triviaiox-core', 'data', 'entity-registry.yaml');
...
describe('skills-count check', () => {
  ...
  it('should FAIL when 0 skills found', async () => {
    ...
    const result = await skillsCountCheck.run(mockContext);
    expect(result.status).toBe('FAIL');
    expect(result.fixCommand).toBe('npx triviaiox-core install --force');
  });
...
describe('health-check.yaml task (INS-4.8)', () => {
  it('should NOT have *doctor alias', () => {
    ...
    const yaml = realFs.readFileSync(
      path.join(__dirname, '..', '..', '..', '..', '..', '.triviaiox-core', 'development', 'tasks', 'health-check.yaml'),
      'utf8',
    );
  ...
  it('should reference triviaiox doctor --json in instructions', () => {
    const realFs = jest.requireActual('fs');
    const yaml = realFs.readFileSync(
      path.join(__dirname, '..', '..', '..', '..', '..', '.triviaiox-core', 'development', 'tasks', 'health-check.yaml'),
      'utf8',
    );
    expect(yaml).toContain('triviaiox doctor --json');
    expect(yaml).toContain('npx triviaiox-core doctor --json');
  });

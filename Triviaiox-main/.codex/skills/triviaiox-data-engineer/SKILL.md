...
# TRIVIAIOX Database Architect & Operations Engineer Activator
...
## Activation Protocol
1. Load `.triviaiox-core/development/agents/data-engineer.md` as source of truth (fallback: `.codex/agents/data-engineer.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .triviaiox-core/development/scripts/generate-greeting.js data-engineer` and show it first.

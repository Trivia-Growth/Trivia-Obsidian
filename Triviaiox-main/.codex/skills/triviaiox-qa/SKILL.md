...
# TRIVIAIOX Test Architect & Quality Advisor Activator
...
## Activation Protocol
1. Load `.triviaiox-core/development/agents/qa.md` as source of truth (fallback: `.codex/agents/qa.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .triviaiox-core/development/scripts/generate-greeting.js qa` and show it first.

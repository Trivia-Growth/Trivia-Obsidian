...
# TRIVIAIOX Product Manager Activator
...
## Activation Protocol
1. Load `.triviaiox-core/development/agents/pm.md` as source of truth (fallback: `.codex/agents/pm.md`).
2. Adopt this agent persona and command system.
3. Generate greeting via `node .triviaiox-core/development/scripts/generate-greeting.js pm` and show it first.

# TRIVIAIOX Squad: Artificial Intelligence Orchestration eXperience

> 🌍 [English](README.en.md) | **[Português](README.md)**

[![Versão NPM](https://img.shields.io/npm/v/triviaiox-core.svg)](https://www.npmjs.com/package/triviaiox-core)
[![Licença: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Versão Node.js](https://img.shields.io/badge/node-%3E%3D18.0.0-brightgreen.svg)](https://nodejs.org/)
[![CI](https://github.com/Trivia-Growth/Triviaiox/actions/workflows/ci.yml/badge.svg)](https://github.com/Trivia-Growth/Triviaiox/actions/workflows/ci.yml)
[![codecov](https://codecov.io/gh/Trivia-Growth/Triviaiox/branch/main/graph/badge.svg)](https://codecov.io/gh/Trivia-Growth/Triviaiox)
[![Documentação](https://img.shields.io/badge/docs-disponível-orange.svg)](https://triviaioxsquad.ai)
...
Se é sua primeira vez no TRIVIAIOX, siga este caminho linear:

1. Instale em um projeto novo ou existente:
```bash
# novo projeto
npx triviaiox-core init meu-projeto
...
- Gemini CLI: `/triviaiox-menu` → `/triviaiox-<agent>`
- Codex CLI: `/skills` → `triviaiox-<agent-id>`
...
## Compatibilidade de Hooks por IDE (Realidade TRIVIAIOX 4.2)

Muitos recursos avançados do TRIVIAIOX dependem de eventos de ciclo de vida (hooks). A tabela abaixo mostra a paridade real entre IDEs/plataformas:
...
O TRIVIAIOX segue uma hierarquia clara de prioridades:
...
**As Duas Inovações Chave do TRIVIAIOX:**
...
### Entendendo o Fluxo de Trabalho TRIVIAIOX

**Antes de mergulhar, revise estes diagramas críticos de fluxo de trabalho que explicam como o TRIVIAIOX funciona:**
...
> ⚠️ **Estes diagramas explicam 90% da confusão sobre o fluxo TRIVIAIOX Agentic Agile** - Entender a criação de PRD+Arquitetura e o fluxo de trabalho sm/dev/qa e como os agentes passam notas através de arquivos de histórias é essencial - e também explica por que isto NÃO é taskmaster ou apenas um simples executor de tarefas!

### O que você gostaria de fazer?

- **[Instalar e Construir software com Equipe Ágil Full Stack de IA](#início-rápido)** → Instruções de Início Rápido
- **[Aprender como usar o TRIVIAIOX](docs/guides/user-guide.md)** → Guia completo do usuário e passo a passo
...
- **[Reportar problemas](https://github.com/Trivia-Growth/Triviaiox/issues)** → Bug reports e feature requests

## Importante: Mantenha Sua Instalação TRIVIAIOX Atualizada

**Mantenha-se atualizado sem esforço!** Para atualizar sua instalação TRIVIAIOX existente:
...
**Instale o TRIVIAIOX com um único comando:**
...
npx triviaiox-core@latest init meu-projeto
```

### ✨ Assistente de Instalação Moderno

O TRIVIAIOX agora inclui uma experiência de instalação interativa de última geração, inspirada em ferramentas modernas como Vite e Next.js:
...
- ✅ Configuração de todos os agentes e fluxos de trabalho TRIVIAIOX
...
Se você já tem o TRIVIAIOX instalado:
...
### Configure Seu IDE para Desenvolvimento TRIVIAIOX

O TRIVIAIOX inclui regras pré-configuradas para IDE para melhorar sua experiência de desenvolvimento:
...
- ✅ Integração de primeira classe no TRIVIAIOX 4.2 (pipeline de ativação e greeting compartilhado)
...
- Arquivos gerados em `.gemini/rules.md`, `.gemini/rules/TRIVIAIOX/agents/` e `.gemini/commands/*.toml`
- ✅ Hooks e settings locais no fluxo de instalacao (`.gemini/hooks/` + `.gemini/settings.json`)
- ✅ Ativacao rapida por slash commands (`/triviaiox-menu`, `/triviaiox-dev`, `/triviaiox-architect`, etc.)
...
- 📝 Padrões de código específicos do TRIVIAIOX

### Início Mais Rápido com Interface Web (2 minutos)

1. **Instale o TRIVIAIOX**: Execute `npx triviaiox-core init meu-projeto`
...
4. **Use comandos TRIVIAIOX**: Digite `*help` para ver comandos disponíveis
5. **Siga o fluxo**: Veja o [Guia do usuário](docs/guides/user-guide.md) para mais detalhes

### Referência de Comandos CLI

O TRIVIAIOX oferece uma CLI moderna e cross-platform com comandos intuitivos:

```bash
# Gerenciamento de Projeto (com assistente interativo)
npx triviaiox-core init <nome-projeto> [opções]
...
npx triviaiox-core install [opções]
...
# Comandos do Sistema
npx triviaiox-core --version   Exibir versão instalada
npx triviaiox-core --help      Exibir ajuda detalhada
npx triviaiox-core info        Exibir informações do sistema
npx triviaiox-core doctor      Executar diagnósticos do sistema
npx triviaiox-core doctor --fix Corrigir problemas detectados automaticamente

# Manutenção
npx triviaiox-core update      Atualizar para versão mais recente
npx triviaiox-core uninstall   Remover TRIVIAIOX
```
...
Next steps:
  ...
  triviaiox-core doctor     # Verify installation
  triviaiox-core --help     # See available commands
```
...
$ npx triviaiox-core install --quiet --force
✔ TRIVIAIOX installed successfully
```
...
$ npx triviaiox-core install --dry-run

[DRY RUN] Would create: ./my-project/
[DRY RUN] Would copy: .triviaiox-core/ (45 files)
...
Configuration:
✔ .triviaiox-core/ directory exists
...
```bash
$ npx triviaiox-core --help

Usage: triviaiox-core [options] [command]

TRIVIAIOX: AI-Orchestrated System for Full Stack Development
...
Commands:
  init <project-name>          Create new TRIVIAIOX project with interactive wizard
  install [options]            Install TRIVIAIOX in current directory
  info                         Display system information
  doctor [options]             Run system diagnostics and health checks
  help [command]               display help for command

Run 'triviaiox-core <command> --help' for detailed information about each command.
```
...
git clone https://github.com/Trivia-Growth/Triviaiox.git
cd triviaiox-core
...
```bash
# Instalar TRIVIAIOX no projeto
npx triviaiox-core@latest install

# Isto vai:
# 1. Detectar instalação existente (se houver)
# 2. Instalar/atualizar framework TRIVIAIOX
# 3. Configurar agentes e workflows
```

## 🌟 Além do Desenvolvimento de Software - Squads

O framework de linguagem natural do TRIVIAIOX funciona em QUALQUER domínio. Os Squads fornecem agentes IA especializados para escrita criativa, estratégia de negócios, saúde e bem-estar, educação e muito mais. Além disso, os Squads podem expandir o núcleo do TRIVIAIOX com funcionalidade específica que não é genérica para todos os casos. [Veja o Guia de Squads](docs/guides/squads-guide.md) e aprenda a criar os seus próprios!

## Agentes Disponíveis

O TRIVIAIOX vem com 12 agentes especializados:

### Agentes Meta

- **triviaiox-master** - Agente mestre de orquestração (inclui capacidades de desenvolvimento de framework)
- **triviaiox-orchestrator** - Orquestrador de fluxo de trabalho e coordenação de equipe
...
- 🏗️ **[Arquitetura Principal](docs/architecture/TRIVIAIOX-VISUAL-OVERVIEW.md)** - Mergulho técnico profundo e design do sistema
- 🚀 **[Guia de Squads](docs/guides/squads-guide.md)** - Estenda o TRIVIAIOX para qualquer domínio além do desenvolvimento de software
...
- 🎯 **[Princípios Orientadores](docs/GUIDING-PRINCIPLES.md)** - Filosofia e melhores práticas do TRIVIAIOX
- 🏛️ **[Visão Geral da Arquitetura](docs/architecture/TRIVIAIOX-VISUAL-OVERVIEW.md)** - Visão detalhada da arquitetura do sistema
- ⚙️ **[Guia de Ajuste de Performance](docs/performance-tuning-guide.md)** - Otimize seu fluxo de trabalho TRIVIAIOX
...
## 🤖 TRIVIAIOX Autonomous Development Engine (ADE)

O TRIVIAIOX introduz o **Autonomous Development Engine (ADE)** - um sistema completo para desenvolvimento autônomo que transforma requisitos em código funcional.
...
Squads permitem estender o TRIVIAIOX para qualquer domínio. Estrutura básica:
...
- **[hybrid-ops](https://github.com/Trivia-Growth/triviaiox-hybrid-ops-pedro-valerio)** - Operações híbridas humano-agente (repositório separado)

## TRIVIAIOX Pro

O **TRIVIAIOX Pro** (`@triviaiox-fullstack/pro`) é o módulo premium do TRIVIAIOX, oferecendo funcionalidades avançadas para equipes e projetos de maior escala.

> **Disponibilidade restrita:** O TRIVIAIOX Pro está disponível exclusivamente para membros do **TRIVIAIOX Cohort Advanced**. [Saiba mais sobre o programa](https://triviaioxsquad.ai).
...
- **Licenciamento** - Gerenciamento de licença via `triviaiox pro activate --key <KEY>`

Para mais informações, execute `npx triviaiox-core pro --help` após a instalação.

## Suporte

- 🐛 [Rastreador de Issues](https://github.com/Trivia-Growth/Triviaiox/issues) - Bug reports e feature requests
...
O TRIVIAIOX implementa um sistema de validação de múltiplas camadas para garantir qualidade do código e consistência:
...
# Validador TRIVIAIOX
node .triviaiox-core/utils/triviaiox-validator.js pre-commit   # Validação pre-commit
node .triviaiox-core/utils/triviaiox-validator.js pre-push     # Validação pre-push
node .triviaiox-core/utils/triviaiox-validator.js stories      # Validar todas stories
```
...
[![Contributors](https://contrib.rocks/image?repo=Trivia-Growth/Triviaiox)](https://github.com/Trivia-Growth/Triviaiox/graphs/contributors)
...
**[⬆ Voltar ao topo](#triviaiox-squad-artificial-intelligence-orchestration-experience)**

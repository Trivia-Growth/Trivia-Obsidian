/**
 * InstallTransaction - Transaction manager for TRIVIAIOX installer
 *
...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.triviaiox-backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.triviaiox-install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.triviaiox-core/');
   */

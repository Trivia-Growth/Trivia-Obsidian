#!/bin/bash
#
# TRIVIAIOX Monitor Hooks Installation Script
#
# This script installs the TRIVIAIOX monitor hooks into ~/.claude/hooks/
...
TRIVIAIOX_ROOT="$(dirname "$SCRIPT_DIR")"
HOOKS_SOURCE="$TRIVIAIOX_ROOT/.triviaiox-core/monitor/hooks"
HOOKS_TARGET="$HOME/.claude/hooks"

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║              TRIVIAIOX Monitor Hooks Installer                      ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "║     export TRIVIAIOX_MONITOR_URL=http://localhost:4001              ║"
echo "║                                                                ║"
